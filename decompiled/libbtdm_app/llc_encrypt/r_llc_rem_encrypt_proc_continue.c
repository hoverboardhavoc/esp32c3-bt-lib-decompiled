...
_L89:
    ...
    (*UNRECOVERED_JUMPTABLE)(iVar2,param_1,uVar4);
    return;
  case '\x05':
  ...
  default:
    ...
    uVar4 = (**(code **)(_r_ip_funcs_p + 0x680))(iVar2,*(code **)(_r_ip_funcs_p + 0x680));
                    ...
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(param_1,uVar4,"llc_encrypt.c",0x452);
    return;
  }
...
_L91:
                    ...
                    /* WARNING: Treating indirect jump as call */
  (*UNRECOVERED_JUMPTABLE)(param_1,1,uVar4);
  return;
_L57:
  ...
  if (((param_1 < *(byte *)(iVar3 + 0xd)) && (*(int *)(&llc_env + param_1 * 4) != 0)) &&
    ...
    *(ushort *)(iVar6 + 0x42) = *(ushort *)(iVar6 + 0x42) & 0xffdf | (ushort)(param_3 == 0) << 5;
    (**(code **)(iVar2 + 0x610))(param_1,*(code **)(iVar2 + 0x610));
