...

{
  ...
  while (iVar1 = iStack_134,
    ...
    if ((bStack_137 & 5) == 4) {
      if (bStack_138 == param_1) {
        ...
        (*DAT_000106e4)(iVar1 + 1,1,&bStack_139,DAT_000106e4);
      }
      else {
  ...
  if (DAT_000106f0 < param_2 + 6 + iVar1) {
    ...
    if (_LANCHOR2 != 0) {
      ...
      _LANCHOR2 = 0;
      iVar1 = iVar4 + 4;
      if (param_2 + 3 + iVar1 <= DAT_000106f0 - 1) goto _L69;
    }
    uVar3 = 3;
  }
  else {
_L69:
    (*DAT_000106e4)(iVar1 + 3,param_2,param_3,DAT_000106e4);
    bStack_137 = 6;
    bStack_138 = (byte)param_1;
    bStack_136 = (byte)param_2;
    (*DAT_000106e4)(iVar1,3,&bStack_138,DAT_000106e4);
    uVar3 = 0;
  }
  return uVar3;
}
