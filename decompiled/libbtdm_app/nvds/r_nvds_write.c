...
{
  if (DAT_00010700 < (uint)(param_1 + param_2)) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"nvds.c",0x1de,param_3,*(code **)(_r_plf_funcs_p + 8));
  }
                    /* WARNING: Could not recover jumptable at 0x0001020e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(_r_plf_funcs_p + 100))
            (DAT_00010704,DAT_000106fc + param_1,param_2,param_3,0,*(code **)(_r_plf_funcs_p + 100))
  ;
  return;
}
