...

{
  ...
  if (piStack_f8 == (int *)0x0) {
    (**(code **)(_r_plf_funcs_p + 8))(0x10000,0x844,*(code **)(_r_plf_funcs_p + 8));
    goto _L297;
  }
  ...
  *(char *)((int)piStack_f8 + 0x3d) = cVar2;
  ...
  if ((*(byte *)(param_1 + 9) & 1) != 0) {
    ...
    *piStack_f8 = (int)pvVar16;
    if (pvVar16 == (void *)0x0) {
      uVar14 = 0;
      (**(code **)(_r_plf_funcs_p + 8))(0x10000,0x6fc,*(code **)(_r_plf_funcs_p + 8));
    }
    else {
  ...
  if ((*(byte *)(param_1 + 9) & 4) != 0) {
    ...
    if (pvVar16 == (void *)0x0) {
      (**(code **)(_r_plf_funcs_p + 8))(0x10000,0x75d,*(code **)(_r_plf_funcs_p + 8));
    }
    else {
      memset(pvVar16,0,0x54);
      uVar23 = *(undefined4 *)(_r_ip_funcs_p + 0x45c);
      ...
      *(uint *)(iVar15 + 0x28) = uStack_fc;
      ...
      if (iVar17 == 0) {
        *(undefined1 *)(iVar15 + 0x50) = 0;
        ...
        (**(code **)(_r_plf_funcs_p + 8))(0,0x10000,0x83a,*(code **)(_r_plf_funcs_p + 8));
      }
      uStack_b3 = 0;
    }
