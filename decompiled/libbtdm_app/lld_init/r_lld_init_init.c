...
{
  if (param_1 == 1) {
    _lld_init_env = (int *)0x0;
    return;
  }
  if (param_1 == 2) {
    if (_lld_init_env != (int *)0x0) {
      if (_lld_init_env[2] != 0) {
        (**(code **)(_r_modules_funcs_p + 0xd8))
                  (_lld_init_env[2] + -0xc,*(code **)(_r_modules_funcs_p + 0xd8));
      }
      if (*_lld_init_env != 0) {
        (**(code **)(_r_modules_funcs_p + 0x110))(*(code **)(_r_modules_funcs_p + 0x110));
      }
      if (_lld_init_env[1] != 0) {
        (**(code **)(_r_modules_funcs_p + 0x110))(*(code **)(_r_modules_funcs_p + 0x110));
      }
      (**(code **)(_r_modules_funcs_p + 0x110))
                (_lld_init_env,*(code **)(_r_modules_funcs_p + 0x110));
      _lld_init_env = (int *)0x0;
    }
    return;
  }
