 ...
 * Source: libbtdm_app -> lld_init.o -> r_lld_init_evt_canceled_cbk1
 *
...
void r_lld_init_evt_canceled_cbk1(int param_1)

{
  ...
  ets_printf("%s - %d\n","r_lld_init_evt_canceled_cbk1",0x533);
  if (param_1 == 0) {
    uVar4 = 0x55f;
    ...
    if (*(char *)(param_1 + 0x31) != '\0') {
                    /* WARNING: Could not recover jumptable at 0x000113b6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)(_r_plf_funcs_p + 0xc))(*(undefined1 *)(param_1 + 0x51),"lld_init.c",0x55a);
      return;
    }
    ...
    if ((uint)*(ushort *)(param_1 + 0x2c) << 1 <= (iVar3 - *(int *)(param_1 + 0x28) & 0xfffffffU)) {
      if (0xff < (uint)*(byte *)(param_1 + 0x16) + (uint)rwip_priority) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"lld_init.c",0x541,*(code **)(_r_plf_funcs_p + 8));
      }
