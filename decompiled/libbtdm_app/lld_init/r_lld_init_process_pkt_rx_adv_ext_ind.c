...

{
  ...
  iVar12 = *(int *)(lld_init_env + param_1 * 4);
  ...
  if ((*(ushort *)(iVar4 + iVar11 + 4) & 0xf) != 7) {
                    /* WARNING: Could not recover jumptable at 0x00011c6e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_plf_funcs_p + 8))(0,"lld_init.c",0x286);
    return;
  }
