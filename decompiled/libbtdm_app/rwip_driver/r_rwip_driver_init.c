...

{
  ...
  if (param_1 == 0) {
    ...
    (**(code **)(_r_modules_funcs_p + 0x100))
              (0xe,*(undefined4 *)(_r_ip_funcs_p + 0x24c),*(code **)(_r_modules_funcs_p + 0x100));
                    /* WARNING: Could not recover jumptable at 0x000100f0. Too many branches */
  ...
  uStack_28 = 1;
  iVar2 = (*(code *)0xffffffff)(0x11,&uStack_28,&uStack_27,0xffffffff);
  if (iVar2 != 0) {
    uStack_27 = 0;
  }
  iVar2 = (**(code **)(_r_plf_funcs_p + 0x38))(*(code **)(_r_plf_funcs_p + 0x38));
  if (*(char *)(iVar2 + 0xe) == '\x01') {
    iVar2 = (**(code **)(_r_plf_funcs_p + 0x34))(*(code **)(_r_plf_funcs_p + 0x34));
    ...
    if (iVar2 != 0) {
      ...
      uVar1 = (**(code **)(_r_modules_funcs_p + 0x2a4))
