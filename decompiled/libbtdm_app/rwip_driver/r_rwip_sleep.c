...

{
     ...
     (iVar1 = (**(code **)(_r_plf_funcs_p + 0x34))(*(code **)(_r_plf_funcs_p + 0x34)), iVar1 != 0))
  {
    if (_btdm_pwr_state == 0) {
      iStack_28 = (**(code **)(_r_modules_funcs_p + 0x2c4))(*(code **)(_r_modules_funcs_p + 0x2c4));
      uVar3 = iStack_28 + 3;
      if ((_btdm_pwr_state & 0xffff) <= 0x270U - extraout_a1) {
        uVar3 = iStack_28 + 2;
      }
      uStack_2c = _rwip_rf;
      ...
      if ((_DAT_00012030 < (int)uStack_2c) &&
         ...
         iVar1 = (**(code **)(_r_osi_funcs_p + 0x94))(&uStack_2c,*(code **)(_r_osi_funcs_p + 0x94)),
         iVar1 != 0)) {
