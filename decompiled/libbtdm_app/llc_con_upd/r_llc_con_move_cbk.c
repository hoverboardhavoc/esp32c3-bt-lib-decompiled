  ...
  if (param_1 < *(byte *)(iVar2 + 0xd)) {
    ...
    if ((iVar2 != 0) && ((*(byte *)(iVar2 + 0x44) & 3) != 3)) {
      if (((*(byte *)(iVar2 + 0x45) & 0x10) == 0) && (-1 < (char)*(byte *)(iVar2 + 0x45))) {
        ...
        if (*(int *)(&llc_env + iVar7) == 0) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x71a,*(code **)(_r_plf_funcs_p + 8));
        }
        if (iVar2 == 0) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x71b,*(code **)(_r_plf_funcs_p + 8));
        }
        if (*(int *)(iVar2 + 4) == 0) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x71c,*(code **)(_r_plf_funcs_p + 8));
        }
        ...
        if ((*(ushort *)(*(int *)(&llc_env + iVar7) + 0x42) & 1) == 0) {
          if ((uVar8 < 4) || (uVar6 < uVar8)) {
            (**(code **)(_r_plf_funcs_p + 8))
                      (0,"llc_con_upd.c",0x723,*(code **)(_r_plf_funcs_p + 8));
          }
          uVar8 = uVar8 - 3;
          uVar6 = uVar6 - 3;
        }
