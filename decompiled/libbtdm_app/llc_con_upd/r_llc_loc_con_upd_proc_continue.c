...
void r_llc_loc_con_upd_proc_continue(uint param_1,int param_2,int param_3)

{
  ...
  if (iVar6 != param_2) {
    ...
    uVar8 = 0x124;
_L62:
                    /* WARNING: Could not recover jumptable at 0x00010364. Too many branches */
  ...
  case 2:
    ...
    if ((((param_3 != 0) &&
         ...
         param_1 < *(byte *)(iVar6 + 0xd))) && (*(int *)(&llc_env + iVar10) != 0)) &&
      ...
      if ((*(ushort *)(iVar9 + 0x42) & 1) == 0) {
        ...
        if (iVar10 == 0) {
          (**(code **)(_r_plf_funcs_p + 8))("llc_con_upd.c",0x137,*(code **)(_r_plf_funcs_p + 8));
        }
        if (*(int *)(iVar10 + 4) == 0) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x138,*(code **)(_r_plf_funcs_p + 8));
        }
  ...
  case 1:
    if ((*(ushort *)(iVar9 + 0x42) & 1) == 0) {
      (**(code **)(_r_plf_funcs_p + 0xc))
                (param_1,param_3,"llc_con_upd.c",0x146,*(code **)(_r_plf_funcs_p + 0xc));
    }
  ...
  case 0:
    ...
    *(ushort *)(iVar9 + 0x42) = *(ushort *)(iVar9 + 0x42) | 0x10;
    if (cVar1 != '\0') {
      ...
      *(short *)(iVar5 + 0x24) = sVar4 + (sVar2 + 1) * 9;
      ...
      *(undefined2 *)(iVar5 + 0x22) = *(undefined2 *)(iVar5 + 0x2a);
      ...
      if (param_3 == 0) {
        llc_ll_connection_update_ind_pdu_send(param_1,iVar5);
        return;
      }
_L38:
  ...
  case 3:
    ...
    if ((param_3 != 0) ||
       (param_3 = (**(code **)(_r_ip_funcs_p + 0x378))
                             ...
                             *(code **)(_r_ip_funcs_p + 0x378)), param_3 != 0)) goto _L38;
    uVar8 = 4;
    UNRECOVERED_JUMPTABLE_00 = *(code **)(_r_ip_funcs_p + 0x684);
    break;
  case 4:
  ...
  default:
    ...
    goto _L62;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00010514. Too many branches */
                    /* WARNING: Treating indirect jump as call */
