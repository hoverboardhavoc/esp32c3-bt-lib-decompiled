...
_L117:
  ...
  uVar5 = uVar4 * 2;
  if (iVar2 == 0) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x39c,*(code **)(_r_plf_funcs_p + 8));
  }
  if (uVar4 == 0) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x39d,*(code **)(_r_plf_funcs_p + 8));
  }
    ...
    *(uint *)(iVar2 + 0xc) = uVar7;
    ...
    if ((*(char *)(iVar8 + 0x15) == '\x02') &&
      ...
      *(uint *)(iVar2 + 0xc) = (uint)auStack_32[0];
                    ...
                    /* WARNING: Could not recover jumptable at 0x00010ed8. Too many branches */
