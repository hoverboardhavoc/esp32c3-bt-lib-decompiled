...

{
  ...
  if (*(int *)(&llc_env + (param_2 >> 8) * 4) == 0) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x6f1,*(code **)(_r_plf_funcs_p + 8));
  }
  if (iVar2 == 0) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x6f2,*(code **)(_r_plf_funcs_p + 8));
  }
  if (*(int *)(iVar2 + 4) == 0) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x6f3,*(code **)(_r_plf_funcs_p + 8));
  }
  if (*(uint *)(iVar2 + 4) <= (uint)*param_1) {
    (**(code **)(_r_plf_funcs_p + 0xc))("llc_con_upd.c",0x6f4,*(code **)(_r_plf_funcs_p + 0xc));
  }
  iVar4 = *(int *)(iVar2 + 8);
  uVar5 = *(uint *)(iVar2 + 4);
  if (uVar5 == 0) {
