  ...
  case 2:
    ...
    if ((((param_3 != 0) &&
      ...
      if ((*(ushort *)(iVar9 + 0x42) & 1) == 0) {
        ...
        if (iVar10 == 0) {
          (**(code **)(_r_plf_funcs_p + 8))("llc_con_upd.c",0x13b,*(code **)(_r_plf_funcs_p + 8));
        }
        if (*(int *)(iVar10 + 4) == 0) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"llc_con_upd.c",0x13c,*(code **)(_r_plf_funcs_p + 8));
        }
  ...
  case 1:
    if ((*(ushort *)(iVar9 + 0x42) & 1) == 0) {
      (**(code **)(_r_plf_funcs_p + 0xc))
                (param_1,param_3,"llc_con_upd.c",0x14a,*(code **)(_r_plf_funcs_p + 0xc));
    }
...
_L5:
  ...
  case 3:
    ...
    if ((param_3 != 0) ||
       (param_3 = (**(code **)(_r_ip_funcs_p + 0x378))
                             ...
                             *(code **)(_r_ip_funcs_p + 0x378)), param_3 != 0)) goto _L5;
    uVar8 = 4;
    UNRECOVERED_JUMPTABLE_00 = *(code **)(_r_ip_funcs_p + 0x684);
    break;
  case 4:
  ...
  default:
    ...
    goto _L29;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00010260. Too many branches */
                    /* WARNING: Treating indirect jump as call */
