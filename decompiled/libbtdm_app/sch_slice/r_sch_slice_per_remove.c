...

{
  ...
  if (param_1 - 3U < 2) {
    ...
    *(undefined4 *)(memset + param_2 * 8) = 0;
    UNRECOVERED_JUMPTABLE = *(code **)(iVar1 + 0x71c);
  }
  else {
    (**(code **)(_r_plf_funcs_p + 8))(0,"sch_slice.c",0x248,*(code **)(_r_plf_funcs_p + 8));
    UNRECOVERED_JUMPTABLE = *(code **)(_r_ip_funcs_p + 0x71c);
  }
                    /* WARNING: Could not recover jumptable at 0x00010374. Too many branches */
