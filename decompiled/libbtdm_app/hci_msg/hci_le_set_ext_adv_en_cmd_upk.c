...

{
  ...
  if (param_2 == 0) {
    ...
    iVar2 = (**(code **)(_r_ip_funcs_p + 0xa4))
                      (&iStack_54,&puStack_50,param_4,puVar6,1,*(code **)(_r_ip_funcs_p + 0xa4));
    if (iVar2 == 0) {
      ...
      if (iVar3 == 0) {
        ...
        for (uVar5 = 0; iVar2 = iVar3, uVar5 < (byte)param_1[1]; uVar5 = uVar5 + 1 & 0xff) {
          ...
          iVar2 = (**(code **)(_r_ip_funcs_p + 0xa4))
                            (&iStack_54,&puStack_50,param_4,uVar7,1,*(code **)(_r_ip_funcs_p + 0xa4)
                            );
          if (iVar2 != 0) break;
          puStack_50 = param_1 + (uVar5 + 6) * 2;
          iVar2 = (**(code **)(_r_ip_funcs_p + 0xa4))
                            (&iStack_54,&puStack_50,param_4,uVar7,2,*(code **)(_r_ip_funcs_p + 0xa4)
                            );
          if (iVar2 != 0) break;
