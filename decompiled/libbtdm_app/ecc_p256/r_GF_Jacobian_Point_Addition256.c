...

{
  ...
  *(undefined4 *)((int)param_3 + 0x80) = 0;
  ...
  if (((iVar1 == 0) &&
      (iVar1 = (**(code **)(_r_modules_funcs_p + 0x3a4))
                         ((int)param_1 + 0x2c,&ecc_Jacobian_InfinityPoint256,
    ...
    *(undefined4 *)((int)param_3 + 0x54) = _DAT_0001306c;
    ...
    if (((iVar1 == 0) &&
      ...
      *(undefined4 *)((int)param_3 + 0x28) = *(undefined4 *)((int)param_1 + 0x28);
      memcpy(__s_00,(void *)((int)param_1 + 0x2c),0x22);
    ...
    if ((iVar1 != 0) ||
       ((iVar1 = (**(code **)(_r_modules_funcs_p + 0x3a4))
                           (__src_01,(int)param_1 + 0x2c,*(code **)(_r_modules_funcs_p + 0x3a4)),
        iVar1 == 0 &&
      ...
      (**(code **)(_r_modules_funcs_p + 0x39c))
                ((int)param_1 + 0x2c,__src,auStack_2a8,*(code **)(_r_modules_funcs_p + 0x39c));
      (**(code **)(_r_modules_funcs_p + 0x39c))
