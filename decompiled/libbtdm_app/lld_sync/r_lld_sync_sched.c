  ...
  do {
    ...
    if (acStack_41[0] == '\0') {
      *(undefined1 *)(iVar3 + 0x16) = co_sca2ppm;
      ...
      if (0xff < (uint)*(byte *)(iVar3 + 0x16) + (uint)DAT_0001302d) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"lld_sync.c",0x337,*(code **)(_r_plf_funcs_p + 8));
      }
    ...
    if (*(char *)(iVar3 + 99) == '\x01') {
      ...
      *(uint *)(iVar3 + 0x44) = iVar4 * *(int *)(iVar3 + 0x40) + *(int *)(iVar3 + 0x44) & 0xfffffff;
      iVar4 = (**(code **)(iVar7 + 0x264))(*(code **)(iVar7 + 0x264));
...
_L214:
      ...
      if (*(char *)(iVar3 + 0x57) == '\0') {
        ...
        uVar5 = uVar5 + iVar7;
        if (((uint)(*(int *)(iVar3 + 0x40) * 0x271) >> 1) - 0x96 < uVar5 >> 1) goto _L214;
      }
      *(undefined2 *)(iVar3 + 0x52) = 0;
      bVar1 = *(byte *)(iVar3 + 0x58);
    }
    uVar6 = (uint)_DAT_0001304e;
    *(uint *)(iVar3 + 4) = uVar9;
