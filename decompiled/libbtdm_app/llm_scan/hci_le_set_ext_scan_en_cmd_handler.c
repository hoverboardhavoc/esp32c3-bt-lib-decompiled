...
_L83:
          if ((uint)*(ushort *)(param_1 + 2) < uVar6 << 7) goto _L84;
        }
      }
      iVar2 = 0x12;
      goto _L67;
...
_L138:
    ...
    iVar2 = 0xfe;
    if ((_sdk_cfg_priv_opts & 8) != 0) goto _L67;
  }
_L103:
  iVar2 = 0xc;
_L67:
