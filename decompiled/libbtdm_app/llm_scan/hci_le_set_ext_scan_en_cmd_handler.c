...
_L123:
          if ((uint)*(ushort *)(param_1 + 2) < uVar6 << 7) goto _L124;
        }
      }
      iVar2 = 0x12;
      goto _L107;
...
_L178:
    ...
    iVar2 = 0xfe;
    if ((_sdk_cfg_priv_opts & 8) != 0) goto _L107;
  }
_L143:
  iVar2 = 0xc;
_L107:
