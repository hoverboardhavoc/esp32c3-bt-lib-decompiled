...
_L488:
  ...
  if (iVar9 != 0) {
    cVar1 = param_1[0x20];
    goto joined_r0x00011d0c;
  }
  if ((bVar15 & 0xfd) != 1) {
    (**(code **)(_r_plf_funcs_p + 8))("llm_scan.c",0x6a9,*(code **)(_r_plf_funcs_p + 8));
  }
          ...
          *puVar14 = 0x10d;
          ...
          if ((uVar7 < 0xe6) && ((param_1[0x16] & 0xfcU) != 0)) {
            (**(code **)(_r_plf_funcs_p + 0xc))
                      (0x60,"llm_scan.c",0x74e,*(code **)(_r_plf_funcs_p + 0xc));
          }
          uVar5 = 0x20;
          if (uVar7 < 0xe6) {
