 ...
 * Source: libbtdm_app -> sch_plan.o -> r_sch_plan_offset_max_calc
 *
...

{
  ...
  for (piVar2 = (int *)_sch_plan_env; piVar2 != (int *)0x0; piVar2 = (int *)*piVar2) {
    if (*(ushort *)(piVar2 + 5) != param_4) {
      ...
      if (uVar3 == 0) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"sch_plan.c",0x95,*(code **)(_r_plf_funcs_p + 8));
      }
      if ((param_1 % uVar3 == 0) && ((uint)piVar2[1] % uVar3 == 0)) {
        ...
        if (uVar1 < param_3 + param_2) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"sch_plan.c",0xa5,*(code **)(_r_plf_funcs_p + 8));
        }
