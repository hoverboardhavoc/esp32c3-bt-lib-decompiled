...

{
  ...
  iVar2 = (**(code **)(_r_ip_funcs_p + 0x98))(uVar4,*(code **)(_r_ip_funcs_p + 0x98));
  if (iVar2 == 0) {
    (**(code **)(_r_plf_funcs_p + 0xc))(uVar4,0,"hci_tl.c",0x278,*(code **)(_r_plf_funcs_p + 0xc));
    return param_1 + 10;
  }
...
_L86:
      (**(code **)(_r_plf_funcs_p + 0xc))
                (uVar3,uVar4,"hci_tl.c",0x26b,*(code **)(_r_plf_funcs_p + 0xc));
      goto _L87;
    }
  }
  uVar3 = 0;
_L87:
  if (*(ushort *)(param_1 + 10) < auStack_22[0]) {
    (**(code **)(_r_plf_funcs_p + 0xc))
              (uVar3,uVar4,"hci_tl.c",0x26e,*(code **)(_r_plf_funcs_p + 0xc));
  }
