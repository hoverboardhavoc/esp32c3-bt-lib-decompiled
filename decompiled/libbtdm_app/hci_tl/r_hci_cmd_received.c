...

{
  ...
  if (DAT_0001201d < '\0') {
    (**(code **)(_r_plf_funcs_p + 8))(0,"hci_tl.c",0x5fd,*(code **)(_r_plf_funcs_p + 8));
  }
  if (param_1 != 0xc35) {
...
_L221:
  ...
  default:
                    ...
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_plf_funcs_p + 0xc))(param_1,"hci_tl.c",0x691,*(code **)(_r_plf_funcs_p + 0xc));
    return;
  case 8:
    uVar2 = 2;
    break;
  ...
  if (uVar4 != 0) {
    (**(code **)(_r_plf_funcs_p + 0xc))
              (uVar4,param_1,"hci_tl.c",0x6bd,*(code **)(_r_plf_funcs_p + 0xc));
  }
  if (iVar6 != 0) {
    ...
    if (uVar4 != 0) {
      (**(code **)(_r_plf_funcs_p + 0xc))
                (uVar4,param_1,"hci_tl.c",0x6d5,*(code **)(_r_plf_funcs_p + 0xc));
    }
