...

{
  ...
  if (((*(char *)(iVar3 + 0x46) == '\x01') && (*(char *)(iVar3 + 0x43) == '\0')) &&
    ...
    if (*(char *)(iVar3 + 0x42) == '\0') {
      uVar4 = uVar4 + *(ushort *)(iVar3 + 0x3c) & 0xfffffff;
      if ((uVar1 & 1) != 0) {
        uVar4 = uVar4 + (*(ushort *)(iVar3 + 0x40) >> 1) & 0xfffffff;
      }
  ...
  iVar13 = 0;
  while( true ) {
    if (uVar11 < (uVar4 - uVar12 & 0xfffffff)) {
      uVar6 = 8;
      if ((*(ushort *)(iVar3 + 0x84) & 2) == 0) {
        uVar6 = 0x3e;
      }
                    /* WARNING: Could not recover jumptable at 0x000104fc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)(_r_ip_funcs_p + 800))(param_1,1,uVar6);
      return;
    }
    uVar8 = uVar4;
    if ((*(ushort *)(iVar3 + 0x84) & 1) != 0) {
      ...
      uVar9 = (((uVar1 + uVar9) * (uVar4 - iVar10 & 0xfffffff)) / 0x640 + 0x40) * 2;
      if (param_3 != 0) {
        *(undefined2 *)(iVar13 + (param_1 + 0x10) * 2 + 8) = 0;
      }
      if ((*(ushort *)(iVar3 + 0x84) & 2) == 0) {
        uVar9 = uVar9 + (uint)*(ushort *)(iVar3 + 0x70) * 0x271;
      }
        ...
        uVar8 = ((int)((uint)uVar1 * (uint)*(ushort *)(iVar3 + 0x70) * 0x271) >> 1) +
                (uint)*(ushort *)(iVar3 + 0x70) * 0x271 + uVar9;
      ...
      if (((*(char *)(iVar3 + 0x46) == '\x01') && (*(char *)(iVar3 + 0x42) != '\0')) &&
         (*(char *)(iVar3 + 0x43) == '\0')) {
        uVar9 = uVar9 + (uint)*(ushort *)(iVar3 + 0x40) * 0x271;
      }
      uVar5 = (uVar9 >> 1) / 0x271;
      uVar8 = uVar4 - uVar5 & 0xfffffff;
      iVar13 = ((int)sVar7 - (uVar9 >> 1)) + uVar5 * 0x271;
      if (iVar13 < 0) {
        uVar8 = uVar8 - 1 & 0xfffffff;
        iVar13 = iVar13 + 0x271;
      }
      *(int *)(iVar3 + 8) = iVar13;
      *(uint *)(iVar3 + 0x10) = *(int *)(iVar3 + 0x5c) + uVar9;
    }
    *(uint *)(iVar3 + 4) = uVar8;
    iVar10 = (**(code **)(_r_ip_funcs_p + 0x6b0))(iVar3,*(code **)(_r_ip_funcs_p + 0x6b0));
    if (iVar10 == 0) break;
  ...
  *(uint *)(iVar3 + 0x48) = uVar4;
  if ((*(ushort *)(iVar3 + 0x84) & 1) != 0) {
    ...
    *(uint *)(iVar3 + 0x4c) = uVar9 + (uint)DAT_00016026 * 2;
  }
  return;
}
