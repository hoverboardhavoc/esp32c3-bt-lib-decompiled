 ...
 * Source: libbtdm_app -> lld_con.o -> r_lld_con_activity_offset_compute
 *
...
int r_lld_con_activity_offset_compute(int param_1,int param_2,uint param_3,int param_4,int param_5)
