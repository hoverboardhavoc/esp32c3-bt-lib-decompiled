...

{
  ...
  while (*(char *)(iVar5 + 0x92) != '\0') {
    ...
    if ((uVar2 & 3) == 0) {
_L405:
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_con.c",0x9c5,*(code **)(_r_plf_funcs_p + 8));
    }
    else {
      if (uVar12 < 3) {
        ...
        if (iVar4 == 0) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"lld_con.c",0x9a5,*(code **)(_r_plf_funcs_p + 8));
        }
