...

{
  ...
  if (iVar2 == 0) {
                    /* WARNING: Could not recover jumptable at 0x00013112. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_plf_funcs_p + 8))(0,"lld_con.c",0xbea);
    return;
  }
  ...
  *(char *)(iVar2 + 0x16) = cVar6;
                    /* WARNING: Could not recover jumptable at 0x000130d2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
