...

{
  ...
  if (iVar2 == 0) {
                    /* WARNING: Could not recover jumptable at 0x000130a6. Too many branches */
  ...
  if (*(char *)(iVar2 + 0x8f) == '\x02') {
                    ...
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_ip_funcs_p + 800))
              (param_1,1,(-(uint)((*(ushort *)(iVar2 + 0x84) & 0x80) == 0) & 0xffffffd9) + 0x3d,
               *(code **)(_r_ip_funcs_p + 800));
    return;
  }
  ...
  if (sdk_cfg_priv_opts != '\0') {
    ...
    uVar1 = *(ushort *)(param_1 * 0x5a + 0x56 + iVar4);
    iVar6 = param_1 * 0x5a + 0x18;
    iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
    if ((((&g_event_empty)[param_1] == '\x01') && (uVar1 >> 8 == 0)) &&
       ((*(ushort *)(iVar4 + iVar6) >> 0xe & 1) == 0)) {
      iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      uVar1 = *(ushort *)(iVar4 + iVar6);
      iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar4 + iVar6) = uVar1 | 0x4000;
    }
    else {
      (&g_event_empty)[param_1] = (byte)(*(ushort *)(iVar4 + iVar6) >> 0xe) & 1;
    }
  }
  uVar1 = *(ushort *)(iVar2 + 0x84);
  iVar4 = 5;
  if (((uVar1 & 6) == 2) && ((uVar1 & 8) == 0)) {
    iVar4 = (*(char *)(iVar2 + 0x46) == '\x01') + 4;
  }
  *(uint *)(iVar2 + 0x48) = *(int *)(iVar2 + 0x48) + *(int *)(iVar2 + 100) & 0xfffffff;
  *(short *)(iVar2 + 0x7e) = *(short *)(iVar2 + 0x7e) + 1;
  if (param_2 == 0) {
    cVar5 = (&rwip_priority)[iVar4 * 2];
  }
  else {
    cVar5 = *(char *)(iVar2 + 0x16) + (&DAT_00016019)[iVar4 * 2];
  }
  *(char *)(iVar2 + 0x16) = cVar5;
                    /* WARNING: Could not recover jumptable at 0x00013068. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(_r_ip_funcs_p + 0x3a8))
            (param_1,uVar3,(int)(uint)uVar1 >> 8 & 1,*(code **)(_r_ip_funcs_p + 0x3a8));
  return;
}
