...

{
  ...
  if (iVar2 == 0) {
                    /* WARNING: Could not recover jumptable at 0x00013122. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_plf_funcs_p + 8))(0,"lld_con.c",0xc11);
    return;
  }
  ...
  if (*(char *)(iVar2 + 0x8f) == '\x02') {
    ...
    if ((*(ushort *)(iVar2 + 0x84) & 0x80) == 0) {
      uVar5 = 0x16;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00012fa4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  *(char *)(iVar2 + 0x16) = cVar6;
                    /* WARNING: Could not recover jumptable at 0x000130e2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
