...
_L252:
  ...
  *(int *)(iVar1 + 0x10) = iVar5;
  ...
  if (*(char *)(iVar2 + 0x15) == '\0') {
    ...
    *(short *)(iVar2 + iVar12) = (short)uVar4;
    iVar2 = (*pcVar9)(0x400,pcVar9);
    *(short *)(iVar2 + iVar5) = (short)uVar4;
    ...
    if (*(char *)(iVar2 + 0x15) == '\x01') {
      ...
      *(uint *)(iVar1 + 0x10) = uVar7;
      ...
      uVar8 = (-2 - (uint)rwip_prog_delay) + *(int *)(iVar1 + 100) >> 1;
      if (*(ushort *)(iVar1 + 0x78) < uVar8) {
        uVar8 = (uint)*(ushort *)(iVar1 + 0x78);
      }
      uVar4 = uVar8 & 0xffff;
      uVar10 = (uint)*(ushort *)(iVar1 + 0x76);
      if (*(ushort *)(iVar1 + 0x76) < uVar7) {
        uVar10 = uVar7;
      }
      *(short *)(iVar1 + 0x78) = (short)uVar8;
      uVar11 = (undefined2)uVar10;
      *(undefined2 *)(iVar1 + 0x76) = uVar11;
      *(uint *)(iVar1 + 0x5c) = uVar10 * 0x4e2;
      *(uint *)(iVar1 + 0x10) = uVar10 * 0x4e2;
    }
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
    iVar2 = _r_plf_funcs_p;
    *(short *)(iVar3 + iVar12) = (short)uVar4;
    iVar2 = (**(code **)(iVar2 + 0xbc))(0x400,*(code **)(iVar2 + 0xbc));
    *(undefined2 *)(iVar2 + iVar5) = uVar11;
  }
