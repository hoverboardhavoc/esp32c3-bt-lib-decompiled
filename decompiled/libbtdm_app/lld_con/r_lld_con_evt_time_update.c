...

{
  ...
  if (uVar7 < uVar4) {
    if (((g_max_evt_env == '\x02') && (uVar8 = (uint)DAT_00016041, uVar8 != 0)) && (uVar8 < uVar4))
    {
      uVar4 = uVar4 - uVar8;
    }
    else {
  ...
  *(int *)(iVar1 + 0x10) = iVar5;
  ...
  if (*(char *)(iVar2 + 0x15) == '\0') {
    ...
    if (*(char *)(iVar2 + 0x15) == '\x01') {
      ...
      *(uint *)(iVar1 + 0x10) = uVar7;
      ...
      if (iVar2 == 0) {
        ...
        *(uint *)(iVar1 + 0x5c) = uVar9 * 0x4e2;
        *(uint *)(iVar1 + 0x10) = uVar9 * 0x4e2;
      }
    }
    else {
    ...
    *(undefined2 *)(iVar2 + iVar5) = uVar10;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00011436. Too many branches */
