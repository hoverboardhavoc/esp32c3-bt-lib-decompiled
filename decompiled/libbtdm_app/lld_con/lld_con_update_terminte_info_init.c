 ...
 * Source: libbtdm_app -> lld_con.o -> lld_con_update_terminte_info_init
 *
...
void lld_con_update_terminte_info_init(int param_1)

{
  *(undefined4 *)(lld_con_term_info + param_1 * 4) = 0;
  return;
}
