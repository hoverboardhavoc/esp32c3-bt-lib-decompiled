...

{
  ...
  if (*(char *)(_p_llm_env + 0xd7) != '\x02') {
    *(undefined1 *)(_p_llm_env + 0xd7) = 1;
    ...
    iVar6 = (**(code **)(_r_plf_funcs_p + 0x38))(*(code **)(_r_plf_funcs_p + 0x38));
    if (*(byte *)(iVar6 + 0xd) <= bStack_9a) {
      if ((char)param_1[2] == '\0') {
        iVar6 = (**(code **)(_r_ip_funcs_p + 0x4d8))
                          (param_1 + 3,*(undefined1 *)((int)param_1 + 5),
                           *(code **)(_r_ip_funcs_p + 0x4d8));
        iVar8 = 0xb;
        if (iVar6 != 0) goto _L41;
      }
        ...
        if (((((((param_1[7] <= uVar9) && ((ushort)(param_1[1] - 4) < 0x3ffd)) &&
           ...
           ((((byte)param_1[6] < 4 && ((param_1[9] + 1) * uVar9 < (uint)param_1[10] << 2)) &&
            ((((byte)param_1[6] & 1) == 0 ||
             ...
             iVar6 == 0)))))) {
          iVar8 = (**(code **)(_r_ip_funcs_p + 0x4ac))(&bStack_9a,*(code **)(_r_ip_funcs_p + 0x4ac))
          ;
          ...
          if (*(int *)(*(int *)(_p_llm_env + 8) + (uint)bStack_9a * 0x44) != 0) {
            (**(code **)(_r_plf_funcs_p + 8))("llm_init.c",0xcb,*(code **)(_r_plf_funcs_p + 8));
          }
          uVar4 = (uint)bStack_9a;
          iVar6 = *(int *)(_p_llm_env + 8);
          uVar7 = (*(code *)_r_modules_funcs_p[0x32])(0,0,0,0x3a,(code *)_r_modules_funcs_p[0x32]);
          *(undefined4 *)(iVar6 + uVar4 * 0x44) = uVar7;
          iVar6 = _p_llm_env;
...
_L37:
              ...
              *(undefined2 *)(puVar10 + 2) = *(undefined2 *)(iVar6 + 0x10);
              ...
              (**(code **)(_r_plf_funcs_p + 0xc))
                        (cVar1,0,"llm_init.c",0xf5,*(code **)(_r_plf_funcs_p + 0xc));
            }
          }
          bVar3 = bStack_9a;
          iVar6 = _p_llm_env;
          ...
          *(undefined1 *)(*(int *)(_p_llm_env + 8) + iVar8 + 0x40) = 5;
          ...
          memcpy(auStack_64,(void *)(iVar6 + 0x1d),5);
          uStack_5e = 1;
          uStack_58 = *param_1;
          bStack_5d = bVar3;
          uStack_56 = param_1[1];
          ...
          iVar8 = (**(code **)(_r_ip_funcs_p + 0x494))(&uStack_70,*(code **)(_r_ip_funcs_p + 0x494))
          ;
          if (iVar8 != 0) {
            iVar8 = 3;
          }
  ...
  iVar8 = 0xc;
_L41:
  (**(code **)(_r_ip_funcs_p + 0x4bc))(param_2,iVar8,*(code **)(_r_ip_funcs_p + 0x4bc));
  return 0;
}
