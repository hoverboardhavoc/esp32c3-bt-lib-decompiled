  ...
  if (*(char *)(_p_llm_env + 0xd7) != '\x02') {
    *(undefined1 *)(_p_llm_env + 0xd7) = 1;
    ...
    if (*(byte *)(iVar5 + 0xd) <= bStack_9a) {
      if ((char)param_1[2] == '\0') {
        iVar5 = (**(code **)(_r_ip_funcs_p + 0x4d8))
      ...
      if (param_1[1] <= *param_1) {
        ...
        if (((((((param_1[7] <= uVar7) && ((ushort)(param_1[1] - 4) < 0x3ffd)) &&
          ...
          if (*(int *)(*(int *)(_p_llm_env + 8) + (uint)bStack_9a * 0x44) != 0) {
            (**(code **)(_r_plf_funcs_p + 8))(0x10000,0xd4,*(code **)(_r_plf_funcs_p + 8));
          }
          uVar8 = (uint)bStack_9a;
          iVar5 = *(int *)(_p_llm_env + 8);
          uVar4 = (*(code *)_r_modules_funcs_p[0x32])(0,0,0,0x3a,(code *)_r_modules_funcs_p[0x32]);
              ...
              *(undefined2 *)(iVar6 + 8) = *(undefined2 *)(iVar5 + 0x10);
              ...
              if (bVar1 < 3) {
                ...
                (**(code **)(_r_plf_funcs_p + 0xc))
                          (bVar1,0,0x10000,0xfe,*(code **)(_r_plf_funcs_p + 0xc));
                goto _L36;
              }
