  ...
  if (*(char *)(_p_llm_env + 0xd7) != '\x02') {
    *(undefined1 *)(_p_llm_env + 0xd7) = 1;
    while( true ) {
      ...
      if (((uint)*(byte *)(iVar8 + 0xd) <= (uint)bStack_a1) ||
         (*(char *)(*(int *)(_p_llm_env + 8) + (uint)bStack_a1 * 0x44 + 0x40) == '\x05')) break;
      bStack_a1 = bStack_a1 + 1;
    }
    iVar8 = (**(code **)(_r_plf_funcs_p + 0x38))(*(code **)(_r_plf_funcs_p + 0x38));
    if (*(byte *)(iVar8 + 0xd) <= bStack_a1) {
      if ((char)param_1[2] == '\0') {
        ...
        if (((((((param_1[7] <= uVar9) && ((ushort)(param_1[1] - 4) < 0x3ffd)) &&
           ...
           ((((byte)param_1[6] < 4 && ((param_1[9] + 1) * uVar9 < (uint)param_1[10] << 2)) &&
            ((((byte)param_1[6] & 1) == 0 ||
             ...
             iVar8 == 0)))))) {
          iVar8 = (**(code **)(_r_ip_funcs_p + 0x4ac))(&bStack_a1,*(code **)(_r_ip_funcs_p + 0x4ac))
          ;
...
_L35:
          ...
          *(undefined1 *)(*(int *)(_p_llm_env + 8) + iVar6 + 0x40) = 5;
          ...
          memcpy(auStack_74,(void *)(iVar8 + 0x1d),5);
          uStack_6e = 1;
          uStack_68 = *param_1;
          bStack_6d = bVar3;
          uStack_66 = param_1[1];
          ...
          uStack_80 = *(undefined4 *)(iVar6 + 4);
          uStack_7c = *(undefined2 *)(iVar6 + 8);
          uStack_6f = 0;
          uStack_44 = *(undefined1 *)(iVar8 + 0xc6);
          if ((_bt_rf_coex_hooks_p != (undefined4 *)0x0) &&
             ((code *)*_bt_rf_coex_hooks_p != (code *)0x0)) {
            (*(code *)*_bt_rf_coex_hooks_p)(uVar9,1,1);
          }
          iVar8 = (**(code **)(_r_ip_funcs_p + 0x494))(&uStack_80,*(code **)(_r_ip_funcs_p + 0x494))
          ;
          if (iVar8 != 0) {
            iVar8 = 3;
          }
