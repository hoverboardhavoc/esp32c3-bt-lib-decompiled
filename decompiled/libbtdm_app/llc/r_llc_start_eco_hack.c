 ...
 * Source: libbtdm_app -> llc.o -> r_llc_start_eco_hack
 *
...
undefined4 r_llc_start_eco_hack(uint param_1,undefined4 *param_2,void *param_3)
  ...
  if (param_1 < *(byte *)(iVar4 + 0xd)) {
    ...
    if (*piVar8 == 0) {
      ...
      *piVar8 = (int)puVar3;
      ...
      (**(code **)(_r_plf_funcs_p + 0xc))(param_1,"llc.c",0x124,*(code **)(_r_plf_funcs_p + 0xc));
      uVar9 = 0xff;
    }
  }
  return uVar9;
