  ...
  if (param_3 < 3) {
    if (param_3 != 0) {
      ...
      UNRECOVERED_JUMPTABLE = *(code **)(_r_ip_funcs_p + 0x2f0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x000118dc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(param_2,param_1,param_3 != 0,UNRECOVERED_JUMPTABLE);
    return;
  }
  if (param_3 != 4) {
                    /* WARNING: Could not recover jumptable at 0x000118fa. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_plf_funcs_p + 0xc))(0x10000,0x493,*(code **)(_r_plf_funcs_p + 0xc));
    return;
  }
                    /* WARNING: Could not recover jumptable at 0x00011918. Too many branches */
                    /* WARNING: Treating indirect jump as call */
