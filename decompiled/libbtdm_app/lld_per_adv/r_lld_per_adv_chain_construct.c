...

{
  ...
  *(ushort *)(iVar5 + iVar7 + 4) = uVar1 & 0xffcf | (ushort)uVar8;
  cVar9 = '\0';
  iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
  *(short *)(iVar7 + 0x34 + iVar5) = (short)((uVar3 * 0xe + 0x1400) * 0x10000 >> 0x10);
  while( true ) {
    cVar9 = cVar9 + '\x01';
    if (sStack_42 == 0) break;
    bVar6 = *(char *)(iVar2 + 0x52) * '\t' + cVar9;
    iVar5 = (**(code **)(_r_ip_funcs_p + 0x2e8))
                      (param_1,(uint)bVar6,7,0,*(ushort *)(iVar2 + 0x48) >> 6 & 1,0,&sStack_46,
                       &uStack_44);
    *(int *)(iVar2 + 0x44) = *(int *)(iVar2 + 0x44) + iVar5;
    iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1400,*(code **)(_r_plf_funcs_p + 0xbc));
    uVar1 = *(ushort *)(iVar5 + uVar3 * 0xe);
    iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1400,*(code **)(_r_plf_funcs_p + 0xbc));
    *(ushort *)(uVar3 * 0xe + iVar5) = (ushort)bVar6 * 0xe + 0x1400 | uVar1 & 0x8000;
    uVar3 = (uint)bVar6;
  }
