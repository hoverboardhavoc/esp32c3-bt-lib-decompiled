...

{
  ...
  if (iVar2 != 0) {
    if (1 < (byte)(*(char *)(iVar2 + 0x53) - 1U)) {
      (**(code **)(_r_plf_funcs_p + 8))(0,0x10000,0x456,*(code **)(_r_plf_funcs_p + 8));
    }
    ...
    if (*(char *)(iVar2 + 0x53) == '\x02') {
      ...
      *(char *)(iVar2 + 0x16) = *(char *)(iVar2 + 0x16) + rwip_priority;
      UNRECOVERED_JUMPTABLE = *(code **)(_r_ip_funcs_p + 0x300);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00011870. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(param_1,UNRECOVERED_JUMPTABLE);
    return;
  }
                    /* WARNING: Could not recover jumptable at 0x000118b6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
