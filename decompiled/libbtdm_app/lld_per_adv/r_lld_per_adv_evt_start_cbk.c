...

{
  ...
  if (iVar4 == 0) {
    if (param_1 == 0) {
      (**(code **)(_r_plf_funcs_p + 8))("lld_per_adv.c",0x3ab,*(code **)(_r_plf_funcs_p + 8));
    }
    else {
      ...
      iVar4 = _r_ip_funcs_p;
      *(undefined2 *)(iVar5 + iVar7 + 0x50) = uVar2;
      (**(code **)(iVar4 + 0x798))(param_1,*(code **)(iVar4 + 0x798));
      ...
      if (((uint)bStack_41 << 7 & 0xffffff7f) != 0) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"lld_per_adv.c",0x82,*(code **)(_r_plf_funcs_p + 8));
      }
      iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      ...
      *(ushort *)(iVar4 + iVar7) = uVar3 & 0xff7f | (ushort)((uint)bStack_41 << 7);
      ...
      if ((uVar8 & 0xffffffbf) != 0) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"lld_per_adv.c",0x8e,*(code **)(_r_plf_funcs_p + 8));
      }
      iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      uVar3 = *(ushort *)(iVar4 + iVar7);
      iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
