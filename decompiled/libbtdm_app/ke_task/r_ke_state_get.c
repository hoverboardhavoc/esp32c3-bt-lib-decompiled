...

{
  ...
  if (uVar1 < 0x1f) {
    ...
    (**(code **)(_r_plf_funcs_p + 8))(0,"ke_task.c",0x1d7,*(code **)(_r_plf_funcs_p + 8));
_L100:
    (**(code **)(_r_plf_funcs_p + 0xc))
              (uVar1,param_1,"ke_task.c",0x1de,*(code **)(_r_plf_funcs_p + 0xc));
    ebreak();
  }
  (**(code **)(_r_plf_funcs_p + 0xc))(param_1,"ke_task.c",0x1df,*(code **)(_r_plf_funcs_p + 0xc));
