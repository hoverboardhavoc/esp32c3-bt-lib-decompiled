...

{
  ...
  uVar1 = param_2 & 0xff;
  if (0x1e < uVar1) {
    (**(code **)(_r_plf_funcs_p + 0xc))(uVar1,"ke_task.c",0x14a,*(code **)(_r_plf_funcs_p + 0xc));
  }
  piVar2 = *(int **)(&ke_task_env + uVar1 * 4);
  if ((*(ushort *)(piVar2 + 2) != 0) &&
     (((param_2 >> 8 < (uint)*(ushort *)(piVar2 + 2) ||
       ((**(code **)(_r_plf_funcs_p + 0xc))
                  (param_2,param_1,"ke_task.c",0x152,*(code **)(_r_plf_funcs_p + 0xc)),
       param_2 >> 8 < (uint)*(ushort *)(piVar2 + 2))) && (*piVar2 != 0)))) {
                    /* WARNING: Could not recover jumptable at 0x0001039a. Too many branches */
