  ...
  if (((*(ushort *)(iVar6 + iVar9) & 0xf) == 3) &&
    ...
    *puVar8 = (char)param_1;
    ...
    memcpy(puVar8 + 2,auStack_34,6);
                    /* WARNING: Could not recover jumptable at 0x00013b44. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_modules_funcs_p + 0xe0))(puVar8);
    return;
  }
                    /* WARNING: Could not recover jumptable at 0x00013a2a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x849);
  return;
}
