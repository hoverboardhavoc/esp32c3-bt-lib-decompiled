...

{
  ...
  if ((*(ushort *)(iVar3 + iVar2 + 4) & 0xf) != 5) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x86a,*(code **)(_r_plf_funcs_p + 8));
    return 0;
  }
  iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
  pvVar4 = (void *)(**(code **)(_r_plf_funcs_p + 0xbc))
                             (*(undefined2 *)(iVar2 + 0x12 + iVar3),
  ...
  if (((*(char *)(iVar3 + 0x24) != '\0') && (*(code **)(_r_ip_funcs_p + 0x9e0) != (code *)0x0)) &&
     (iVar3 = (**(code **)(_r_ip_funcs_p + 0x9e0))(uStack_38), iVar3 == 0)) {
    return 0;
  }
  ...
  if (uVar5 < _g_ble_con_interval_min) {
    return 0;
  }
  if (0xc80 < uVar5) {
    return 0;
  ...
  if ((uint)uStack_2a << 2 <= (ushort)(uStack_2c + 1) * uVar5) {
    return 0;
  }
  ...
  if (uVar5 == 0) {
    ...
    if (((*(ushort *)(iVar3 + iVar2) >> 1 & 1) != 0) &&
       (iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0xc60,*(code **)(_r_plf_funcs_p + 0xbc)),
       (*(ushort *)(iVar2 + iVar3) >> 0xb & 1) == 0)) {
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x8a2,*(code **)(_r_plf_funcs_p + 8));
    }
  }
  uStack_54 = 0;
  uStack_50 = 0;
_L722:
  ...
  if ((*(ushort *)(param_1 * 0x5a + 0x14 + iVar2) >> 2 & 1) == 0) {
    ...
    uVar7 = uVar5 & 0xff;
    if (9 < uVar7) {
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x8b6,*(code **)(_r_plf_funcs_p + 8));
    }
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0xc60,*(code **)(_r_plf_funcs_p + 0xbc));
    iVar2 = (uVar5 & 0xff) * 0x34;
    if ((*(ushort *)(iVar3 + iVar2) >> 5 & 1) == 0) {
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x8b7,*(code **)(_r_plf_funcs_p + 8));
    }
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0xc60,*(code **)(_r_plf_funcs_p + 0xbc));
    if ((*(ushort *)(iVar2 + iVar3) >> 7 & 1) == 0) {
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x8b8,*(code **)(_r_plf_funcs_p + 8));
    }
    pvVar4 = (void *)(**(code **)(_r_plf_funcs_p + 0xbc))
