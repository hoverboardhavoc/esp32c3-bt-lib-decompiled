  ...
  if (*(int *)(&lld_adv_env + param_1 * 4) == 0) {
    ...
    *(void **)(&lld_adv_env + param_1 * 4) = __s;
    if (__s != (void *)0x0) {
      ...
      *(undefined2 *)(iVar4 + 0x16 + iVar7) = 0x8027;
      if (*(char *)((int)__s + 0x8d) != '\x7f') {
        pcVar10 = *(code **)(_r_modules_funcs_p + 0x1fc);
        uVar8 = (*_lld_exp_sync_pos_tab)(0,_lld_exp_sync_pos_tab);
        (*pcVar10)(param_1,uVar8);
      }
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 0x18 + iVar7) = 0;
      (**(code **)(_r_ip_funcs_p + 0x1e0))(param_1,uVar6,*(code **)(_r_ip_funcs_p + 0x1e0));
      bVar1 = *(byte *)((int)__s + 0x87);
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar4 + 0x1c + iVar7) = ((ushort)bVar1 * 9 & 0xff) * 0xe + 0x1400;
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 0xc + iVar7) = 0xbed6;
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 0xe + iVar7) = 0x8e89;
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 0x10 + iVar7) = 0x5555;
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 0x12 + iVar7) = 0x55;
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 0x28 + iVar7) = 0;
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 0x2a + iVar7) = 0;
      uVar2 = *(ushort *)((int)__s + 0x74);
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar4 + 0x20 + iVar7) = (ushort)((int)(uint)uVar2 >> 1) & 8;
      ...
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar4 + 4 + iVar7) = (ushort)uVar9 | (ushort)((uint)bVar1 << 2) | (ushort)bVar1;
      bVar1 = *(byte *)(param_2 + 0xf);
      if ((param_1 & 0xffffffe0) != 0) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0xe6,*(code **)(_r_plf_funcs_p + 8));
      }
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar4 + 2 + iVar7) = (ushort)((bVar1 & 1) << 7) | (ushort)param_1 | 0x800;
      uVar3 = *param_2;
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 6 + iVar7) = uVar3;
      uVar3 = param_2[1];
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 8 + iVar7) = uVar3;
      uVar3 = param_2[2];
      iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(undefined2 *)(iVar4 + 10 + iVar7) = uVar3;
      ...
      *(ushort *)(iVar7 + iVar4 + 0x26) = uVar2 & 0xff1f | (ushort)uVar9;
      (*pcVar10)(param_1,param_2,uVar5,pcVar10);
      (**(code **)(_r_ip_funcs_p + 0x194))(__s,*(code **)(_r_ip_funcs_p + 0x194));
      return 0;
    }
    (**(code **)(_r_plf_funcs_p + 8))("lld_adv.c",0xde2,*(code **)(_r_plf_funcs_p + 8));
  }
  return 0xc;
}
