...
void r_lld_adv_adv_data_update(int param_1,int param_2,undefined2 param_3)
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      (**(code **)(_r_plf_funcs_p + 0xc))
                (param_1,0,"lld_adv.c",0xda7,*(code **)(_r_plf_funcs_p + 0xc));
    }
  }
  else if (*(char *)(iVar1 + 0x89) == '\0') {
    (**(code **)(_r_ip_funcs_p + 0x17c))(param_1,1,0,*(code **)(_r_ip_funcs_p + 0x17c));
  }
  else {
    ...
    *(undefined2 *)(iVar1 + 0x24) = param_3;
    if (param_2 == 0) {
      adv_adv_data_need_to_set[param_1] = 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001621e. Too many branches */
