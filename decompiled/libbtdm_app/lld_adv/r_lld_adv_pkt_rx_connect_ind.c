...

{
  ...
  if ((*(ushort *)(iVar3 + iVar2 + 4) & 0xf) != 5) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x7f8,*(code **)(_r_plf_funcs_p + 8));
    return 0;
  }
  iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
  ...
  if (uVar5 == 0) {
    ...
    if (((*(ushort *)(iVar3 + iVar2) >> 1 & 1) != 0) &&
      ...
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x82b,*(code **)(_r_plf_funcs_p + 8));
    }
  }
  uStack_54 = 0;
  uStack_50 = 0;
_L690:
  ...
  if ((*(ushort *)(param_1 * 0x5a + 0x14 + iVar2) >> 2 & 1) == 0) {
    ...
    uVar7 = uVar5 & 0xff;
    if (9 < uVar7) {
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x842,*(code **)(_r_plf_funcs_p + 8));
    }
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0xc60,*(code **)(_r_plf_funcs_p + 0xbc));
    iVar2 = (uVar5 & 0xff) * 0x34;
    if ((*(ushort *)(iVar3 + iVar2) >> 5 & 1) == 0) {
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x843,*(code **)(_r_plf_funcs_p + 8));
    }
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0xc60,*(code **)(_r_plf_funcs_p + 0xbc));
    if ((*(ushort *)(iVar2 + iVar3) >> 7 & 1) == 0) {
      (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x844,*(code **)(_r_plf_funcs_p + 8));
    }
    pvVar4 = (void *)(**(code **)(_r_plf_funcs_p + 0xbc))
