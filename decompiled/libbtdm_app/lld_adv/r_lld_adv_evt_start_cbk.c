...

{
  ...
  if (iVar5 == 0) {
    if (param_1 == 0) {
      ...
      uVar13 = 0;
      uVar8 = *(ushort *)(iVar5 + iVar10) & 0x1f;
      ...
      if (uVar14 != 0) {
        ...
        *(ushort *)(iVar6 + 8 + iVar5) =
        ...
        iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1400,*(code **)(_r_plf_funcs_p + 0xbc));
        *(ushort *)(iVar6 + 10 + iVar5) = (ushort)(uVar9 >> 8) | (ushort)bVar2 << 5;
      }
      (**(code **)(_r_ip_funcs_p + 0x1e0))(uVar12,uVar8,*(code **)(_r_ip_funcs_p + 0x1e0));
      (**(code **)(_r_ip_funcs_p + 0x19c))(param_1,0,uVar13,*(code **)(_r_ip_funcs_p + 0x19c));
      (**(code **)(_r_modules_funcs_p + 0x1e0))
                (uVar8,uVar12,&bStack_61,&uStack_60,*(code **)(_r_modules_funcs_p + 0x1e0));
      if ((bStack_61 & 0xfe) != 0) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",0x82,*(code **)(_r_plf_funcs_p + 8));
      }
      iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      uVar8 = *(ushort *)(iVar5 + iVar10);
      iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar5 + iVar10) = uVar8 & 0xff7f | (ushort)bStack_61 << 7;
      ...
      uVar8 = *(ushort *)(iVar5 + iVar10);
      iVar5 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar10 + iVar5) = uVar8 & 0xffbf | (ushort)(byte)uStack_60 << 6;
      ...
      uStack_50 = uVar12;
      bStack_48 = bVar1;
      (**(code **)(_r_ip_funcs_p + 0x6c8))(&uStack_60,*(code **)(_r_ip_funcs_p + 0x6c8));
      *(undefined1 *)(param_1 + 0x89) = 1;
    }
                    /* WARNING: Could not recover jumptable at 0x00013ee6. Too many branches */
