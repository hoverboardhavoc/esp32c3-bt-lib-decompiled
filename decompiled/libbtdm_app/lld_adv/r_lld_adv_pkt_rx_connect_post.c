...

{
  ...
  iVar10 = (uint)bVar6 * 0x14;
  uVar1 = *(ushort *)(iVar10 + 10 + iVar4);
  if (0xfff < uVar1) {
    (**(code **)(_r_plf_funcs_p + 8))(0,"lld_adv.c",1000,*(code **)(_r_plf_funcs_p + 8));
  }
  iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
  uVar11 = CONCAT22(uVar1,*(undefined2 *)(iVar10 + 8 + iVar4));
  iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
  uVar1 = *(ushort *)(iVar10 + 0xc + iVar4);
  iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
  uVar8 = (uint)(*(ushort *)(iVar4 + iVar10 + 6) >> 0xe);
  ...
  if (((DAT_00017078 & 8) != 0) && ((uVar8 - 2 & 0xff) < 2)) {
    uVar2 = uVar5 + (uint)_DAT_0001707a * -2;
    uVar5 = uVar2 & 0xffff;
    uVar2 = (int)(uVar2 * 0x10000) >> 0x10;
  }
  ...
  *puVar3 = (char)param_1;
  ...
  if ((*(ushort *)(iVar4 + 0x74) & 0x10) != 0) {
    iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
    bVar6 = (byte)(*(ushort *)(iVar10 + 4 + iVar4) >> 5) & 1;
  }
  iVar4 = *(int *)(&lld_adv_env + param_1 * 4);
  puVar3[0x36] = bVar6;
  uVar7 = 0;
  if (*(short *)(iVar4 + 0x78) != 0) {
    uVar7 = *(undefined1 *)(iVar4 + 0x86);
  }
  puVar3[0x38] = uVar7;
  ...
  *(undefined2 *)(puVar3 + 0x22) = *(undefined2 *)(param_2 + 0x1a);
  ...
  puVar3[0x37] = param_6;
  *(uint *)(puVar3 + 0x30) = uVar11;
  pcVar9 = *(code **)(iVar4 + 0xbc);
  *(short *)(puVar3 + 0x2c) = (short)uVar2;
  iVar4 = (*pcVar9)(0x1000,pcVar9);
  puVar3[0x34] = (byte)((ushort)*(undefined2 *)(iVar4 + iVar10 + 6) >> 0xe);
                    /* WARNING: Could not recover jumptable at 0x0001339c. Too many branches */
