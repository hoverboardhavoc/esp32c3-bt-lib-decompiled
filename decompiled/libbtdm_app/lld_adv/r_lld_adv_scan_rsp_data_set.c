...

{
  ...
  if ((*(ushort *)(iVar3 + 0x74) & 0x10) == 0) {
    ...
    *(undefined2 *)(iVar3 + 0x80) = param_3;
    (*UNRECOVERED_JUMPTABLE)(*(undefined1 *)(iVar3 + 0x87),UNRECOVERED_JUMPTABLE);
  }
  else {
    ...
    *(undefined2 *)(iVar7 + iVar3 + 4) = param_3;
    ...
    *(ushort *)(iVar7 + iVar3) = (short)uVar2 * 0xe + 0x1400U | uVar4 & 0x8000;
    iVar5 = (**(code **)(iVar5 + 0x1a0))(2,*(code **)(iVar5 + 0x1a0));
    if (iVar5 != 0) {
  ...
  if ((param_4 != 0) && (sVar6 != 0)) {
    if (param_5 == 0) {
      ...
      UNRECOVERED_JUMPTABLE = *(code **)(_r_ip_funcs_p + 0xdc);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00013066. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(sVar6);
    return;
  }
  return;
}
