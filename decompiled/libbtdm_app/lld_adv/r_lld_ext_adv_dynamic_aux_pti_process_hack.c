 ...
 * Source: libbtdm_app -> lld_adv.o -> r_lld_ext_adv_dynamic_aux_pti_process_hack
 *
...
void r_lld_ext_adv_dynamic_aux_pti_process_hack(uint param_1,uint param_2,int param_3)
