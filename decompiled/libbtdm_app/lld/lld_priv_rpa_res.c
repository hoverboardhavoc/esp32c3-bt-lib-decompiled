  ...
  do {
    ...
    if (cVar1 != '\0') {
      if ((param_1 == (void *)0x0) || (iVar6 = memcmp(param_1,pcVar10 + 1,6), iVar6 != 0)) {
        if (param_2 != (void *)0x0) goto _L211;
_L195:
        cVar4 = cVar12;
        cVar5 = cVar1;
        cVar3 = cVar12;
        if (cVar11 == '\0') goto _L192;
      }
      else {
        cVar11 = cVar1;
        cVar4 = cVar12;
...
_L202:
        *param_3 = (short)(uVar8 & 0xff) * 0x34 + 0xc60;
        if (param_1 != (void *)0x0) {
          memcpy(&DAT_00011285 + uVar8 * 0xd,param_1,6);
        }
        if (param_2 != (void *)0x0) {
          memcpy(&DAT_0001128b + uVar8 * 0xd,param_2,6);
        }
