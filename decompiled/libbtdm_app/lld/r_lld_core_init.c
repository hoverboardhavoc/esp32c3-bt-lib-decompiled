...

{
  ...
  uVar3 = (uint)_rwip_prog_delay;
  _DAT_60031000 = (int)(DAT_0001402e + 1) >> 1 | 0x100600;
  ...
  do {
    ...
    iVar4 = _r_ip_funcs_p;
    *(short *)(iVar5 + iVar2) = (short)(((uVar7 % 10) * 0x14 + 0x1000) * 0x10000 >> 0x10);
    ...
    iVar4 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
    *(ushort *)(iVar5 + iVar4) = uVar1 & 0x7fff | 0x8000;
    uVar3 = uVar7;
  } while (uVar7 != 10);
  iVar2 = 3;
  if (DAT_0001401a == '\0') {
