...

{
  ...
  if (uVar2 < *(byte *)(_p_ble_util_buf_env + 0x1bb)) {
    ...
    (**(code **)(_r_modules_funcs_p + 0x4c))
               ...
               *(code **)(_r_modules_funcs_p + 0x4c));
                    /* WARNING: Could not recover jumptable at 0x00010884. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_osi_funcs_p + 0x18))();
    return;
  }
                    /* WARNING: Could not recover jumptable at 0x000108a2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(_r_ip_funcs_p + 0x738))(0,param_1);
  return;
}
