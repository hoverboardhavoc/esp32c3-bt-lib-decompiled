...

{
  ...
  if (param_1 != 0) {
    ...
    do {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00010d1c. Too many branches */
  ...
  if (_DAT_6003100c == 0) {
                    /* WARNING: Could not recover jumptable at 0x00010dea. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(_r_plf_funcs_p + 8))(0,"arch_main.c",0x3c2,*(code **)(_r_plf_funcs_p + 8));
    return;
  }
  return;
}
