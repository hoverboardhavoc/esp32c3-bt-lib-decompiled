...

{
  if (param_1 == 0) {
    ...
    _DAT_00013118 = *(undefined4 *)(_r_h4tl_eif_p + 0x20);
    _DAT_00013114 = *(undefined4 *)(_r_h4tl_eif_p + 0x24);
    return &g_eif_api;
  }
  (**(code **)(_r_plf_funcs_p + 0xc))(0,"arch_main.c",0x758,*(code **)(_r_plf_funcs_p + 0xc));
