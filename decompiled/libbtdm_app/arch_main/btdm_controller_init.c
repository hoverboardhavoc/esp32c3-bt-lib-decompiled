...

{
  ...
  if ((((_r_plf_funcs_p == (void *)0x0) ||
      ...
      _r_ip_funcs_p == (void *)0x0)) || (iVar9 = r_llm_handler_tab_create(), iVar9 == 0)) {
  ...
  config_funcs_reset();
  if ((*param_1 == 0x5a5aa5a5) && (param_1[1] == 0x2103080)) {
    if (((((uint)param_1[0xb] >> 0x10) - 1 & 0xff) < 2) &&
      ...
      if (*(byte *)((int)param_1 + 0x1e) < 0x10) {
        ...
        if ((*(char *)((int)param_1 + 0x17) != '\0') ||
           (iVar9 = (**(code **)((int)_r_plf_funcs_p + 0xe8))
                              (param_1[6],*(code **)((int)_r_plf_funcs_p + 0xe8)), iVar9 == 0)) {
          iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))(*(code **)((int)_r_plf_funcs_p + 0x38));
          uStack_34 = *(undefined1 *)(iVar9 + 0xd);
          bStack_33 = DAT_00012027;
          ...
          if (_btdm_env_p != (int *)0x0) {
            ...
            iVar9 = (**(code **)((int)_r_ip_funcs_p + 0x244))
            ...
            ;
            if ((iVar13 != 0) && (iVar12 != 0 && (iVar11 != 0 && iVar9 != 0))) {
              iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))
                                (*(code **)((int)_r_plf_funcs_p + 0x38));
              bVar1 = *(byte *)(iVar9 + 0xd);
              iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))
                                (*(code **)((int)_r_plf_funcs_p + 0x38));
              bVar2 = *(byte *)(iVar9 + 0xd);
              uVar16 = (uint)DAT_00012027;
              iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))
                                (*(code **)((int)_r_plf_funcs_p + 0x38));
              piVar6 = _btdm_env_p;
              iVar11 = 0;
              if (DAT_00012026 != '\0') {
                iVar11 = uVar16 * 0xe0 + (uint)*(byte *)(iVar9 + 0xd) * 0x88;
              }
              pcVar14 = *(code **)(_r_osi_funcs_p + 0x78);
              _btdm_env_p[1] =
                   ((bVar2 + 2) * 0xc + (uint)bVar1 * 0xe6 + 0x25b + iVar11 & 0xfffffffc) + 0xc;
              iVar9 = (*pcVar14)(pcVar14);
              pvVar5 = _r_plf_funcs_p;
              *piVar6 = iVar9;
              iVar9 = (**(code **)((int)pvVar5 + 0x38))(*(code **)((int)pvVar5 + 0x38));
              piVar6 = _btdm_env_p;
              uVar16 = 0;
              if (DAT_00012026 != '\0') {
                uVar16 = (uint)DAT_00012027 * 400;
                if ((uint)DAT_00012027 * 400 < 0x1800) {
                  uVar16 = 0x1800;
                }
              }
              pcVar14 = *(code **)(_r_osi_funcs_p + 0x78);
              _btdm_env_p[3] =
                   (((uint)*(byte *)(iVar9 + 0xd) * 0x104 + 0x8ef) * 2 + 0x675 + uVar16 & 0xfffffffc
                   ) + 0xc;
              iVar9 = (*pcVar14)(pcVar14);
              piVar6[2] = iVar9;
              piVar6 = _btdm_env_p;
              _btdm_env_p[5] = 0x29c;
              iVar9 = (**(code **)(_r_osi_funcs_p + 0x78))(0x29c,*(code **)(_r_osi_funcs_p + 0x78));
              cVar8 = DAT_00012026;
              piVar6[4] = iVar9;
              piVar6 = _btdm_env_p;
              if (cVar8 != '\0') {
              ...
              if ((((*_btdm_env_p != 0) && (_btdm_env_p[2] != 0)) && (_btdm_env_p[4] != 0)) &&
                ...
                if ((*(char *)(iVar9 + 0x17) != '\0') &&
                   (iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))
                                      (*(code **)((int)_r_plf_funcs_p + 0x38)), piVar6 = _btdm_env_p
                   , *(char *)(iVar9 + 0x17) == '\x01')) {
                  iVar9 = (**(code **)(_r_osi_funcs_p + 0x78))
                                    (0xc,*(code **)(_r_osi_funcs_p + 0x78));
                  piVar7 = _btdm_env_p;
                  piVar6[9] = iVar9;
                  if ((void *)piVar7[9] == (void *)0x0) goto _L238;
                ...
                if (_g_rw_init_sem == 0) {
                  ...
                  if (_g_rw_schd_queue == 0) {
                    ...
                    if (_g_rw_schd_sem == 0) {
                      ...
                      iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))
                                        (*(code **)((int)_r_plf_funcs_p + 0x38));
                      uVar4 = *(undefined2 *)(iVar9 + 8);
                      iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))
                                        (*(code **)((int)_r_plf_funcs_p + 0x38));
                      uVar3 = *(undefined1 *)(iVar9 + 10);
                      iVar9 = (**(code **)((int)_r_plf_funcs_p + 0x38))
                                        (*(code **)((int)_r_plf_funcs_p + 0x38));
                      iVar9 = (*pcVar14)(btdm_controller_task,"btController",uVar4,0,uVar3,
