...

{
  ...
  uVar16 = 0xffffffff;
  if (_g_rw_init_sem != 0) goto _L281;
  _r_plf_funcs_p =
  ...
  if (((_r_plf_funcs_p == (void *)0x0) ||
     ...
     (_r_ip_funcs_p =
           (void *)(**(code **)(_r_osi_funcs_p + 0x78))(0x928,*(code **)(_r_osi_funcs_p + 0x78)),
  ...
  memcpy(_r_ip_funcs_p,&r_ip_funcs_ro,0x928);
  if ((*param_1 == 0x5a5aa5a5) && (param_1[1] == 0x2302140)) {
        ...
        if (*(byte *)((int)param_1 + 0x1e) < 0x10) {
                                 ...
                                 (param_1[6],*(code **)((int)_r_plf_funcs_p + 0xe8)), iVar11 == 0))
          {
            ...
            if (_btdm_env_p != (int *)0x0) {
              ...
              iVar12 = (**(code **)((int)_r_ip_funcs_p + 0xe4))
                                 (*(code **)((int)_r_ip_funcs_p + 0xe4));
              iVar13 = (**(code **)((int)_r_plf_funcs_p + 0x4c))
                                 (*(code **)((int)_r_plf_funcs_p + 0x4c));
              iVar14 = (**(code **)((int)_r_ip_funcs_p + 0x44))
                                 (*(code **)((int)_r_ip_funcs_p + 0x44));
              if ((iVar14 != 0) && (iVar13 != 0 && (iVar12 != 0 && iVar11 != 0))) {
                ...
                *piVar7 = iVar11;
                ...
                uVar17 = 0;
                if (DAT_00012032 != '\0') {
                  uVar17 = (uint)DAT_00012033 * 400;
                  if ((uint)DAT_00012033 * 400 < 0x1800) {
                    uVar17 = 0x1800;
                  }
                }
                pcVar15 = *(code **)(_r_osi_funcs_p + 0x78);
                ...
                if ((((*_btdm_env_p != 0) && (_btdm_env_p[2] != 0)) && (_btdm_env_p[4] != 0)) &&
                  ...
                  if ((*(char *)(iVar11 + 0x17) != '\0') &&
                    ...
                    piVar8 = _btdm_env_p;
                    piVar7[9] = iVar11;
                    if ((void *)piVar8[9] == (void *)0x0) goto _L299;
