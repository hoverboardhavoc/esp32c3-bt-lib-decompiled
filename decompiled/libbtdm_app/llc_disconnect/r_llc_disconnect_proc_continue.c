...

{
  ...
  if (param_2 == 0) {
    ...
    if (iVar2 == 0) {
      ...
      *(undefined1 *)(iVar4 + 0x46) = *(undefined1 *)(iVar1 + 9);
      ...
      (**(code **)(_r_ip_funcs_p + 0x688))(param_1,0,0,*(code **)(_r_ip_funcs_p + 0x688));
                    /* WARNING: Could not recover jumptable at 0x0001017a. Too many branches */
    ...
    if (iVar2 == 1) {
      ...
      (*pcVar5)(param_1,uVar3,"llc_disconnect.c",0xc0);
    }
  }
                    /* WARNING: Could not recover jumptable at 0x000101a0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
