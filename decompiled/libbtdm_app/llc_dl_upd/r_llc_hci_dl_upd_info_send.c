 ...
 * Source: libbtdm_app -> llc_dl_upd.o -> r_llc_hci_dl_upd_info_send
 *
...

{
  ...
  *puVar2 = 7;
  *(undefined2 *)(puVar2 + 8) = param_5;
  iVar1 = _r_ip_funcs_p;
  *(short *)(puVar2 + 2) = (short)param_1;
  *(undefined2 *)(puVar2 + 4) = param_3;
  *(undefined2 *)(puVar2 + 6) = param_2;
  UNRECOVERED_JUMPTABLE = *(code **)(iVar1 + 0x8c);
  *(undefined2 *)(puVar2 + 10) = param_4;
