 ...
 * Source: libbtdm_app -> lld_debug_snap.o -> ble_debug_controller_snap
 *
...

{
  ...
  iVar15 = (**(code **)(_r_plf_funcs_p + 0x38))(*(code **)(_r_plf_funcs_p + 0x38));
  bVar1 = *(byte *)(iVar15 + 0xd);
  piVar35 = (int *)&lld_con_env;
  uVar16 = (**(code **)(_r_modules_funcs_p + 0x2c4))(*(code **)(_r_modules_funcs_p + 0x2c4));
  ...
  do {
    ...
    if (bVar1 <= uVar27) {
      ...
      ;
      do {
        iVar17 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
        ...
        if ((uVar7 & 0xf000) != 0) {
          (**(code **)(_r_plf_funcs_p + 8))
                    (0,"lld_debug_snap.c",1000,*(code **)(_r_plf_funcs_p + 8));
        }
        iVar17 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc));
      ...
      ets_printf(&__c_5,(int)DAT_00011049);
      ets_printf(">D %08lx %08lx\n",_DAT_60031054,_DAT_60031054);
      pcVar13 = &g_event_empty;
      pcVar19 = (char *)(**(code **)(_r_ip_funcs_p + 0x91c))(*(code **)(_r_ip_funcs_p + 0x91c));
    ...
    iVar28 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
