...

{
  ...
  if (*(char *)(_p_llm_env + 0xd7) == '\x01') goto _L500;
  *(undefined1 *)(_p_llm_env + 0xd7) = 2;
  iVar3 = 0x12;
  if ((1 < *param_1) || (0xef < param_1[1])) goto _L501;
    ...
    if (uVar9 != 0xff) {
      ...
      if ((short)piVar8[0xb] == 0) {
        ...
        if (*param_1 == 0) {
          ...
          if (cVar2 != '\f') {
            iVar3 = 0xfe;
            if ((_sdk_cfg_priv_opts & 0x10) != 0) goto _L501;
            goto _L500;
          }
