...
_L259:
  ...
  *(undefined1 *)(_p_llm_env + 0xd7) = 2;
  ...
  if (((uVar5 & 2) == 0) && (uVar9 = 0x12, uVar10 != 0)) goto _L286;
  iVar8 = iVar7 * 0x44;
  ...
  if (*(char *)(iVar11 + 0x40) != '\x01') {
    ...
    goto _L259;
    uVar9 = 0x12;
    if (((uVar5 & 0x12) == 0x12) && (0x1f < uVar10)) goto _L286;
  }
...
_L320:
      ...
      *(undefined2 *)(iVar11 + 0x36) = uVar6;
      if ((*(short *)(*(int *)(iVar4 + 8) + iVar8 + 0x36) == 0) && (!bVar3)) goto _L321;
    }
    bVar1 = param_1[3];
    if (bVar1 != 0) {
      iVar11 = *(int *)(_p_llm_env + 8) + iVar8;
