...
_L235:
  ...
  *(undefined1 *)(_p_llm_env + 0xd7) = 2;
  ...
  if ((uVar5 & 0x10) == 0) {
    if ((bVar1 != 3) && (uVar9 == 0)) goto _L263;
  }
  else if ((bVar1 != 3) || (0x1f < uVar9)) goto _L263;
  if (((uVar5 & 2) == 0) && (uVar8 = 0x12, uVar9 != 0)) goto _L263;
  iVar4 = iVar7 * 0x44;
  iVar10 = *(int *)(_p_llm_env + 8) + iVar4;
  if (*(char *)(iVar10 + 0x40) != '\x01') {
    if ((bVar1 != 3) || ((((uVar5 & 2) != 0 && (uVar9 == 0)) && ((uVar5 & 0x10) == 0)))) goto _L235;
    uVar8 = 0x12;
    if (((uVar5 & 0x12) == 0x12) && (0x1f < uVar9)) goto _L263;
  }
...
_L296:
      ...
      if ((*(short *)(*(int *)(_p_llm_env + 8) + iVar4 + 0x36) == 0) && (!bVar3)) goto _L297;
    }
    bVar1 = param_1[3];
    if (bVar1 != 0) {
      iVar10 = *(int *)(_p_llm_env + 8) + iVar4;
