...
_L333:
    if (*param_1 != 1) {
      if (*(char *)((int)param_1 + 1) == '\0') {
        for (uVar8 = 0;
          ...
          if ((*(char *)(*(int *)(_p_llm_env + 8) + uVar8 * 0x44 + 0x40) == '\x02') &&
             (psVar2 = (short *)(**(code **)(_r_ip_funcs_p + 0x1e8))
                                          (uVar8,*(code **)(_r_ip_funcs_p + 0x1e8)),
        ...
        bVar9 = 0;
        do {
          if (0xef < *(byte *)((int)param_1 + uVar8 + 2)) goto _L334;
          ...
          if (((short)piVar6[0xb] != 0) || (*(short *)((int)piVar6 + 0x36) != 0)) goto _L334;
          if ((char)*param_1 == '\x01') {
            iVar4 = *piVar6;
            uVar1 = *(ushort *)(iVar4 + 2);
            if (((uVar1 & 2) != 0) && ((uVar1 & 0x10) == 0 && (short)piVar6[0xd] == 0)) goto _L338;
            if (((uVar1 & 0x11) == 1) &&
               (iVar3 = (**(code **)(_r_ip_funcs_p + 0x540))
                                  (iVar4,*(undefined2 *)((int)piVar6 + 0x2a),
                                   *(code **)(_r_ip_funcs_p + 0x540)), iVar3 != 0)) goto _L334;
            if ((*(ushort *)(iVar4 + 2) & 1) != 0) {
              if (((*(ushort *)(iVar4 + 2) & 0xc) != 0) &&
                 (iVar3 = (**(code **)(_r_ip_funcs_p + 0x4d8))
                                    (iVar4 + 0xd,*(undefined1 *)(iVar4 + 0xc),
            ...
            if (((*(byte *)(iVar4 + 0xb) & 1) != 0) &&
               (iVar4 = (*(code *)*_r_modules_funcs_p)
                                  (*(int *)(_p_llm_env + 8) + iVar13 * 0x44 + 4,&co_null_bdaddr,
                                   (code *)*_r_modules_funcs_p), iVar4 != 0)) goto _L334;
          }
          else if (((_DAT_00014032 & 2) == 0) && ((char)piVar6[0x10] != '\x02')) goto _L338;
        ...
        if (bVar9 != 0) {
          ...
          for (uVar8 = 0;
              ...
              uVar8 < *(byte *)(iVar13 + 0xd); uVar8 = uVar8 + 1 & 0xff) {
            bVar10 = bVar10 + (*(char *)(*(int *)(_p_llm_env + 8) + uVar8 * 0x44 + 0x40) == '\0');
            if (bVar9 <= bVar10) goto _L353;
          }
          iVar13 = 7;
          if (bVar10 < bVar9) goto _L330;
        }
_L353:
        for (uVar8 = 0; iVar13 = _p_llm_env, uVar8 < *(byte *)((int)param_1 + 1);
            uVar8 = uVar8 + 1 & 0xff) {
          uVar11 = (uint)*(byte *)((int)param_1 + uVar8 + 2);
          iVar4 = uVar11 * 0x44;
          piVar6 = (int *)(*(int *)(_p_llm_env + 8) + iVar4);
          if ((char)piVar6[0x10] == '\x02') {
            if ((char)*param_1 == '\0') {
_L355:
              if ((((_DAT_00014032 & 2) == 0) || ((char)piVar6[0x10] == '\x02')) &&
                 (iVar3 = (**(code **)(_r_ip_funcs_p + 0x1e8))
                                    (uVar11,*(code **)(_r_ip_funcs_p + 0x1e8)), iVar13 = _p_llm_env,
                 iVar3 == 0)) {
              ...
              (**(code **)(_r_ip_funcs_p + 0x1d4))
                        (uVar11,param_1[uVar8 + 6],*(char *)((int)param_1 + uVar8 + 0x20),
                         *(code **)(_r_ip_funcs_p + 0x1d4));
              piVar6 = (int *)(*(int *)(_p_llm_env + 8) + iVar4);
              iVar13 = *piVar6;
              if ((iVar13 != 0) && ((*(ushort *)(iVar13 + 2) & 1) != 0)) {
                bVar9 = *(byte *)((int)piVar6 + 0x3e);
            ...
            *(undefined1 *)(iVar13 + 0x40) = 2;
            ...
            if (((*(ushort *)(iVar3 + 2) & 0x13) == 0) &&
              ...
              if ((char)piVar6[0x10] != '\v') goto _L366;
              iVar3 = *piVar6;
              ...
              iVar4 = (**(code **)(_r_ip_funcs_p + 0x308))
              ...
              if (iVar4 == 0) {
                ...
                *(ushort *)(iVar13 + 0x20) = (ushort)bVar9;
                *(undefined4 *)(iVar13 + 0x1c) = uStack_7c;
                iVar4 = _r_ip_funcs_p;
                *(undefined4 *)(iVar13 + 0x24) = 0;
                (**(code **)(iVar4 + 0x6fc))(iVar13 + 0xc,*(code **)(iVar4 + 0x6fc));
