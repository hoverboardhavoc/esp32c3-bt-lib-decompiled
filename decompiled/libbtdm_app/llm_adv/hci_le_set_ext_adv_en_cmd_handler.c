      ...
      if (*(char *)((int)param_1 + 1) == '\0') {
        for (uVar9 = 0;
          ...
          if ((*(char *)(*(int *)(_p_llm_env + 8) + uVar9 * 0x44 + 0x40) == '\x02') &&
             (iVar4 = (**(code **)(_r_ip_funcs_p + 0x1e8))(uVar9,*(code **)(_r_ip_funcs_p + 0x1e8)),
             iVar2 = _p_llm_env, iVar4 == 0)) {
            ...
            if (((uVar1 & 2) == 0) || ((short)piVar11[0xd] != 0)) {
              if (((uVar1 & 0x11) == 1) &&
                 (iVar3 = (**(code **)(_r_ip_funcs_p + 0x540))
                                    (iVar4,*(undefined2 *)((int)piVar11 + 0x2a),
                                     *(code **)(_r_ip_funcs_p + 0x540)), iVar3 != 0)) goto _L336;
            }
            ...
            if (((*(byte *)(iVar4 + 0xb) & 1) != 0) &&
               (iVar4 = (*(code *)*_r_modules_funcs_p)
                                  (*(int *)(_p_llm_env + 8) + iVar2 * 0x44 + 4,&co_null_bdaddr,
                                   (code *)*_r_modules_funcs_p), iVar4 != 0)) goto _L336;
          }
...
_L353:
        for (uVar13 = 0; iVar2 = _p_llm_env, uVar13 < *(byte *)((int)param_1 + 1);
          ...
          iVar4 = uVar6 * 0x44;
          piVar11 = (int *)(*(int *)(_p_llm_env + 8) + iVar4);
...
_L356:
            ...
            *(undefined1 *)(iVar2 + 0x40) = 2;
            if ((*(ushort *)(iVar3 + 2) & 0x13) == 0) {
              ...
              iVar3 = *piVar11;
              iVar10 = *(int *)(*(int *)(_p_llm_env + 8) + iVar4);
