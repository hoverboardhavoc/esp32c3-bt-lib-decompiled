...
_L452:
  ...
  if (bVar1 != 3) {
    if (uVar9 == 0) goto _L452;
    if (*(char *)(uVar13 * 0x44 + iVar11 + 0x40) == '\f') goto _L451;
  }
  iVar3 = uVar13 * 0x44;
  iVar11 = iVar11 + iVar3;
...
_L491:
      ...
      if ((*(short *)(*(int *)(_p_llm_env + 8) + iVar3 + 0x2c) == 0) && (!bVar2)) goto _L492;
    }
    bVar1 = param_1[2];
    if (bVar1 != 0) {
      iVar11 = *(int *)(_p_llm_env + 8) + iVar3;
