...
_L357:
    if (*param_1 != 1) {
      if (*(char *)((int)param_1 + 1) == '\0') {
        ...
        bVar8 = 0;
        do {
          if (0xef < *(byte *)((int)param_1 + uVar7 + 2)) goto _L358;
          ...
          if (((short)piVar5[0xb] != 0) || (*(short *)((int)piVar5 + 0x36) != 0)) goto _L358;
          if ((char)*param_1 == '\x01') {
            iVar11 = *piVar5;
            uVar1 = *(ushort *)(iVar11 + 2);
            if (((uVar1 & 2) != 0) && ((uVar1 & 0x10) == 0 && (short)piVar5[0xd] == 0)) goto _L362;
            if (((uVar1 & 0x11) == 1) &&
            ...
            if (((*(byte *)(iVar11 + 0xb) & 1) != 0) &&
               (iVar11 = (*(code *)*_r_modules_funcs_p)
                                   (*(int *)(_p_llm_env + 8) + iVar13 * 0x44 + 4,&co_null_bdaddr,
                                    (code *)*_r_modules_funcs_p), iVar11 != 0)) goto _L358;
          }
          else if (((_DAT_00014032 & 2) == 0) && ((char)piVar5[0x10] != '\x02')) goto _L362;
        ...
        if (bVar8 != 0) {
          ...
          for (uVar7 = 0;
            ...
            if (bVar8 <= bVar9) goto _L377;
          }
          iVar13 = 7;
          if (bVar9 < bVar8) goto _L354;
        }
_L377:
...
_L379:
                  ...
                  if (iVar13 == 0) {
                    ...
                    *(undefined1 *)(iVar13 + (uStack_68 & 0xff) * 0x44 + 0x40) = 4;
                    ...
                    (**(code **)(_r_plf_funcs_p + 0xc))
                              (0,"llm_adv.c",0x663,*(code **)(_r_plf_funcs_p + 0xc));
                  }
                }
              }
            }
            ...
            if (iVar13 != 0) {
              (**(code **)(_r_plf_funcs_p + 0xc))
                        (uVar10,0,"llm_adv.c",0x6ef,*(code **)(_r_plf_funcs_p + 0xc));
              goto _L354;
            }
            ...
            *(undefined1 *)(iVar13 + 0x40) = 2;
            ...
            if (((*(ushort *)(iVar3 + 2) & 0x13) == 0) &&
              ...
              if ((char)piVar5[0x10] != '\v') goto _L390;
              iVar3 = *piVar5;
                ...
                if (iVar13 == 0) {
                  ...
                  *(undefined1 *)(iVar13 + (uStack_88 & 0xff) * 0x44 + 0x40) = 4;
                  ...
                  (**(code **)(_r_plf_funcs_p + 8))
                            (0,"llm_adv.c",0x6e3,*(code **)(_r_plf_funcs_p + 8));
                }
              }
            }
            if (_bt_rf_coex_hooks_p != (int *)0x0) {
