...

{
  ...
  *(undefined1 *)(_p_llm_env + 0xd7) = 2;
  ...
  if (((bVar1 < 5) && ((byte)param_1[2] < 2)) && (bVar2 = param_1[3], bVar2 < 0xfc)) {
    ...
    if ((uVar4 & 0x10) == 0) {
      if ((bVar1 != 4) ||
         (((iVar8 = *(int *)(_p_llm_env + 8) + iVar6 * 0x44, *(char *)(iVar8 + 0x40) != '\x01' &&
           (*(short *)(iVar8 + 0x28) != 0)) && (bVar2 == 0)))) goto _L188;
    }
    else if ((bVar1 == 3) && (bVar2 < 0x20)) {
_L188:
      if ((((byte)(bVar1 - 3) < 2) || (bVar2 != 0)) && ((uVar4 & 0x12) != 2)) {
        iVar8 = iVar6 * 0x44;
        if (*(char *)(*(int *)(_p_llm_env + 8) + iVar8 + 0x40) != '\x01') {
          uVar9 = 0xc;
        ...
        if ((uint)*(ushort *)(iVar7 + 0x30) <
          ...
          if (*(short *)(iVar7 + 0x2c) != 0) {
            ...
            *(undefined4 *)(iVar8 + *(int *)(_p_llm_env + 8) + 0x2c) = 0;
          }
_L248:
          uVar9 = 7;
        }
          ...
          if ((param_1[1] & 0xfd) == 1) {
            if (*(short *)(iVar7 + 0x2c) != 0) {
              (**(code **)(_r_ip_funcs_p + 0xd8))(*(code **)(_r_ip_funcs_p + 0xd8));
              *(undefined2 *)(*(int *)(_p_llm_env + 8) + iVar8 + 0x2e) = 0;
            }
            iVar7 = *(int *)(_p_llm_env + 8) + iVar8;
            if (param_1[1] == '\x03') {
...
_L247:
            ...
            if ((*(short *)(*(int *)(_p_llm_env + 8) + iVar8 + 0x2c) == 0) && (!bVar3)) goto _L248;
          }
          bVar1 = param_1[3];
          if (bVar1 != 0) {
            iVar7 = *(int *)(_p_llm_env + 8) + iVar8;
          ...
          if ((byte)(param_1[1] - 2) < 2) {
            ...
            *(undefined4 *)(iVar8 + 0x28) = uVar9;
            if ((_bt_rf_coex_hooks_p != 0) && (*(int *)(_bt_rf_coex_hooks_p + 4) != 0)) {
              ...
              uStack_28 = *(undefined2 *)(iVar8 + 0x2e);
              if ((*(byte *)(iStack_30 + 0x15) < 3) ||
                 (iVar8 = lld_phy_coded_500k_get(), iVar8 == 0)) {
