...
_L489:
  ...
  if (bVar1 != 3) {
    if (uVar9 == 0) goto _L489;
    if (*(char *)(uVar13 * 0x44 + iVar11 + 0x40) == '\f') goto _L488;
  }
  iVar3 = uVar13 * 0x44;
  iVar11 = iVar11 + iVar3;
...
_L528:
      ...
      if ((*(short *)(*(int *)(_p_llm_env + 8) + iVar3 + 0x2c) == 0) && (!bVar2)) goto _L529;
    }
    bVar1 = param_1[2];
    if (bVar1 != 0) {
      iVar11 = *(int *)(_p_llm_env + 8) + iVar3;
