...
_L519:
  ...
  *(undefined1 *)(_p_llm_env + 0xd7) = 2;
  if (0xef < *param_1) goto _L520;
  iVar7 = (**(code **)(iVar7 + 0x544))(0,*(code **)(iVar7 + 0x544));
  uVar8 = 0x42;
  if (iVar7 == 0xff) goto _L517;
  iVar11 = *(int *)(_p_llm_env + 8);
  uVar14 = (uint)*(byte *)(iVar11 + iVar7 * 0x44 + 0x3d);
  if (uVar14 == 0xff) goto _L519;
  bVar1 = param_1[1];
...
_L520:
  ...
  if (bVar1 != 3) {
    if (uVar9 == 0) goto _L520;
    if (*(char *)(uVar14 * 0x44 + iVar11 + 0x40) == '\f') goto _L519;
  }
  iVar3 = uVar14 * 0x44;
  iVar11 = iVar11 + iVar3;
...
_L559:
      ...
      *(undefined2 *)(iVar11 + 0x2c) = uVar6;
      if ((*(short *)(*(int *)(iVar13 + 8) + iVar3 + 0x2c) == 0) && (!bVar2)) goto _L560;
    }
    bVar1 = param_1[2];
    if (bVar1 != 0) {
      iVar11 = *(int *)(_p_llm_env + 8) + iVar3;
    ...
    if ((byte)(param_1[1] - 2) < 2) {
      ...
      if (*(char *)(iVar11 + 0x40) == '\f') {
        (**(code **)(_r_ip_funcs_p + 0x2d8))
                  (uVar14,*(undefined1 *)(iVar11 + 0x2e),*(undefined2 *)(iVar11 + 0x2c),
                   *(code **)(_r_ip_funcs_p + 0x2d8));
      }
      ...
      if ((_bt_rf_coex_hooks_p != 0) && (*(int *)(_bt_rf_coex_hooks_p + 4) != 0)) {
        ...
        uStack_38._0_3_ = CONCAT12(cVar10,(undefined2)uStack_38);
