...
_L131:
        ...
        if (((((uVar8 <= uVar9) && ((byte)(param_1[10] - 1) < 7)) &&
          ...
          if (*piVar10 != 0) {
            (*(code *)_r_modules_funcs_p[0x36])(*piVar10 + -0xc,(code *)_r_modules_funcs_p[0x36]);
            piVar10 = (int *)(*(int *)(_p_llm_env + 8) + (uint)bStack_3d * 0x44);
            *piVar10 = 0;
          }
          *piVar10 = (int)param_1;
