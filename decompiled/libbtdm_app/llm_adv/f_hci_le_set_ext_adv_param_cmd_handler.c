 ...
 * Source: libbtdm_app -> llm_adv.o -> f_hci_le_set_ext_adv_param_cmd_handler
 *
...
_L121:
    ...
    *(undefined1 *)(_p_llm_env + 0xd7) = 2;
    ...
    if (iVar7 == 0xff) {
      iVar7 = (**(code **)(_r_ip_funcs_p + 0x4ac))(&bStack_3d,*(code **)(_r_ip_funcs_p + 0x4ac));
      if (iVar7 != 0) goto _L124;
      *(undefined1 *)(*(int *)(_p_llm_env + 8) + (uint)bStack_3d * 0x44 + 0x3d) = 0xff;
    }
    else if (*(char *)(*(int *)(_p_llm_env + 8) + iVar7 * 0x44 + 0x40) != '\x01') goto _L121;
    if (*param_1 < 0xf0) {
...
_L129:
        ...
        if (((((uVar8 <= uVar9) && ((byte)(param_1[10] - 1) < 7)) &&
          ...
          iVar7 = *(int *)(*(int *)(_p_llm_env + 8) + (uint)bStack_3d * 0x44);
          if (iVar7 != 0) {
          ...
          *(byte **)((uint)bStack_3d * 0x44 + iVar7) = param_1;
          *(undefined1 *)(iVar7 + (uint)bStack_3d * 0x44 + 0x3e) = 0xff;
          if (3 < param_1[0xb]) {
