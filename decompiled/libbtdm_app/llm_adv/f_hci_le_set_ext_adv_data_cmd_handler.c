    ...
    if ((uVar6 & 0x10) == 0) {
      if ((bVar1 != 4) ||
         (((iVar5 = *(int *)(_p_llm_env + 8) + iVar8 * 0x44, *(char *)(iVar5 + 0x40) != '\x01' &&
           (*(short *)(iVar5 + 0x28) != 0)) && (bVar2 == 0)))) goto _L191;
    }
...
_L250:
            ...
            *(undefined2 *)(iVar9 + 0x2c) = uVar7;
            if ((*(short *)(*(int *)(iVar4 + 8) + iVar5 + 0x2c) == 0) && (!bVar3)) goto _L251;
          }
          bVar1 = param_1[3];
          if (bVar1 != 0) {
            iVar9 = *(int *)(_p_llm_env + 8) + iVar5;
