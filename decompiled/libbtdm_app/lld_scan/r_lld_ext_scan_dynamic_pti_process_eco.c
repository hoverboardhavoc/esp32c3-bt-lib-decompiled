...

{
  ...
  if ((((param_1 != 0) && (_lld_scan_env != 0)) &&
      (iVar8 = (**(code **)(_r_modules_funcs_p + 400))(*(code **)(_r_modules_funcs_p + 400)),
      iVar8 != 0)) &&
    ...
    if (((param_1 != 0) && (_lld_scan_env != 0)) &&
      ...
      *puVar6 = *puVar6 & 0xdfffffff | uVar9 << 0x1d;
      if (*(char *)(param_1 + 0x39) == '\x01') {
        ...
        uVar2 = *(ushort *)((uint)bVar1 * 0x5a + 0x34 + iVar8);
        ...
        iVar8 = ((uVar2 - 0x1400) / 0xe & 0xff) * 0xe + 10;
        uVar2 = *(ushort *)(iVar7 + iVar8);
        iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1400,*(code **)(_r_plf_funcs_p + 0xbc));
        *(ushort *)(iVar7 + iVar8) = uVar2 & 0xf0ff | (ushort)bVar5 << 8;
        ...
        uVar2 = *(ushort *)(iVar7 + iVar8);
        iVar7 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1400,*(code **)(_r_plf_funcs_p + 0xbc));
        *(ushort *)(iVar7 + iVar8) = uVar2 & 0xefff | (ushort)bVar1 << 0xc;
      }
    }
    return;
  }
