...

{
  ...
  do {
    iVar6 = iVar7 * 4;
    iVar4 = *(int *)(_lld_scan_env + iVar6);
    if (iVar4 != 0) {
      (**(code **)(_r_ip_funcs_p + 0x3d8))(iVar4,1,*(code **)(_r_ip_funcs_p + 0x3d8));
      if (*(char *)(iVar4 + 0x3c) == '\0') {
        ...
        if (*(char *)(iVar4 + 0x3d) == '\x03') {
          ...
          (**(code **)(_r_ip_funcs_p + 0x448))(iVar7,*(code **)(_r_ip_funcs_p + 0x448));
        }
        (**(code **)(_r_modules_funcs_p + 0x110))
                  (*(undefined4 *)(_lld_scan_env + iVar6),*(code **)(_r_modules_funcs_p + 0x110));
        iVar4 = _lld_scan_env;
        *(undefined4 *)(iVar6 + _lld_scan_env) = 0;
        *(byte *)(iVar4 + 0xc) = ~(byte)(1 << iVar7) & *(byte *)(iVar4 + 0xc);
      }
      else if (*(char *)(iVar4 + 0x3c) == '\x01') {
        bVar3 = *(byte *)(iVar4 + 0x38);
        iVar6 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
        *(undefined2 *)((uint)bVar3 * 0x5a + 0x20 + iVar6) = 1;
