...

{
  ...
  if (_lld_scan_env != 0) {
    ...
    if (iVar3 != 0) {
      ...
      *(undefined1 *)(iVar3 + 0x3c) = 0;
      if (cVar1 == '\x02') {
                    /* WARNING: Could not recover jumptable at 0x00012f4a. Too many branches */
      ...
      if (*(char *)(iVar3 + 0x3d) == '\x03') {
        ...
        if (*(char *)(iVar5 + 0x18) == '\0') {
          (**(code **)(_r_plf_funcs_p + 8))(0,"lld_scan.c",0x9d0,*(code **)(_r_plf_funcs_p + 8));
        }
      ...
      if ((uint)*(ushort *)(iVar3 + 0x30) << 1 <= (iVar4 - *(int *)(iVar3 + 0x28) & 0xfffffffU)) {
        if (0xff < (uint)*(byte *)(iVar3 + 0x16) + (uint)rwip_priority) {
          (**(code **)(_r_plf_funcs_p + 8))(0,"lld_scan.c",0x9da,*(code **)(_r_plf_funcs_p + 8));
        }
      ...
      if (*(char *)(iVar3 + 0x3e) == '\x01') {
        *(undefined1 *)(iVar3 + 0x3e) = 0;
                    /* WARNING: Could not recover jumptable at 0x00013058. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(iVar5 + 0x430))(param_1,iVar4,1);
        return;
      }
  ...
  UNRECOVERED_JUMPTABLE = *(code **)(_r_plf_funcs_p + 8);
_L674:
                    /* WARNING: Could not recover jumptable at 0x0001303a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*UNRECOVERED_JUMPTABLE)(0,"lld_scan.c",uVar6);
  return;
}
