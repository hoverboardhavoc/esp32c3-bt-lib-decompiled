...

{
  ...
  sVar3 = *(short *)(param_3 + 0x12 + iVar8);
  if (*(char *)(iVar6 + 0x6e) != -1) {
    ...
    if ((((uVar4 & 0x10) == 0) || ((*(byte *)(iVar6 + 0x6d) & 4) != 0)) ||
       ((iVar8 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x1000,*(code **)(_r_plf_funcs_p + 0xbc)),
        (*(ushort *)(param_3 + 0x10 + iVar8) & 0x300) == 0 &&
        ((*(byte *)(iVar6 + 0x6d) & 0x10) == 0)))) {
      ...
      if (*(char *)(param_4 + 8) != -1) {
        ...
        *(byte *)(iVar6 + 0x58) = (byte)(uVar4 >> 7) & 1;
        ...
        uVar5 = *(undefined2 *)(param_3 + 0xe + iVar8);
...
_L109:
          ...
          uVar10 = 3;
          if (*(char *)(iVar6 + 0x6e) == '\0') goto _L109;
        }
      ...
      if (*(char *)(iVar6 + 0x6e) != -1) goto _L112;
    }
    else {
_L106:
