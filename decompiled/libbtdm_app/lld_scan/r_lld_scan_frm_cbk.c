...

{
  ...
  if (1 < param_2) {
    (**(code **)(_r_plf_funcs_p + 0xc))
              (param_2,param_3,"lld_scan.c",0xa1c,*(code **)(_r_plf_funcs_p + 0xc));
  }
  if (param_3 == 1) {
    uVar1 = 1;
    ...
    if (param_3 != 0) {
      if (param_3 == 2) {
        ...
        if (param_3 != 4) {
                    /* WARNING: Could not recover jumptable at 0x000131bc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(_r_plf_funcs_p + 0xc))(param_2,param_3,"lld_scan.c",0xa32);
          return;
        }
        UNRECOVERED_JUMPTABLE_00 = *(code **)(_r_ip_funcs_p + 0x3fc);
      }
                    /* WARNING: Could not recover jumptable at 0x00013208. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    UNRECOVERED_JUMPTABLE_00 = *(code **)(_r_ip_funcs_p + 0x3f4);
                    ...
                    /* WARNING: Could not recover jumptable at 0x000131dc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
