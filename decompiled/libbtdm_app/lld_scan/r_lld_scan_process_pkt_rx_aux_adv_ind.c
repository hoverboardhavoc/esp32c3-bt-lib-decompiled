...

{
  ...
  *(byte *)(iVar7 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar8 + iVar17 + 6) >> 0xe);
  ...
  if (*(char *)(iVar7 + 0x6e) == -1) {
    if ((*(ushort *)(param_3 + 6) & 0x1000) != 0) goto _L447;
  }
  else {
...
_L397:
  if (-1 < (int)((uint)*(ushort *)(param_3 + 6) << 0x12)) goto _L399;
    ...
    if (iVar8 == 0) {
      ...
      *(uint *)(puVar11 + 0x18) = CONCAT22(uVar4,*(undefined2 *)(iVar12 + iVar17 + 8));
      ...
      if (0x751 < (uVar20 + 0x4e1 & 0xffff)) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"lld_scan.c",0x6b9,*(code **)(_r_plf_funcs_p + 8));
      }
