...

{
  ...
  if (param_1 != 0) {
    ...
    if (uVar6 != 0) {
      ...
      iVar4 = (uint)bVar1 * 0x5a + 0x16;
      uVar2 = *(ushort *)(iVar3 + iVar4);
      iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar3 + iVar4) = uVar2 & 0xffc0 | uVar6 & 0xff;
    }
  ...
  if ((((g_scan_forever != '\0') && (param_1 != 0)) && (*(char *)(param_1 + 0x3c) != '\x02')) &&
     (bVar1 = *(byte *)(param_1 + 0x38),
     iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc)),
     *(short *)(iVar3 + (uint)bVar1 * 0x5a + 0x20) != 1)) {
    bVar1 = *(byte *)(param_1 + 0x38);
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
    *(undefined2 *)(iVar3 + (uint)bVar1 * 0x5a + 0x20) = 0;
    *(undefined4 *)(param_1 + 0x24) = 0xffffffff;
  }
  if (param_1 == 0) {
    (**(code **)(_r_plf_funcs_p + 8))("lld_scan.c",0xa59,*(code **)(_r_plf_funcs_p + 8));
  }
  else {
    bVar1 = *(byte *)(param_1 + 0x38);
    uVar5 = (uint)bVar1;
    ...
    if (*(char *)(param_1 + 0x3e) != '\x01') {
      ...
      *(char *)(param_1 + 0x44) = (char)uVar8;
      ...
      uVar2 = *(ushort *)(iVar3 + iVar7 + 0x14);
      iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
      *(ushort *)(iVar3 + iVar7 + 0x14) = uVar2 & 0xfff7 | (ushort)(uVar8 << 3);
    }
    ...
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
    *(ushort *)(iVar3 + iVar7) = uVar2 & 0xff7f | (ushort)((uint)bStack_51 << 7);
    ...
    uVar2 = *(ushort *)(iVar3 + iVar7);
    iVar3 = (**(code **)(_r_plf_funcs_p + 0xbc))(0x400,*(code **)(_r_plf_funcs_p + 0xbc));
    *(ushort *)(iVar3 + iVar7) = uVar2 & 0xffbf | (ushort)uVar8;
