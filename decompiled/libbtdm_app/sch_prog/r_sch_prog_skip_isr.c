...

{
  ...
  if (DAT_00011106 == '\0') {
    (**(code **)(_r_plf_funcs_p + 8))(0,"sch_prog.c",0x1fa,*(code **)(_r_plf_funcs_p + 8));
  }
  uVar1 = (uint)DAT_00011104;
  while( true ) {
    if (DAT_00011106 == '\0') {
                    /* WARNING: Could not recover jumptable at 0x00010670. Too many branches */
    ...
    if (((&g_bt_plf_log_level)[iVar3] != '\0') &&
      ...
      if (*(code **)(&r_modules_funcs_p + iVar3) == (code *)0x0) {
        (**(code **)(_r_plf_funcs_p + 8))(0,"sch_prog.c",0x20f,*(code **)(_r_plf_funcs_p + 8));
      }
      else {
