...

{
  ...
  uVar1 = uVar10 & 0xff;
  if (iVar9 == 0) {
    (**(code **)(_r_plf_funcs_p + 0xc))(uVar10,0,"llc_llcp.c",0xe6,*(code **)(_r_plf_funcs_p + 0xc))
    ;
  }
  iVar2 = (**(code **)(_r_ip_funcs_p + 0x5c4))(*(code **)(_r_ip_funcs_p + 0x5c4));
  if ((iVar9 == 0) || ((*(ushort *)(iVar9 + 0x42) & 0x40) != 0)) goto _L10;
    ...
    if (*(ushort *)(iVar8 + 8) == (ushort)*(byte *)(param_1 + 1)) {
      ...
      if (bVar7 != 2) {
        ...
        if (bVar7 == 3) {
          ...
          if (bVar7 == 1) {
            if ((*(byte *)(uVar5 * 0xc + iVar2 + 10) & 4) == 0) goto _L48;
            goto _L12;
          }
          bVar7 = *(byte *)(uVar5 * 0xc + iVar2 + 10) & 1;
        }
        if (bVar7 == 0) goto _L10;
      }
    }
    else {
      cStack_6f = '\x19';
...
_L12:
    if (cStack_6f == '\0') {
      if (0x22 < abStack_50[0]) {
        (**(code **)(_r_plf_funcs_p + 0xc))
                  (param_2,"llc_llcp.c",0x173,*(code **)(_r_plf_funcs_p + 0xc));
      }
    ...
    cStack_6f = '\x19';
    bVar7 = *(byte *)(iVar9 + 0x44) & 3;
    if ((*(byte *)(iVar9 + 0x44) & 3) == 0) goto _L12;
    if (2 < bVar7) {
      if (bVar7 == 3) goto _L10;
      goto _L12;
    }
_L48:
    cVar6 = '=';
