  ...
  if (*(char *)(_p_llm_env + 0xd7) != '\x02') {
    *(undefined1 *)(_p_llm_env + 0xd7) = 1;
    while( true ) {
      ...
      if ((uint)*(byte *)(iVar6 + 0xd) <= (uint)bStack_91) break;
      if (*(char *)(*(int *)(_p_llm_env + 8) + (uint)bStack_91 * 0x44 + 0x40) == '\x05') break;
      bStack_91 = bStack_91 + 1;
    }
    iVar6 = r_sdk_config_get_opts();
    if (*(byte *)(iVar6 + 0xd) <= bStack_91) {
      if ((char)param_1[2] == '\0') {
      ...
      if (param_1[1] <= *param_1) {
        ...
        if ((((((param_1[7] <= uVar9) && ((ushort)(param_1[1] - 4) < 0x3ffd)) &&
          ...
          if ((byte)param_1[6] < 4) {
            if (((param_1[9] + 1) * uVar9 < (uint)param_1[10] << 2) &&
               ((((byte)param_1[6] & 1) == 0 ||
                (iVar6 = r_co_bdaddr_compare(_p_llm_env + 0x12,&co_null_bdaddr), iVar6 == 0)))) {
              iVar6 = r_llm_activity_free_get(&bStack_91);
              ...
              uVar8 = r_ke_msg_alloc(0,0,0,0x3a);
...
_L35:
              ...
              *(undefined1 *)(*(int *)(_p_llm_env + 8) + iVar7 + 0x40) = 5;
              ...
              uStack_70 = *(undefined4 *)(iVar7 + 4);
              uStack_6c = *(undefined2 *)(iVar7 + 8);
              uStack_5f = 0;
