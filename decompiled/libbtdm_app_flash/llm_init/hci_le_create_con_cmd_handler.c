  ...
  if (*(char *)(_p_llm_env + 0xd7) != '\x02') {
    *(undefined1 *)(_p_llm_env + 0xd7) = 1;
    while( true ) {
      ...
      if (((uint)*(byte *)(iVar6 + 0xd) <= (uint)bStack_9a) ||
    ...
    if ((uint)*(byte *)(iVar6 + 0xd) <= (uint)bStack_9a) {
      if (((char)param_1[2] == '\0') &&
         (iVar6 = r_llm_is_dev_connected(param_1 + 3,*(undefined1 *)((int)param_1 + 5)), iVar6 != 0)
         ) {
        r_ble_log_internal_x1(0x802e01af,(uint)(byte)param_1[2] << 8 | 0xb);
        uVar3 = 0xb;
        goto _L40;
      }
...
_L24:
        ...
        if ((((((uVar3 < param_1[7]) || (0x3ffc < (ushort)(param_1[1] - 4))) ||
             ...
             ((param_1[0xc] < param_1[0xb] || (param_1[7] < 6)))) ||
            ((0xc80 < uVar3 || ((0xc76 < (param_1[10] - 10 & 0xffff) || (499 < param_1[9])))))) ||
           ((3 < bStack_99 ||
            ((3 < (byte)param_1[6] || ((uint)param_1[10] << 2 <= (ushort)(param_1[9] + 1) * uVar3)))
            ))) goto _L24;
        if ((((byte)param_1[6] & 1) == 0) ||
           (iVar6 = r_co_bdaddr_compare(_p_llm_env + 0x12,&co_null_bdaddr), iVar6 == 0)) {
          uVar3 = r_llm_activity_free_get(&bStack_9a);
          if (uVar3 != 0) {
            r_ble_log_internal_x1(0x802e01b2,(uint)bStack_9a << 8 | uVar3);
            goto _L40;
          }
          ...
          uStack_88 = uVar3;
          uStack_84 = uVar8;
          iVar6 = r_sch_plan_req(&uStack_90);
          if (iVar6 != 0) {
            r_ble_log_internal_x1(0x802e01b3,(uint)bStack_9a << 8 | 0xd);
            uVar3 = 0xd;
            goto _L40;
          }
          if (*(int *)(*(int *)(_p_llm_env + 8) + (uint)bStack_9a * 0x44) != 0) {
            r_assert_err(0x10000,0xd4);
          }
          uVar7 = (uint)bStack_9a;
          iVar6 = *(int *)(_p_llm_env + 8);
          uVar5 = r_ke_msg_alloc(0,0,0,0x3a);
          *(undefined4 *)(iVar6 + uVar7 * 0x44) = uVar5;
          iVar6 = _p_llm_env;
...
_L35:
              ...
              *(undefined4 *)(iVar9 + 4) = *(undefined4 *)(iVar6 + 0xc);
              *(undefined2 *)(iVar9 + 8) = *(undefined2 *)(iVar6 + 0x10);
            }
            else {
              if (bVar1 < 3) {
                ...
                r_assert_param(bVar1,0,0x10000,0xfe);
                goto _L34;
              }
              memcpy((void *)(iVar9 + (uint)bStack_9a * 0x44 + 4),(void *)(iVar6 + 0x12),6);
            }
          }
_L34:
          *(undefined1 *)(*(int *)(_p_llm_env + 8) + (uint)bStack_9a * 0x44 + 0x40) = 5;
          r_ble_log_internal_x1(0x404e01b4,bStack_9a | 0x500);
          ...
          iVar9 = *(int *)(iVar6 + 8) + (uint)bStack_9a * 0x44;
          uStack_70 = *(undefined4 *)(iVar9 + 4);
          uStack_6c = *(undefined2 *)(iVar9 + 8);
          uStack_5f = 0;
          uStack_34 = *(undefined1 *)(iVar6 + 0xc6);
          ...
          if (uVar3 != 0) {
            r_ble_log_internal_x1(0x802e01b5,uVar3);
            uVar3 = 3;
          }
          goto _L40;
        }
    ...
    r_ble_log_internal_x1(0x802e01ae,(uint)bStack_9a << 8 | 0xc);
  }
  uVar3 = 0xc;
_L40:
