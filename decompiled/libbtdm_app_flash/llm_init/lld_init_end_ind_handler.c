...

{
  ...
  if (*(byte *)(iVar5 + 0xd) <= uVar15) {
    r_assert_param(uVar15,0,0x10000,0x2ad);
  }
  iVar5 = uVar15 * 0x44;
  ...
  if ((char)piVar10[0x10] == '\x05') {
    ...
    if (iVar17 == 0) {
      ...
      *(undefined1 *)(*(int *)(_p_llm_env + 8) + iVar5 + 0x40) = 0;
      r_ble_log_internal_x1(0x404e01ef,uVar15);
    }
    else {
      ...
      if (uVar18 == 0) {
        *(undefined1 *)(*(int *)(_p_llm_env + 8) + iVar5 + 0x40) = 0;
        r_ble_log_internal_x1(0x404e01ee,uVar15);
      }
      else {
        ...
        *(undefined1 *)(iVar6 + 0x28) = 0;
        r_ble_log_internal_x1(0x404e01ed,uVar15 | 0x900);
