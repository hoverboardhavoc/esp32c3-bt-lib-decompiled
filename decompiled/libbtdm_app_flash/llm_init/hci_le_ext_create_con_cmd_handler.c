...
undefined4 hci_le_ext_create_con_cmd_handler(byte *param_1,undefined4 param_2)

{
  ...
  if ((*(char *)(iVar8 + 0x18) == '\0') ||
     (iVar8 = r_sdk_config_get_opts_ext(), *(char *)(iVar8 + 0x22) == '\0')) {
...
_L128:
    ...
    *(undefined1 *)(_p_llm_env + 0xd7) = 2;
    while( true ) {
      ...
      if (((uint)*(byte *)(iVar8 + 0xd) <= (uint)bStack_da) ||
         (*(char *)(*(int *)(_p_llm_env + 8) + (uint)bStack_da * 0x44 + 0x40) == '\x05')) break;
      bStack_da = bStack_da + 1;
    }
    iVar8 = r_sdk_config_get_opts();
    if ((uint)bStack_da < (uint)*(byte *)(iVar8 + 0xd)) {
      r_ble_log_internal_x1(0x802e01e1,(uint)bStack_da << 8 | 0xc);
      goto _L128;
    }
    if ((*param_1 == 0) && (iVar8 = r_llm_is_dev_connected(param_1 + 3,param_1[2]), iVar8 != 0)) {
      r_ble_log_internal_x1(0x802e01e2,(uint)*param_1 << 8 | 0xb);
      uVar9 = 0xb;
      uVar7 = 0;
      goto _L123;
    }
    ...
    if ((bVar1 & 0xf8) == 0) {
      ...
      for (uVar10 = 0; (int)uVar10 < (int)uVar16; uVar10 = uVar10 + 1) {
        if (((bVar1 & 2) == 0) || ((uVar9 & 1) != uVar10)) {
          ...
          if ((uVar5 < uVar4) || ((uVar4 < 4 || (uVar5 < 4)))) {
            r_ble_log_internal_x2(0x802e01e4,CONCAT22(uVar5,uVar4),uVar10 << 8 | 0x12);
            goto _L163;
          }
        }
        puVar12 = puVar12 + 8;
      ...
      for (uVar9 = 0; uVar16 != uVar9; uVar9 = uVar9 + 1) {
        ...
        if (((((uVar10 < *puVar12) || (puVar12[5] < puVar12[4])) ||
             (puVar2 = puVar12 + 3, (uint)*puVar12 < (uint)_g_ble_con_interval_min)) ||
            ((0xc80 < uVar10 || (0xc76 < (*puVar2 - 10 & 0xffff))))) ||
           ((puVar3 = puVar12 + 2, 499 < *puVar3 ||
            (puVar12 = puVar12 + 8,
            (int)((uint)*puVar2 * 10) < (int)((ushort)(*puVar3 + 1) * uVar10 * 5 + 1) >> 1)))) {
          uVar9 = uVar9 << 8 | 0x12;
          uVar7 = 0x802e01e5;
          goto _L162;
        }
      ...
      if (uVar9 == 0) {
        ...
        for (; uVar16 != uVar20; uVar20 = uVar20 + 1) {
          uVar11 = (uint)*puVar19 << 1;
          uVar10 = (uint)puVar19[1] << 1;
          ...
          *(ushort *)(puVar18 + 4) = (ushort)bStack_da;
          iVar8 = r_sch_plan_req(puVar18);
          puVar19 = puVar19 + 8;
          puVar18 = puVar18 + 8;
          if (iVar8 != 0) {
            r_ble_log_internal_x1(0x802e01e9,uVar20 << 8 | 0xd);
            uVar9 = 0x3b;
            uVar7 = 0;
            goto _L123;
          }
        ...
        if (*(int *)(*(int *)(_p_llm_env + 8) + (uint)bStack_da * 0x44) != 0) {
          r_assert_err(0,0x10000,0x1f5);
        }
        bVar1 = param_1[1];
        if (bVar1 == 2) {
_L111:
          iVar8 = *(int *)(_p_llm_env + 8) + (uint)bStack_da * 0x44;
          uVar6 = *(undefined2 *)(_p_llm_env + 0x10);
          *(undefined4 *)(iVar8 + 4) = *(undefined4 *)(_p_llm_env + 0xc);
          *(undefined2 *)(iVar8 + 8) = uVar6;
        }
        else {
          if (bVar1 < 3) {
            ...
            r_assert_param(0,0x10000,0x20a);
            goto _L115;
          }
...
_L115:
        ...
        *(byte **)((uint)bStack_da * 0x44 + iVar8) = param_1;
        *(undefined1 *)(iVar8 + (uint)bStack_da * 0x44 + 0x40) = 5;
        r_ble_log_internal_x1(0x404e01ea,bStack_da | 0x500);
        ...
        bStack_bb = bStack_d9;
        bStack_ba = *param_1;
        iVar17 = *(int *)(iVar8 + 8) + (uint)bStack_da * 0x44;
        uStack_d0 = *(undefined4 *)(iVar17 + 4);
        uStack_cc = *(undefined2 *)(iVar17 + 8);
        uStack_bf = 1;
        uStack_94 = *(undefined1 *)(iVar8 + 0xc6);
        ...
        uVar7 = 1;
        if (uVar9 != 0) {
          r_ble_log_internal_x1(0x802e01eb,(uint)bStack_da << 8 | uVar9);
          uVar9 = 3;
        }
        goto _L123;
      }
      r_ble_log_internal_x1(0x802e01e8,(uint)bStack_da << 8 | uVar9);
    }
    else {
      uVar9 = uVar9 << 8 | 0x12;
      uVar7 = 0x802e01e3;
_L162:
      r_ble_log_internal_x1(uVar7,uVar9);
_L163:
      uVar9 = 0x12;
    }
  }
