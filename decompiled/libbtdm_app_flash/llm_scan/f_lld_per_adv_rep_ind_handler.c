...

{
  ...
  if ((char)piVar11[0x10] == '\x0e') {
    ...
    *(uint *)(iVar12 + 0x14) = ((uVar4 - 1) + uVar18) % uVar18;
    r_sch_plan_set_hack(iVar12 + 0xc);
        ...
        if ((bVar5) || (bVar9 != 0x28)) {
             ...
             ((*(byte *)(iVar12 + 0x29) == bVar9 && ((int)uVar19 < (int)(param_1[0x19] - uVar18)))))
          {
            ...
            *puVar8 = uVar17;
            iVar12 = *(int *)(param_1 + 0x14);
            puVar8[2] = uVar3;
            memcpy((void *)((int)puVar8 + 7),(void *)(iVar12 + 2 + (uint)param_1[0x1a] + uVar18),
                   uVar19 - 1);
          ...
          r_lld_sync_ch_map_update(uVar15,auStack_48,*(undefined2 *)((uVar13 + 7 & 0xff) + iVar12));
          bVar5 = true;
        }
      }
    }
