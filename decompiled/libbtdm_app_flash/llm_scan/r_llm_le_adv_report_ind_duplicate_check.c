...

{
  ...
  if (((*(char *)(_p_llm_env + 0xd7) == '\x01') || ((*(byte *)(_p_llm_env + 0xd4) & 0x40) != 0)) &&
     (iVar6 = r_llm_le_scan_duplicate_opt_get(), (*(byte *)(_p_llm_env + 0xd4) & 1) != 0)) {
    ...
    uVar5 = llm_adv_is_in_duplicate_scan_duplicate_exceptional_list(abStack_110,uVar9 & 0xff);
    if (uVar5 == 0) {
      if (((*(char *)(iVar6 + 8) == '\0') || ((bVar1 & 0xef) != 0)) ||
         ((abStack_10a[1] != '*' || (uVar8 < 0xc)))) {
        if (*(char *)(iVar6 + 9) == '\x01') {
          uVar9 = uVar4 + 2;
          pbVar7 = abStack_10a;
        }
        ...
        llm_hash_function_blob(pbVar7,uVar9);
