  ...
  if (((((ushort)(*(short *)(param_1 + 0xc) - 10U) < 0x3ff7) && (*param_1 < 2)) && (param_1[2] < 2))
    ...
    if (((*param_1 != 1) || (iVar3 = llm_is_pal_empty(), iVar3 == 0)) &&
      ...
      *(undefined1 *)(_p_llm_env + 0xd7) = 2;
      ...
      if (*(byte *)(iVar3 + 0xd) <= abStack_21[0]) {
        if (*param_1 == 0) {
          iVar3 = 0xb;
          iVar4 = r_llm_is_dev_synced(param_1 + 3,param_1[2],param_1[1]);
          uVar6 = 0;
          if (iVar4 != 0) goto _L243;
        }
...
_L243:
  r_llm_cmd_stat_send(param_2,iVar3);
  return uVar6;
}
