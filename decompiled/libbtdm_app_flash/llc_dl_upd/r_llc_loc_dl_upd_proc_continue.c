...

{
  ...
  if (iVar6 != 0) {
    if (iVar6 == 1) {
      ...
      r_ble_log_internal_x1(0x804f0098,iVar6 << 8 | param_1);
      uVar7 = r_llc_proc_state_get(iVar5);
      r_assert_param(param_1,uVar7,"llc_dl_upd.c",0x164);
    }
  ...
  if (*(char *)(iVar4 + 0x1c) == '\x03') {
    ...
    *(ushort *)(iVar5 + 10) = uVar8;
    iVar6 = r_bt_rf_coex_conn_phy_coded_data_time_limit_en_get_hack();
    if (iVar6 != 0) {
      iVar6 = r_bt_rf_coex_conn_phy_coded_data_time_limit_en_get_hack();
      if (iVar6 == 0) {
        uVar8 = 0xa90;
  ...
  *(ushort *)(iVar5 + 0xe) = uVar8;
  iVar4 = r_bt_rf_coex_conn_phy_coded_data_time_limit_en_get_hack();
  if (iVar4 != 0) {
    iVar4 = r_bt_rf_coex_conn_phy_coded_data_time_limit_en_get_hack();
    if (iVar4 == 0) {
      uVar8 = 0xa90;
