...

{
  ...
  while (iVar1 = iStack_134, iVar2 = r_nvds_walk_tag(iStack_134,&bStack_138,&iStack_134), iVar2 == 0
    ...
    if ((bStack_137 & 5) == 4) {
      if (bStack_138 == param_1) {
        ...
        (*DAT_0001067c)(iVar1 + 1,1,&bStack_139,DAT_0001067c);
      }
      else {
  ...
  if (DAT_00010688 < param_2 + 6 + iVar1) {
    _LANCHOR2 = (**(code **)(_r_osi_funcs_p + 0x78))(0x800,*(code **)(_r_osi_funcs_p + 0x78));
    if (_LANCHOR2 != 0) {
      r_nvds_purge(iVar4,_LANCHOR2);
      (**(code **)(_r_osi_funcs_p + 0x7c))(_LANCHOR2,*(code **)(_r_osi_funcs_p + 0x7c));
      _LANCHOR2 = 0;
      iVar1 = iVar4 + 4;
      if (param_2 + 3 + iVar1 <= DAT_00010688 - 1) goto _L71;
    }
    uVar3 = 3;
  }
  else {
_L71:
    (*DAT_0001067c)(iVar1 + 3,param_2,param_3,DAT_0001067c);
    bStack_137 = 6;
    bStack_138 = (byte)param_1;
    bStack_136 = (byte)param_2;
    (*DAT_0001067c)(iVar1,3,&bStack_138,DAT_0001067c);
    uVar3 = 0;
  }
  return uVar3;
}
