...
/* WARNING: Removing unreachable block (ram,0x0001026a) */
...
/* WARNING: Removing unreachable block (ram,0x0001020e) */
/* WARNING: Removing unreachable block (ram,0x00010214) */
/* WARNING: Removing unreachable block (ram,0x0001021a) */
/* WARNING: Removing unreachable block (ram,0x000101c2) */
...

{
  ...
  piVar15 = (int *)_g_conflict_elt;
_L31:
  do {
    piVar10 = piVar4;
    if (piVar10 == (int *)0x0) {
      if (bVar2) {
        _g_conflict_elt = (int)piVar15;
      }
      if (uVar5 <= uVar8) {
        return 3;
      }
