...
byte f_ll_phy_update_ind_handler(undefined4 param_1,int param_2,uint param_3)

{
  ...
  if ((*(byte *)(param_2 + 1) & 0xf8) == 0) {
    if (((*(byte *)(param_2 + 2) & 0xf8) == 0) &&
      ...
      bVar1 = 0;
      if ((param_3 - *(ushort *)(param_2 + 4) & 0xffff) < 0x7fff) {
        ...
        r_ble_log_internal_x2(0x804f00c1,(uint)*(ushort *)(param_2 + 4) << 0x10 | param_3,param_1);
      }
    }
  }
