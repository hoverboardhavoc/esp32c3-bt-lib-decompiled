...

{
  ...
  uVar2 = 0;
  if ((param_1 < *(byte *)(iVar4 + 0xd)) && (iVar4 = *(int *)(&llc_env + iVar8), iVar4 != 0)) {
    uVar2 = *(byte *)(iVar4 + 0x31) & 1;
  }
  r_sdk_config_get_opts();
  iVar4 = r_sdk_config_get_opts();
  uVar3 = 0;
  if ((param_1 < *(byte *)(iVar4 + 0xd)) && (*(int *)(&llc_env + iVar8) != 0)) {
    uVar3 = (int)(uint)*(byte *)(*(int *)(&llc_env + iVar8) + 0x31) >> 3 & 1;
  }
  iVar4 = r_sdk_config_get_opts();
  uVar6 = param_1 << 8;
  if (((*(byte *)(iVar4 + 0xd) <= param_1) || (*(int *)(&llc_env + iVar8) == 0)) ||
     ((*(byte *)(*(int *)(&llc_env + iVar8) + 0x44) & 3) == 3)) {
    r_ble_log_internal_x1(0x80030045,uVar6 | 0xc);
    uVar9 = 0xc;
    goto _L237;
  }
  ...
  uVar9 = bVar1 & 0x40;
  if ((bVar1 & 0x40) != 0) {
    r_ble_log_internal_x1(0x80030046,(uint)bVar1 << 0x10 | uVar6 | 0x3a);
    uVar9 = 0x3a;
    goto _L237;
  }
...
_L243:
          r_ble_log_internal_x1(0x80030048,uVar6 | 0x70011);
          uVar9 = 0x11;
          goto _L237;
        }
...
_L246:
          r_ble_log_internal_x1(0x80030049,uVar2 << 0x10 | uVar6 | 0x1a);
          uVar9 = 0x1a;
          goto _L237;
        }
...
_L250:
      ...
      puVar5 = (undefined4 *)r_ke_msg_alloc(0x10e,uVar6 | 1,0x14);
      ...
      *(char *)((int)puVar5 + 0xb) = (char)uVar3;
      if ((bVar1 & 1) == 0) {
        uVar2 = uVar2 & *(byte *)(param_2 + 3);
      }
      *(char *)((int)puVar5 + 10) = (char)uVar2;
  ...
  r_ble_log_internal_x2
            (0x80030047,(uint)*(byte *)(param_2 + 3) << 0x18 | (uint)bVar1 << 0x10 | uVar6 | 0x12,
