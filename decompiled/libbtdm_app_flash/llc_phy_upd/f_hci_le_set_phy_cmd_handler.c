...

{
  ...
  if (((*(byte *)(iVar4 + 0xd) <= param_1) || (*(int *)(&llc_env + iVar10) == 0)) ||
     ((*(byte *)(*(int *)(&llc_env + iVar10) + 0x44) & 3) == 3)) goto _L237;
...
_L258:
    ...
    bVar2 = (byte)uVar3;
    if ((bVar1 & 1) == 0) {
      if (*(char *)(param_2 + 3) == '\0') goto _L258;
...
_L247:
      if (7 < *(byte *)(param_2 + 4)) goto _L260;
      if ((bVar1 & 1) == 0) goto _L248;
_L242:
      if ((*(byte *)(param_2 + 4) & uVar3) == 0) goto _L262;
