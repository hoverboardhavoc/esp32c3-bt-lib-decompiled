 ...
 * Source: libbtdm_app_flash -> llc_con_upd.o -> llc_ll_connection_param_rsp_pdu_send
 *
...
void llc_ll_connection_param_rsp_pdu_send(int param_1)

{
  ...
  r_llc_llcp_send_eco(auStack_2c,0);
  return;
}
