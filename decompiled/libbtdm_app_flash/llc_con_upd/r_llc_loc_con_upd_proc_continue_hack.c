...

{
  ...
  r_ble_log_internal_x2
            (0x404f0085,(uint)*(ushort *)(iVar8 + 0x42) | param_1 << 0x10 | param_2 << 0x18,param_3)
  ;
  if (param_2 == 6) {
  ...
  if (iVar5 != param_2) {
    iVar8 = r_llc_proc_state_get(iVar4);
    r_ble_log_internal_x1(0x804f0086,param_2 << 0x10 | param_1 | iVar8 << 8);
    r_llc_proc_state_get(iVar4);
    r_assert_warn(param_2,"llc_con_upd.c",299);
    return;
  }
    ...
    if ((param_3 != 0) && (iVar5 = r_sdk_config_get_opts(), param_1 < *(byte *)(iVar5 + 0xd))) {
      if ((*(int *)(&llc_env + iVar9) != 0) &&
        ...
        if ((*(ushort *)(iVar8 + 0x42) & 1) == 0) {
          ...
          if (iVar9 == 0) {
            r_assert_err("llc_con_upd.c",0x13e);
          }
          if (*(int *)(iVar9 + 4) == 0) {
            r_assert_err(0,"llc_con_upd.c",0x13f);
          }
  ...
  case 1:
    if ((*(ushort *)(iVar8 + 0x42) & 1) == 0) {
      r_assert_param(param_1,param_3,"llc_con_upd.c",0x14d);
    }
...
_L117:
  ...
  default:
    iVar8 = r_llc_proc_state_get(iVar4);
    r_ble_log_internal_x1(0x804f0087,iVar8 << 8 | param_1);
    uVar6 = r_llc_proc_state_get(iVar4);
    r_assert_param(param_1,uVar6,"llc_con_upd.c",0x1c6);
    return;
  }
