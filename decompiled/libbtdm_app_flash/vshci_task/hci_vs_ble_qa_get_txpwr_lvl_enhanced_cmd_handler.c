 ...
 * Source: libbtdm_app_flash -> vshci_task.o -> hci_vs_ble_qa_get_txpwr_lvl_enhanced_cmd_handler
 *
...

{
  ...
  puVar1 = (undefined1 *)r_ke_msg_alloc(0x1101,param_3,0xfd13,6);
  puVar1[1] = param_1;
  *puVar1 = 0;
  uVar2 = ble_txpwr_get(*param_2,*(undefined2 *)(param_2 + 1));
  puVar1[2] = (char)uVar2;
