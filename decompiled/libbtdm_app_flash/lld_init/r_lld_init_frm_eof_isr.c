...

{
  ...
  if (_lld_init_env == 0) {
_L220:
    r_assert_param(param_1,0x10000,0x4f4);
    return;
  }
  ...
  r_ble_log_internal_x1(0x40420127,uVar4 << 0x10 | *(ushort *)(iVar7 + uVar4 * 0x5a) & 0x1f);
  ...
  *(undefined1 *)(iVar11 + 0x31) = 0;
  if (cVar3 == '\x02') {
    ...
    while( true ) {
      iVar7 = uVar4 * 4;
      iVar11 = *(int *)(_lld_init_env + iVar7);
      if (iVar11 != 0) {
        r_ble_log_internal_x2
                  (0x40020123,*(undefined4 *)(iVar11 + 0x24),
  ...
  bVar2 = *(byte *)(iVar11 + 0x52);
  uVar4 = (iVar7 - param_2 & 0xfffffffU) + 1 >> 1;
  if (*(char *)(iVar11 + 0x3d) == '\x01') {
    ...
    *(uint *)(iVar11 + 0x10) =
    ...
    bVar10 = DAT_00013042;
    if (DAT_00013042 < *(byte *)(iVar11 + 0x16)) {
      bVar10 = *(byte *)(iVar11 + 0x16);
    }
    *(byte *)(iVar11 + 0x16) = bVar10;
    *(ushort *)(iVar11 + 0x14) = DAT_00013043 & 0xf | 0x2000;
    ...
    if (iVar8 == 0) {
      ...
      *(char *)(iVar11 + 0x3e) = (1 < uVar12) + '\x02';
      ...
      iVar7 = r_emi_get_mem_addr_by_offset(0x400);
      *(ushort *)(iVar7 + iVar8 + 4) = uVar5 & 0xffcf | (ushort)(uVar12 << 4);
      uVar5 = *(ushort *)(&lld_init_max_aux_dur_tab + uVar12 * 2);
      iVar7 = r_emi_get_mem_addr_by_offset(0x400);
      *(ushort *)(iVar8 + 0x20 + iVar7) = (ushort)(((uint)uVar5 + uVar4 + 0x270) / 0x271) & 0xff;
      if (uVar4 < 0x4000) {
        iVar7 = r_emi_get_mem_addr_by_offset(0x400);
        uVar5 = (ushort)(uVar4 + 1 >> 1);
      }
      else {
        iVar7 = r_emi_get_mem_addr_by_offset(0x400);
        uVar5 = (ushort)((uVar4 + 0x270) / 0x271) & 0xff | 0x8000;
      }
      *(ushort *)(iVar7 + iVar8 + 0x1a) = uVar5;
      ...
      iVar7 = r_emi_get_mem_addr_by_offset(0x400);
      *(ushort *)(iVar7 + iVar8 + 0x26) = uVar5 & 0x3ff | (ushort)uVar4;
      goto _L84;
    }
    *(undefined1 *)(iVar11 + 0x3d) = 0;
  }
  if (uVar4 < *(uint *)(iVar11 + 0x24)) {
    ...
    if (_sch_slice_params == 0xffffffff) {
      uVar12 = (*(ushort *)(iVar11 + 0x2c) - uVar4) * 2 + iVar7 & 0xffffffc;
    }
  ...
  *(uint *)(iVar11 + 0x10) = uVar12;
  if (param_3 == 0) {
    *(undefined1 *)(iVar11 + 0x16) = DAT_00013046;
    *(undefined4 *)(iVar11 + 0x28) = *(undefined4 *)(iVar11 + 4);
  }
  iVar8 = (uint)bVar2 * 0x5a;
  *(ushort *)(iVar11 + 0x14) = DAT_00013047 & 0xf | 0x6000;
  *(undefined1 *)(iVar11 + 0x3e) = 1;
  iVar7 = r_emi_get_mem_addr_by_offset(0x400);
  *(short *)(iVar8 + 0x20 + iVar7) = (short)uVar4;
  uVar4 = *(uint *)(iVar11 + 0x24);
  if ((uVar4 >> 0xf & 1) != 0) {
    r_assert_err(0,0x10000,0x4ab);
  }
  iVar7 = r_emi_get_mem_addr_by_offset(0x400);
  *(ushort *)(iVar8 + 0x1a + iVar7) = (ushort)uVar4 | 0x8000;
  iVar7 = r_emi_get_mem_addr_by_offset(0x400);
  *(undefined2 *)(iVar8 + 0x46 + iVar7) = 0;
  iVar7 = r_sch_arb_insert(iVar11);
  if (iVar7 != 0) {
