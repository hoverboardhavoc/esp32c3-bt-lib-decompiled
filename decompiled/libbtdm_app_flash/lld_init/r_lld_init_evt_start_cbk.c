...

{
  ...
  if (param_1 != 0) {
    r_ble_log_internal_x1
              (0x4042009f,CONCAT11(*(undefined1 *)(param_1 + 0x31),*(undefined1 *)(param_1 + 0x52)))
    ;
    ...
    *(ushort *)(iVar6 + iVar4) = uVar3 & 0xffbf | (ushort)uVar10;
    ...
    iVar6 = r_emi_get_mem_addr_by_offset(0x400);
    *(undefined2 *)(iVar4 + 0x1e + iVar6) = uVar5;
    uVar5 = r_lld_init_compute_winoffset
                      (*(undefined2 *)(iVar7 + 0x16),*(undefined2 *)(iVar7 + 0x18),uVar2,
                       *(undefined4 *)(param_1 + 4));
    iVar6 = r_emi_get_mem_addr_by_offset(0x400);
    *(undefined2 *)(iVar4 + 0x36 + iVar6) = uVar5;
    uVar5 = r_lld_init_compute_winoffset
