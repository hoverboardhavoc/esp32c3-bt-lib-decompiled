...

{
  ...
  if (*(short *)(iVar5 + 0x24) != 0) {
    r_lld_per_adv_data_set(param_1,*(undefined1 *)(iVar5 + 0x26),1);
  ...
  *(ushort *)(iVar9 + iVar6) = (ushort)(((uint)uVar4 << 0x11) >> 0x11);
  iVar9 = r_emi_get_mem_addr_by_offset(0x1400);
  if ((int)((uint)*(ushort *)(iVar6 + 6 + iVar9) << 0x13) < 0) {
    bVar2 = *(byte *)(iVar5 + 0x52);
    ...
    *(char *)(iVar5 + 0x57) = (char)uVar10;
    ...
    iVar9 = r_emi_get_mem_addr_by_offset(0x1400);
    *(ushort *)(iVar9 + iVar6 + 8) = (ushort)uVar10 | uVar4 & 0xffc0;
    bVar3 = *(byte *)(iVar5 + 0x57);
    if ((bVar3 & 0xc0) != 0) {
    ...
    iVar6 = r_emi_get_mem_addr_by_offset(0x400);
    *(ushort *)(iVar6 + iVar9) = uVar4 & 0x3ff | (ushort)bVar3 << 10;
    uVar10 = 0;
    while( true ) {
      bVar2 = *(byte *)(iVar5 + 0x52);
      ...
      *(ushort *)(iVar9 + iVar6) = uVar4 & 0x7fff;
      ...
      uVar4 = *(ushort *)(iVar9 + iVar6 + 8);
      iVar9 = r_emi_get_mem_addr_by_offset(0x1400);
      *(ushort *)(iVar9 + iVar6 + 8) = (ushort)bVar2 | uVar4 & 0xffc0;
    }
  }
  bVar2 = DAT_0001301b;
  cVar11 = DAT_0001301a;
