...

{
  ...
  if (param_1 != 0) {
    ...
    if ((*(uint *)(iVar3 + 0x28) & 0x40) != 0) {
      ...
      if (*(byte *)(iVar3 + 0x2c) < 3) {
        r_ble_log_internal_x2
                  (0x40480007,(uint)*(byte *)(param_1 + 0x52) | (uVar6 * 9 & 0xff) << 8,
    ...
    *(undefined2 *)(iVar3 + 0x50 + iVar4) = uVar2;
    ...
    iVar4 = r_emi_get_mem_addr_by_offset(0x400);
    uVar5 = *(ushort *)(iVar4 + iVar3) & 0x1f;
    r_lld_per_adv_set_tx_power(uVar6,uVar5);
    r_lld_per_adv_dynamic_pti_process(param_1);
    r_bt_rma_get_ant_by_act(uVar5,uVar6,&bStack_41,&pcStack_40);
    if ((bStack_41 & 0xfe) != 0) {
    ...
    iVar4 = r_emi_get_mem_addr_by_offset(0x400);
    *(ushort *)(iVar4 + iVar3) = uVar5 & 0xff7f | (ushort)bStack_41 << 7;
    ...
    uVar5 = *(ushort *)(iVar4 + iVar3);
    iVar4 = r_emi_get_mem_addr_by_offset(0x400);
    *(ushort *)(iVar4 + iVar3) = uVar5 & 0xffbf | (ushort)(byte)pcStack_40 << 6;
