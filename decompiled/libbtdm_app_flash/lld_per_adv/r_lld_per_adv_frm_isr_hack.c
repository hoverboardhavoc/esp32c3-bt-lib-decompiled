...

{
  ...
  if (iVar15 != 0) {
    ...
    r_ble_log_internal_x4
              (0x40440002,CONCAT22(uVar7,*(undefined2 *)(iVar9 + 0xc + iVar11)),
               uVar12 >> 1 |
               ((uint)(uVar12 < uVar14) + (int)((ulonglong)*(uint *)(iVar15 + 4) * 0x271 >> 0x20)) *
               -0x80000000,*(undefined2 *)(iVar15 + 0x4c),
               (uint)*(byte *)(iVar15 + 0x52) | param_2 << 8 | (uVar4 & 0x3f) << 0x10 |
               ((uVar5 & 0xc) << 2 | uVar6 & 3) << 0x18);
  }
  iVar9 = r_emi_get_mem_addr_by_offset(0x400);
  r_ble_log_internal_x1(0x4044012d,param_1 << 0x10 | *(ushort *)(param_1 * 0x5a + iVar9) & 0x1f);
  ...
  if (*(char *)(iVar15 + 0x53) == '\x02') {
    ...
    *puVar10 = uVar1;
    ...
    r_ble_log_internal_x1(0x4004012f,param_1 << 0x10 | (uint)*(ushort *)(*piVar8 + 0x4c));
    r_ke_free(*piVar8);
    *piVar8 = 0;
    return;
  }
