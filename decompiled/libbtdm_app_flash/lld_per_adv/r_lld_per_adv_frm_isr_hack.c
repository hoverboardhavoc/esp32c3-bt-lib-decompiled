...

{
  ...
  *(ushort *)(iVar7 + iVar5) = uVar3 & 0x7fff;
  iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
  if ((int)((uint)*(ushort *)(iVar7 + iVar5 + 6) << 0x13) < 0) {
    bVar2 = *(byte *)(iVar4 + 0x52);
    ...
    *(char *)(iVar4 + 0x57) = (char)uVar8;
    ...
    iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
    uVar3 = *(ushort *)(iVar7 + iVar5 + 8);
    iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
    *(ushort *)(iVar5 + 8 + iVar7) = uVar3 & 0xffc0 | (ushort)uVar8;
    ...
    iVar5 = r_emi_get_mem_addr_by_offset(0x400);
    *(ushort *)(iVar5 + iVar7) = uVar3 & 0x3ff | (ushort)uVar8;
    uVar8 = 0;
    while( true ) {
      bVar2 = *(byte *)(iVar4 + 0x52);
      uVar8 = uVar8 + 1 & 0xff;
      ...
      *(ushort *)(iVar7 + iVar5) = uVar3 & 0x7fff;
      ...
      uVar3 = *(ushort *)(iVar7 + iVar5 + 8);
      iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
      *(ushort *)(iVar5 + 8 + iVar7) = uVar3 & 0xffc0 | (ushort)bVar2;
    }
  }
  bVar2 = DAT_0001301b;
  cVar9 = DAT_0001301a;
  ...
  *(ushort *)(iVar4 + 0x14) = bVar2 & 0xf | 0x2000;
  iVar4 = *(int *)(&lld_per_adv_env + (uint)*(byte *)(iVar4 + 0x52) * 4);
