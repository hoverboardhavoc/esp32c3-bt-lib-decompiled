 ...
 * Source: libbtdm_app_flash -> hci_tl.o -> r_hci_tl_c2h_data_flow_on
 *
...

{
  ...
  case 0:
    if (((*(short *)(uVar3 + 8) != 0xc03) && (*(short *)(uVar3 + 8) != 0xc35)) &&
       (iVar1 = (DAT_0001201d + 1) * 0x1000000, DAT_0001201d = (byte)((uint)iVar1 >> 0x18),
       5 < iVar1 >> 0x18)) {
    ...
    break;
  case 1:
    iVar1 = (DAT_0001201d + 1) * 0x1000000;
    DAT_0001201d = (byte)((uint)iVar1 >> 0x18);
    if (5 < iVar1 >> 0x18) {
