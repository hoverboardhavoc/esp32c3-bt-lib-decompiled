 ...
 * Source: libbtdm_app_flash -> ke_task.o -> r_ke_task_schedule_hack
 *
    ...
    if (iVar2 == 0) {
      ...
      if (pcVar3 == (code *)0x0) {
        ...
        if (iVar2 == 2) {
          ...
          r_ble_log_internal_x1(0x404a020e,puVar1);
          goto _L48;
        }
        if (iVar2 != 0) {
...
_L48:
  ...
  if (_ke_env == 0) {
    r_ke_event_clear(3);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001033e. Too many branches */
