 ...
 * Source: libbtdm_app_flash -> aes_ccm.o -> r_aes_ccm_process_e
 *
...
_L41:
    ...
    if ((bVar2 & 1) == 0) {
      r_aes_ccm_xor_128_msb(iVar3,iVar9,param_2);
      r_aes_ccm_xor_128_lsb(iVar10,iVar10,iVar3,uVar7,0);
    }
    else {
      r_aes_ccm_xor_128_lsb(iVar10,iVar10,iVar9,0);
      r_aes_ccm_xor_128_msb(iVar3,iVar9,param_2,uVar7);
    }
