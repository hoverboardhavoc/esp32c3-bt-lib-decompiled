...

{
  ...
  if (0x6180f < *(int *)(param_1 + 0x10) - 0x271U) {
    r_assert_param(0,"sch_arb.c",0x296);
  }
  if (0x270 < *(uint *)(param_1 + 8)) {
    r_assert_err(0,"sch_arb.c",0x297);
  }
...
_L83:
    if (1 < *(ushort *)(param_1 + 0x14) >> 0xe) {
      ...
      if ((int)uVar4 < (int)(*(uint *)(param_1 + 0x10) / 0x271)) goto _L90;
    }
    ...
    while (piVar2 = piVar1, piVar2 != (int *)0x0) {
      if (piVar2 == (int *)param_1) {
        r_assert_err(0,"sch_arb.c",0x2ee);
      }
      ...
      if (uVar4 != 5) {
        if ((*(byte *)((int)piVar2 + 0x16) < *(byte *)(param_1 + 0x16)) &&
          ...
          if (((*(byte *)(param_1 + 0x16) <= *(byte *)((int)piVar2 + 0x16)) ||
              (_r_co_list_extract_after != piVar2)) || (1 < (uVar4 - 3 & 0xff))) goto _L90;
          if (uVar4 == 3) break;
        }
        else {
...
_L90:
  ...
  r_ble_log_internal_x3
            (0x20090228,*(undefined4 *)(param_1 + 4),*(undefined4 *)(param_1 + 0x10),
             (uint)*(byte *)(param_1 + 0x16) << 8 | uVar4);
  return uVar4;
}
