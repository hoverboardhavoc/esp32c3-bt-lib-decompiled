...
void r_llc_rem_encrypt_proc_err_cb(uint param_1,uint param_2,char *param_3)

{
  ...
  if (param_2 == 0) {
    ...
    if (3 < param_2) {
      r_assert_param("llc_encrypt.c",0x5f3);
      return;
    }
  ...
  if (((iVar5 != 0x13) || (iVar5 = r_llc_proc_state_get(uVar3), iVar5 == 0x11)) || (iVar5 == 0x12))
  {
...
_L75:
  ...
  if (((param_1 < *(byte *)(iVar2 + 0xd)) && (*(int *)(&llc_env + param_1 * 4) != 0)) &&
    ...
    if ((cVar6 == '\0') || (*(char *)(iVar5 + 0x3a) != '\0')) {
      r_llc_hci_enc_evt_send(param_1,cVar6);
    }
    *(ushort *)(iVar8 + 0x42) = *(ushort *)(iVar8 + 0x42) & 0xffdf | (ushort)(cVar6 == '\0') << 5;
