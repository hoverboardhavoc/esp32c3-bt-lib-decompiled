 ...
 * Source: libbtdm_app_flash -> llc_encrypt.o -> f_ll_pause_enc_rsp_handler
 *
...

{
  ...
  if ((*(ushort *)(iVar1 + 0x42) & 1) != 0) {
    ...
    if (iVar2 == 3) {
      r_llc_loc_encrypt_proc_continue(param_1,1,0);
      return 0;
    }
    if ((*(ushort *)(iVar1 + 0x42) & 1) != 0) {
      return 0x24;
  ...
  if (iVar1 == 3) {
    r_llc_rem_encrypt_proc_continue_eco(param_1,0xb,0);
    return 0;
  }
  return 0x24;
}
