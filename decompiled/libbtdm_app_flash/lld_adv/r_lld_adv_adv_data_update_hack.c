...

{
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      r_assert_param(param_1,0,0x10000,0xde7);
    }
  }
  else {
    r_ble_log_internal_x2
              (0x40c000d2,param_1 << 0x10 | param_3 | (uint)*(byte *)(iVar1 + 0x89) << 0x18,param_2)
    ;
    iVar1 = *(int *)(&lld_adv_env + param_1 * 4);
      ...
      *(short *)(iVar1 + 0x24) = (short)param_3;
      if (param_2 == 0) {
        adv_adv_data_need_to_set[param_1] = 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00015b38. Too many branches */
