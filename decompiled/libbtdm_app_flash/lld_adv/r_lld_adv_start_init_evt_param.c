...

{
  ...
  *(ushort *)(iVar2 + 0x76) = *(ushort *)(iVar2 + 0x76) & 0xf000 | uVar3 & 0xfff;
  if ((*(byte *)(param_2 + 0x25) & 0xf0) != 0) {
    r_assert_param(0xf000,0x10000,0xc0b);
  }
  *(ushort *)(iVar2 + 0x76) =
...
_L1066:
  ...
  *(ushort *)(iVar11 + 2 + iVar4) =
  ...
  r_lld_adv_adv_data_set_hack(param_1,uVar3,sVar6,0,0);
_L1070:
  iVar5 = uVar12 * 0xe;
  bVar7 = *(byte *)(param_2 + 0x1e);
  iVar4 = r_emi_get_mem_addr_by_offset(0x1400);
  ...
  *(ushort *)(iVar4 + iVar13) = (ushort)((bVar7 & 1) << 6) | 4;
    ...
    if (*(ushort *)(param_2 + 0x16) == 0) {
      ...
      *(ushort *)(iVar4 + iVar5) = (short)uVar9 * 0xe + 0x1400U | uVar3 & 0x8000;
      ...
      if (iVar4 != 0) {
        ...
        iVar10 = iVar5 + 10;
        uVar3 = *(ushort *)(iVar13 + iVar10);
        iVar13 = r_emi_get_mem_addr_by_offset(0x1400);
        *(ushort *)(iVar13 + iVar10) = uVar3 & 0xf0ff | (ushort)uVar9;
        bVar7 = *(byte *)(iVar4 + 4);
        iVar4 = r_emi_get_mem_addr_by_offset(0x1400);
        uVar3 = *(ushort *)(iVar4 + iVar10);
        iVar4 = r_emi_get_mem_addr_by_offset(0x1400);
        *(ushort *)(iVar4 + iVar10) = uVar3 & 0xefff | (ushort)bVar7 << 0xc;
      }
    }
    else {
  ...
  if ((*(ushort *)(iVar2 + 0x74) & 6) == 2) {
    ...
    iVar2 = r_emi_get_mem_addr_by_offset(0x1400);
    *(ushort *)(iVar2 + iVar11) = (short)uVar12 * 0xe + 0x1400U | uVar3 & 0x8000;
    iVar2 = r_emi_get_mem_addr_by_offset(0x1400);
  ...
  uVar3 = *(ushort *)(iVar2 + iVar11);
  iVar2 = r_emi_get_mem_addr_by_offset(0x1400);
  *(ushort *)(iVar11 + iVar2) = (ushort)(((uint)uVar3 << 0x11) >> 0x11);
  return;
}
