  ...
  if (param_3 < 3) {
    ...
    if (iVar5 != 0) {
      ...
      if ((param_3 == 0) && (g_ble_ext_config != '\0')) {
        DAT_00016580 = DAT_00016580 + 1;
      }
      if (bVar1 && bVar2) {
        g_adv_delay_dis = '\x01';
        unaff_s5 = *(undefined4 *)(iVar5 + 100);
        ...
        *(uint *)(iVar5 + 100) = (uint)(*(int *)(iVar5 + 100) * 2 + iVar7) >> 1;
      }
    }
       ...
       (((*(ushort *)(iVar5 + 0x74) & 0x10) == 0 || ((*(ushort *)(iVar5 + 0x74) & 0x14) == 0x10))))
    {
      r_lld_adv_adv_data_set_hack
                (param_2,*(undefined1 *)(iVar5 + 0x28),*(undefined2 *)(iVar5 + 0x24),1,1);
    ...
    if ((iVar5 != 0) && (bVar3)) {
      g_adv_delay_dis = '\0';
      *(undefined4 *)(iVar5 + 100) = unaff_s5;
    }
    return;
  }
  if (param_3 != 4) {
    r_assert_param(param_3,0x10000,0xb76);
    return;
  }
  param_2 = param_2 & 0xff;
  iVar5 = *(int *)(&lld_adv_env + param_2 * 4);
  ...
  if (*(char *)(iVar5 + 0x89) == '\x02') {
    ...
    if ((*(char *)(iVar5 + 0x95) == '\0') || (*(int *)(iVar5 + 0x38) != param_1)) {
      ...
      if ((*(ushort *)(iVar5 + 0x74) & 8) == 0) {
        if ((uint)(*(int *)(iVar5 + 100) << 1) <= (param_1 - *(int *)(iVar5 + 0x5c) & 0xfffffffU)) {
...
_L1049:
  ...
  if (iVar5 != 0) {
    ...
    if (((*(uint *)(iVar7 + 0x28) & 4) != 0) &&
       (iVar7 = r_sdk_config_get_opts_ext(), *(byte *)(iVar7 + 0x2c) < 3)) {
      r_ble_log_internal_x1
                (0x40000002,(uint)*(byte *)(iVar5 + 0x89) << 0x18 | uVar8 << 0x10 | 0x100 | param_2)
      ;
    }
