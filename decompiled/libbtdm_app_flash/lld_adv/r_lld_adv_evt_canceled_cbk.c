...

{
  ...
  if (param_1 == 0) {
    ...
    r_ble_log_internal_x1
              (0x404000cf,CONCAT11(*(undefined1 *)(param_1 + 0x89),*(undefined1 *)(param_1 + 0x87)))
    ;
    if (*(char *)(param_1 + 0x89) != '\0') {
      r_assert_err(0,0x10000,0x9b9);
    }
    cVar2 = rwip_priority;
    ...
    if (*(int *)(param_1 + 0x58) != -1) {
      ...
      if (iVar6 != 0) {
        r_ble_log_internal_x1(0x400000c0,(uint)*(byte *)(iVar6 + 0x89) << 0x18 | uVar7 | 0x3c0100);
