...
_L1253:
  ...
  *(uint *)(iVar3 + 0x58) = uVar1;
  r_ble_log_internal_x2(0x40000072,param_1 << 0x10 | param_3 << 0x18 | param_2);
_L1249:
                    /* WARNING: Could not recover jumptable at 0x00016418. Too many branches */
