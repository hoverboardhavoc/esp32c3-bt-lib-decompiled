...
void r_lld_adv_adv_data_update(uint param_1,int param_2,undefined4 param_3)

{
  ...
  if (*(int *)(&lld_adv_env + iVar2) == 0) {
    ...
    if (iVar2 == 0) {
      r_assert_param(param_1,0,"lld_adv.c",0xda7);
    }
  }
  else {
      ...
      *(short *)(iVar2 + 0x24) = (short)param_3;
      if (param_2 == 0) {
        adv_adv_data_need_to_set[param_1] = 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00015974. Too many branches */
