...

{
  ...
  sVar2 = DAT_00016584;
  if (((DAT_00016584 != 0) && (DAT_00016586 != 0)) && (*(int *)(&lld_adv_env + param_1 * 4) != 0)) {
  ...
  if ((*(char *)(iVar4 + 0x18) == '\0') && ((*(ushort *)(param_2 + 0x18) & 0x10) != 0)) {
    ...
    iVar4 = r_emi_get_mem_addr_by_offset(0x1400);
    *(ushort *)(iVar4 + iVar7) = uVar1 & 0xffdf;
    iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
    iVar4 = (uVar3 + 1 & 0xff) * 0xe + 2;
    uVar1 = *(ushort *)(iVar7 + iVar4);
    iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
    *(ushort *)(iVar7 + iVar4) = uVar1 & 0xffdf;
  }
  ...
  if (iVar7 != 0) {
    ...
    for (cVar8 = '\0'; cVar8 != cVar6; cVar8 = cVar8 + '\x01') {
      if ((iVar7 - 1U & 0xfe) != 0) {
      ...
      iVar5 = r_emi_get_mem_addr_by_offset(0x1400);
      *(ushort *)(iVar5 + iVar4) = (ushort)(((iVar7 - 1U & 0xff) << 0x15) >> 0x10) | uVar1 & 0xffdf;
      iVar4 = iVar4 + 0xe;
    }
  }
