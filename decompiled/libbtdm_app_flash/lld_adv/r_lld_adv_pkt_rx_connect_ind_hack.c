...

{
  ...
  pvVar5 = (void *)r_emi_get_mem_addr_by_offset(*(undefined2 *)((uint)bVar1 * 0x14 + 0x12 + iVar4));
  ...
  if ((*(char *)(iVar4 + 0x24) != '\0') &&
     (iVar4 = r_lld_adv_utils_verify_aa(uStack_28), iVar4 == 0)) {
    return 0;
  }
  bVar1 = *(byte *)(_p_lld_env + 0xd8);
  ...
  iVar2 = r_emi_get_mem_addr_by_offset(0x1000);
  pvVar5 = (void *)r_emi_get_mem_addr_by_offset(*(undefined2 *)(iVar2 + iVar4 + 0x12));
  ...
  uVar3 = r_co_nb_good_le_channels(&uStack_28);
  if (uVar3 < 2) {
    return 0;
  }
  if ((bStack_24 & 0xe0) != 0) {
  ...
  if (uVar3 == 0) {
    ...
    pvVar5 = (void *)r_emi_get_mem_addr_by_offset(uVar3 + 0x18 & 0xffff);
    ...
    if ((((*(ushort *)(iVar2 + iVar4) >> 1 & 1) != 0) &&
        (iVar2 = r_emi_get_mem_addr_by_offset(0xc60), (*(ushort *)(iVar2 + iVar4) >> 3 & 1) != 0))
       && (iVar2 = r_co_bdaddr_compare(&uStack_44,auStack_5c), iVar2 == 0)) {
      uVar6 = uVar6 | 2;
      uStack_54 = uStack_44;
      uStack_50 = uStack_40;
      goto _L745;
