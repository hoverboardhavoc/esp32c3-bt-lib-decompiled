...

{
  ...
  r_ble_log_internal_x1(0x40a000c7,uVar3);
  ...
  r_ble_log_internal_hex(0x20a000c8,0x22,auStack_34);
  if ((uStack_28 & 0xffff) == uStack_28 >> 0x10) {
    r_ble_log_internal_x2(0x80a000c9,uVar3);
    uVar2 = 0;
  }
  else {
    ...
    if ((*(char *)(iVar4 + 0x24) != '\0') &&
      ...
      r_ble_log_internal_x2(0x80a000ca,uVar3);
      return 0;
    }
