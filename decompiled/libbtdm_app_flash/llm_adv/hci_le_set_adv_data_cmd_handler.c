...

{
  ...
  if (*(char *)(_p_llm_env + 0xd7) == '\x02') {
    r_ble_log_internal_x1(0x802e0150,0x212);
    uVar3 = 0xc;
  }
  else {
    *(undefined1 *)(_p_llm_env + 0xd7) = 1;
    if (*param_1 < 0x20) {
      ...
      if (iVar4 == 0xff) {
        ...
        if (uVar3 != 0) {
          r_ble_log_internal_x1(0x802e0152,(uint)abStack_21[0] << 8 | uVar3);
          goto _L284;
        }
      ...
      if (*param_1 != 0) {
        ...
        bVar1 = *param_1;
        if (iVar4 == 0) {
          r_ble_log_internal_x1(0x802e0153,(uint)bVar1 << 8 | 7);
          uVar3 = 7;
          goto _L284;
        }
      ...
      *(ushort *)(iVar5 + 0x2a) = (ushort)*param_1;
      ...
      r_ble_log_internal_x1(0x802e0151,(uint)*param_1 << 8 | 0x12);
      uVar3 = 0x12;
    }
  }
_L284:
