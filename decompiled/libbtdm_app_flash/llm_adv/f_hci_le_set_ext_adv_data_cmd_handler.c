...

{
  ...
  *(undefined1 *)(_p_llm_env + 0xd7) = 2;
  iVar6 = r_llm_adv_hdl_to_id(*param_1,&iStack_30);
  uVar8 = 0x42;
  if (iVar6 == 0xff) goto _L444;
  bVar1 = param_1[1];
  if (((bVar1 < 5) && ((byte)param_1[2] < 2)) && (bVar2 = param_1[3], bVar2 < 0xfc)) {
    uVar4 = *(ushort *)(iStack_30 + 2);
    if ((uVar4 & 0x10) == 0) {
      if ((bVar1 != 4) ||
         (((iVar9 = *(int *)(_p_llm_env + 8) + iVar6 * 0x44, *(char *)(iVar9 + 0x40) != '\x01' &&
           (*(short *)(iVar9 + 0x28) != 0)) && (bVar2 == 0)))) goto _L413;
    }
...
_L413:
      if ((((byte)(bVar1 - 3) < 2) || (bVar2 != 0)) && ((uVar4 & 0x12) != 2)) {
        ...
        if (*(char *)(*(int *)(_p_llm_env + 8) + iVar9 + 0x40) != '\x01') {
          uVar8 = 0xc;
          if (1 < (byte)(bVar1 - 3)) goto _L444;
          if ((((uVar4 & 0x11) == 1) && (iVar7 = r_llm_adv_con_len_check(), iVar7 != 0)) ||
...
_L472:
            ...
            if ((*(short *)(*(int *)(_p_llm_env + 8) + iVar9 + 0x2c) == 0) && (!bVar3)) goto _L473;
          }
          bVar1 = param_1[3];
          if (bVar1 != 0) {
            iVar7 = *(int *)(_p_llm_env + 8) + iVar9;
          ...
          if ((byte)(param_1[1] - 2) < 2) {
            ...
            *(undefined4 *)(iVar9 + 0x28) = uVar8;
            ...
            r_lld_adv_adv_data_update_hack(iVar6,0,0);
          }
          uVar8 = 0;
        }
        goto _L444;
