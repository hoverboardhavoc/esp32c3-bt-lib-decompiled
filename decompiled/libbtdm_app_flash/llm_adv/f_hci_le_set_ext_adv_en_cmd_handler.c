  ...
  *(undefined1 *)(_p_llm_env + 0xd7) = 2;
  if (*param_1 == 0) {
    if (*(byte *)(iVar11 + 0xd6) != 0) {
      r_ble_log_internal_x1(0x402e0191,(uint)*(byte *)(iVar11 + 0xd6) << 0x10 | 0x12);
      return 2;
    }
_L608:
    if (*(short *)param_1 != 1) {
        ...
        for (uVar9 = 0; iVar11 = r_sdk_config_get_opts(), uVar9 < *(byte *)(iVar11 + 0xd);
          ...
          if ((*(char *)(*(int *)(_p_llm_env + 8) + uVar9 * 0x44 + 0x40) == '\x02') &&
            ...
            *(char *)(iVar11 + 0xd6) = *(char *)(iVar11 + 0xd6) + '\x01';
            r_ble_log_internal_x1(0x404e019d,uVar9 | 0x300);
...
_L741:
          ...
          if (*param_1 == 1) {
            ...
            if (((uVar2 & 2) != 0) && ((short)piVar8[0xd] == 0 && (uVar2 & 0x10) == 0)) {
              r_ble_log_internal_x1(0x802e0194,iVar11 << 8 | 0xc);
              goto _L740;
            }
            if (((uVar2 & 0x11) == 1) &&
            ...
            if ((*(ushort *)(iVar13 + 2) & 1) != 0) {
              if (((*(ushort *)(iVar13 + 2) & 0xc) != 0) &&
                 ...
                 iVar5 != 0)) {
                r_ble_log_internal_x1(0x802e0196,*(ushort *)(iVar13 + 2) | 0xb0000);
                iVar11 = 0xb;
                goto _L606;
              }
            ...
            if (((*(byte *)(iVar13 + 0xb) & 1) != 0) &&
               ...
               iVar3 != 0)) {
              r_ble_log_internal_x1
                        (0x802e0198,(uint)*(byte *)(iVar13 + 0xb) << 0x10 | iVar11 << 8 | 0x12);
              goto _L739;
            }
          }
        ...
        if (uVar9 != 0) {
          ...
          if (uVar12 < uVar9) {
            r_ble_log_internal_x1(0x802e0199,uVar12 << 8 | uVar9 << 0x10 | 7);
            iVar11 = 7;
            goto _L606;
          }
        }
...
_L630:
              if ((((_DAT_0001405e & 2) == 0) || ((char)piVar8[0x10] == '\x02')) &&
                ...
                *(char *)(iVar11 + 0xd6) = *(char *)(iVar11 + 0xd6) + '\x01';
                r_ble_log_internal_x1(0x404e019c,uVar12 | 0x300);
                uVar10 = 0;
            ...
            *(undefined1 *)(*(int *)(_p_llm_env + 8) + iVar3 + 0x40) = 2;
            r_ble_log_internal_x1(0x404e019a,uVar12 | 0x200);
            ...
            if (((*(ushort *)(iVar13 + 2) & 0x13) == 0) &&
              ...
              if (iVar3 == 0) {
                ...
                *(undefined1 *)(iVar11 + 0x40) = 0xc;
                r_ble_log_internal_x1(0x404e019b,uVar10 | 0xc00);
