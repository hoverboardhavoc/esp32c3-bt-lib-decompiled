...
_L42:
    ...
    uVar18 = 0;
    if (param_1[1] != 0x3c) goto _L78;
  }
  else {
    if (uVar18 == 0) {
      if ((param_1[1] != 0x3c) && (param_1[1] != 0x43)) goto _L42;
      goto _L75;
    }
    ...
    if (iVar5 != 0) {
      ...
      uStack_38 = CONCAT13(puVar4[0x16],CONCAT12(bStack_34,CONCAT11(puVar4[0x14],uVar12)));
    ...
    if (bStack_67 == 0xff) {
      ...
      if (*(char *)((uint)bStack_67 * 0x44 + *(int *)(_p_llm_env + 8) + 0x40) == '\0') {
        ...
        iVar14 = (uint)bStack_67 * 0x44 + *(int *)(_p_llm_env + 8);
        if (iVar5 == 0) {
          *(byte *)(*(int *)(_p_llm_env + 8) + iVar16 + 0x3e) = bStack_67;
          *(undefined1 *)(iVar14 + 0x40) = 4;
        }
        else {
          r_assert_param(uVar17,*(undefined1 *)(iVar14 + 0x40),"llm_adv.c",0xac7);
        }
      }
      ...
      bVar3 = bStack_67;
      iVar5 = _p_llm_env;
      iVar14 = *(int *)(_p_llm_env + 8) + (uint)bStack_67 * 0x44;
      memcpy((void *)(iVar14 + 4),pbVar10,6);
      bVar1 = param_1[0x37];
      *(undefined1 *)(iVar14 + 0x28) = 1;
      *(byte *)(iVar14 + 0x41) = bVar1;
      *(undefined1 *)(iVar14 + 0x40) = 9;
      uVar2 = *(ushort *)(param_1 + 0x1e);
      *(undefined4 *)(iVar14 + 0x14) = 0;
      *(uint *)(iVar14 + 0x10) = (uint)uVar2 << 1;
      *(undefined4 *)(iVar14 + 0x18) = 5;
      *(undefined4 *)(iVar14 + 0x1c) = 5;
      cVar11 = *(char *)(iVar5 + 0xd8);
      puVar15 = (undefined *)0x0;
      if (cVar11 != '\0') {
        puVar15 = &r_llc_con_move_cbk;
        cVar11 = '\x01';
      }
      *(undefined **)(iVar14 + 0x24) = puVar15;
      *(char *)(iVar14 + 0x22) = cVar11;
      *(ushort *)(iVar14 + 0x20) = (ushort)bVar3;
      iVar5 = r_sdk_config_get_opts();
      if (*(char *)(iVar5 + 0x15) == '\x01') {
        uVar12 = *(undefined1 *)(iVar14 + 0x20);
        uVar19 = *(uint *)(iVar14 + 0x1c);
        uVar8 = r_lld_con_evt_duration_min_get(uVar12);
        uVar9 = uVar8 / 0x4e2;
        if (uVar8 / 0x4e2 < uVar19) {
          uVar9 = uVar19;
        }
        *(uint *)(iVar14 + 0x1c) = uVar9;
        uVar19 = *(uint *)(iVar14 + 0x18);
        uVar8 = r_lld_con_evt_duration_min_get(uVar12);
        uVar9 = uVar8 / 0x4e2;
        if (uVar8 / 0x4e2 < uVar19) {
          uVar9 = uVar19;
        }
        *(uint *)(iVar14 + 0x18) = uVar9;
      }
      else {
        iVar5 = r_sdk_config_get_opts();
        if ((*(char *)(iVar5 + 0x15) == '\x02') &&
           (iVar5 = r_lld_con_evt_sd_evt_time_get
                              (*(undefined1 *)(iVar14 + 0x20),&uStack_66,&uStack_64), iVar5 == 0)) {
          *(uint *)(iVar14 + 0x1c) = (uint)uStack_66;
          *(uint *)(iVar14 + 0x18) = (uint)uStack_64;
        }
      }
      if (sdk_cfg_priv_opts != '\0') {
        r_sch_plan_set(iVar14 + 0xc);
      }
      ...
      *(undefined1 *)(*(int *)(_p_llm_env + 8) + iVar16 + 0x40) = 1;
      if (_bt_rf_coex_hooks_p != (undefined4 *)0x0) {
        ...
        if ((code *)_bt_rf_coex_hooks_p[1] != (code *)0x0) {
          ...
          uStack_5c = 0;
          uStack_5a = 0;
          uStack_60 = (undefined2)*(undefined4 *)(*(int *)(_p_llm_env + 8) + iVar16 + 0x1c);
