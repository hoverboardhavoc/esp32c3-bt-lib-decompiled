...

{
  ...
  if ((*(char *)(iVar6 + 0x18) == '\0') ||
     (iVar6 = r_sdk_config_get_opts_ext(), *(char *)(iVar6 + 0x2d) == '\0')) {
...
_L367:
    ...
    *(undefined1 *)(_p_llm_env + 0xd7) = 2;
    ...
    if (iVar6 == 0xff) {
      ...
      if (iVar6 != 0) goto _L370;
      *(undefined1 *)(*(int *)(_p_llm_env + 8) + (uint)bStack_2d * 0x44 + 0x3d) = 0xff;
    }
    else if (*(char *)(*(int *)(_p_llm_env + 8) + iVar6 * 0x44 + 0x40) != '\x01') goto _L367;
    if ((*param_1 < 0xf0) &&
      ...
      if (((*(char *)(iVar6 + 0x22) != '\0') ||
         ...
         (((uVar1 & 0x10) != 0 ||
          (((((uVar1 & 3) != 3 && ((uVar1 & 8) == 0)) &&
           ...
           (((uVar1 & 1) == 0 ||
            (iVar6 = r_sdk_config_get_opts_ext(), *(char *)(iVar6 + 0x22) != '\0')))))))) {
        uVar1 = *(ushort *)(param_1 + 2);
