...
_L752:
    ...
    *(undefined1 *)(_p_llm_env + 0xd7) = 2;
    if (*param_1 < 0xf0) {
      ...
      if (iVar3 == 0xff) {
        r_ble_log_internal_x1(0x802e0116,(uint)*param_1 << 8 | 0xff0042);
        uVar1 = 0x42;
        goto _L754;
      }
      iVar6 = iVar3 * 0x44;
      ...
      if (bStack_2d == 0xff) {
        ...
        if (uVar1 != 0) {
          r_ble_log_internal_x1(0x802e0117,(uint)bStack_2d << 0x10 | iVar3 << 8 | uVar1);
          goto _L754;
        }
      ...
      if (((*param_1 < 0xf0) && (*(ushort *)(param_1 + 2) <= *(ushort *)(param_1 + 4))) &&
        ...
        *(undefined1 *)(iVar3 + (uint)bStack_2d * 0x44 + 0x40) = 10;
        r_ble_log_internal_x1(0x404e0118,bStack_2d | 0xa00);
      ...
      r_ble_log_internal_x1(0x802e0115,(uint)*param_1 << 8 | 0x12);
    }
    uVar1 = 0x12;
  }
_L754:
