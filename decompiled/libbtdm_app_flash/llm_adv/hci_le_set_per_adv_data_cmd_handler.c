...
_L731:
  ...
  if (bVar1 != 3) {
    if (uVar9 == 0) goto _L731;
    if (*(char *)(uVar13 * 0x44 + iVar11 + 0x40) == '\f') goto _L730;
  }
  iVar3 = uVar13 * 0x44;
  iVar11 = iVar11 + iVar3;
...
_L770:
      ...
      *(undefined2 *)(iVar11 + 0x2c) = uVar6;
      if ((*(short *)(*(int *)(iVar12 + 8) + iVar3 + 0x2c) == 0) && (!bVar2)) goto _L771;
    }
    bVar1 = param_1[2];
    if (bVar1 != 0) {
      iVar11 = *(int *)(_p_llm_env + 8) + iVar3;
