        ...
        if (*param_1 == 0) {
          if (*(char *)(iVar3 + 0x40) == '\v') {
            *(undefined1 *)(iVar3 + 0x40) = 10;
            ...
            iVar3 = r_lld_per_adv_stop(uVar7);
            if (iVar3 == 0) {
              piVar8 = (int *)(*(int *)(_p_llm_env + 8) + iVar11);
...
_L852:
          ...
          if (*(char *)(iVar3 + 0x40) != '\r') {
            ...
            if ((*(ushort *)(iVar4 + 2) & 0x13) == 0) {
                 ...
                 (piVar9 = (int *)(*(int *)(_p_llm_env + 8) + iVar10), (char)piVar9[0x10] == '\v'))
              {
                ...
                iVar3 = r_lld_per_adv_start(uVar7,&local_60);
                if (iVar3 != 0) goto _L843;
        ...
        r_ble_log_internal_x2
                  (0x802e011f,iVar5 << 0x18 | (uint)*(ushort *)(iVar3 + 0x2c) | 0xc0000,uVar7);
      }
_L886:
      iVar3 = 0xc;
      goto _L843;
