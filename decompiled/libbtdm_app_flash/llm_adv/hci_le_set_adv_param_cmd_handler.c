...
_L229:
  ...
  *(undefined1 *)(_p_llm_env + 0xd7) = 1;
  ...
  if (iVar6 == 0xff) {
    ...
    if (iVar6 != 0) goto _L244;
    r_llm_adv_set_dft_params(bStack_3d,0);
  }
  else if (*(char *)(iVar6 * 0x44 + *(int *)(_p_llm_env + 8) + 0x40) != '\x01') goto _L229;
  *(undefined1 *)(*(int *)(_p_llm_env + 8) + (uint)bStack_3d * 0x44 + 0x3d) = 0xff;
  bVar1 = (byte)param_1[2];
  if (bVar1 < 5) {
    if (bVar1 != 1) {
      if (((param_1[1] < *param_1) || (*param_1 < 8)) || (0x4000 < param_1[1])) goto _L235;
    }
...
_L236:
          ...
          if (iVar6 != 0) goto _L235;
          bVar4 = true;
        }
        else {
          bVar4 = false;
          if (bVar1 == 4) goto _L236;
        }
        iVar6 = _p_llm_env;
