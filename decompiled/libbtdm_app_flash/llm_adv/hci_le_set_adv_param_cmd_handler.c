    ...
    if (cVar9 != '\0') {
      *(undefined1 *)(_p_llm_env + 0xd7) = 1;
      ...
      if (iVar5 == 0xff) {
        ...
        if (uVar7 != 0) {
          r_ble_log_internal_x1(0x802e00ef,(uint)bStack_3d << 8 | uVar7);
          goto _L253;
        }
        ...
        if (uVar7 != 1) {
          r_ble_log_internal_x1(0x802e00ee,uVar7 << 0x10 | iVar5 << 8 | 0xc);
          goto _L235;
        }
      }
            ...
            if ((cVar1 == '\x01') || (cVar1 == '\x04')) {
              ...
              if (iVar5 != 0) {
                r_ble_log_internal_x1
                          (0x802e00f0,(uint)bStack_3d << 8 | (uint)(byte)param_1[2] << 0x10 | 0x12);
                goto _L273;
              }
            }
            else {
...
_L249:
            ...
            *(undefined1 *)(*(int *)(_p_llm_env + 8) + (uint)bStack_3d * 0x44 + 0x40) = 1;
            r_ble_log_internal_x1(0x404e00f1,bStack_3d | 0x100);
