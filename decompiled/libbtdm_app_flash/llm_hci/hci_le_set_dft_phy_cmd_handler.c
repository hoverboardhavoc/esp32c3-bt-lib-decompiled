...

{
  ...
  iVar2 = _p_llm_env;
  bVar1 = *param_1;
  if (((bVar1 & 2) == 0) && (uVar3 = 0x12, param_1[2] == 0)) goto _L3;
  if ((bVar1 & 1) == 0) {
    uVar3 = 0x12;
    if (param_1[1] == 0) goto _L3;
    if ((bVar1 & 2) == 0) goto _L9;
_L10:
    uVar3 = 0x11;
    if (param_1[1] != (param_1[1] & 7)) goto _L3;
    bVar4 = 7;
    if ((bVar1 & 2) == 0) goto _L7;
  }
  else if ((bVar1 & 2) == 0) {
_L9:
    uVar3 = 0x11;
    if (param_1[2] != (param_1[2] & 7)) goto _L3;
    if ((bVar1 & 1) == 0) goto _L10;
_L7:
    bVar4 = param_1[2];
  }
  else {
