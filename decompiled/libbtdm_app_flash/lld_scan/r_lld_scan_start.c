...
_L916:
            ...
            if (9 < bVar2) {
              if (bVar2 == 10) {
                ...
                uVar15 = 8;
                if (bVar2 != 0xb) goto _L822;
              }
              goto _L916;
            }
            uVar15 = 5;
            if (bVar2 == 8) goto _L916;
_L822:
            r_assert_err(0,"lld_scan.c",0xc35);
          }
              ...
              *(uint *)(iVar20 + 0x28) = uVar11;
              ...
              if (iVar13 == 0) {
                ...
                *(undefined2 *)(iVar20 + 0x36) = 0;
                ...
                r_assert_err(0,"lld_scan.c",0xc87);
              }
            }
            piVar23 = piVar23 + 1;
