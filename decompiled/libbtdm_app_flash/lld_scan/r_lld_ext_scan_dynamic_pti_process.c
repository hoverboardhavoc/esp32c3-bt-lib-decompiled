    ...
    *puVar3 = *puVar3 & 0xdfffffff | uVar7 << 0x1d;
    if (*(char *)(param_1 + 0x39) == '\x01') {
      ...
      *(ushort *)(iVar5 + iVar4) = uVar2 & 0xf0ff | (ushort)uVar6;
      ...
      uVar2 = *(ushort *)(iVar5 + iVar4);
      iVar5 = r_emi_get_mem_addr_by_offset(0x1400);
      *(ushort *)(iVar5 + iVar4) = uVar2 & 0xefff | (ushort)uVar7;
    }
  }
  return;
}
