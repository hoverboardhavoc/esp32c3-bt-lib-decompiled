...
_L166:
          ...
          uVar12 = 3;
          if (*(char *)(iVar8 + 0x6e) == '\0') goto _L166;
        }
      ...
      if (((uVar5 & 0x300) == 0) && ((*(byte *)(iVar8 + 0x6d) & 0x10) == 0)) goto _L159;
      *(undefined1 *)(iVar8 + 0x6e) = 0xff;
      r_ble_log_internal_x2(0x40a1013f,CONCAT22(uVar5,uVar4));
    }
_L161:
    if (*(char *)(iVar8 + 0x6e) != -1) goto _L158;
  }
