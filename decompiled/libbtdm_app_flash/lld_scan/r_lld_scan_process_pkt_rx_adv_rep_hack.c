...
void r_lld_scan_process_pkt_rx_adv_rep_hack(uint param_1,undefined1 param_2,int param_3,int param_4)

{
  ...
  sVar3 = *(short *)(param_3 + 0x12 + iVar9);
  if (*(char *)(iVar7 + 0x6e) != -1) {
    ...
    if ((((uVar4 & 0x10) == 0) || ((*(byte *)(iVar7 + 0x6d) & 4) != 0)) ||
       ((iVar9 = r_emi_get_mem_addr_by_offset(0x1000),
        (*(ushort *)(param_3 + 0x10 + iVar9) & 0x300) == 0 &&
      ...
      if (*(char *)(param_4 + 8) != -1) {
        *(byte *)(iVar7 + 0x58) = (byte)(uVar4 >> 7) & 1;
        iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
        uVar5 = *(undefined2 *)(param_3 + 0xe + iVar9);
    ...
    if (*(byte *)(iVar9 + 0x2c) < 3) {
      r_ble_log_internal_x1
                (0x40a1000d,
                 ...
                 param_1 | (uint)*(byte *)(iVar7 + 0x3d) << 8);
      return;
    }
  }
  return;
