...

{
  ...
  if (((_lld_scan_env == 0) || (iVar11 = *(int *)(param_1 * 4 + _lld_scan_env), iVar11 == 0)) ||
     (*(char *)(_lld_scan_env + 0x17) == '\0')) {
    return;
  }
  if (((iVar11 == 0) || (*(char *)(_lld_scan_env + 0x17) == '\0')) ||
     (*(char *)(iVar11 + 0x3d) != '\0')) {
    return;
  }
  if (((iVar11 != 0) && (_lld_scan_env != 0)) &&
    ...
    if (((iVar11 != 0) && (_lld_scan_env != 0)) &&
       (iVar10 = r_bt_rf_coex_ext_scan_dynamic_pti_en_get(), iVar10 != 0)) {
      r_lld_ext_scan_dynamic_pti_get(iVar11,1,&uStack_3c);
      uVar6 = uStack_38;
      uVar5 = uStack_3c;
      bVar1 = *(byte *)(iVar11 + 0x38);
