...

{
  ...
  *(byte *)(iVar7 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar9 + iVar17 + 6) >> 0xe);
  ...
  if (*(char *)(iVar7 + 0x6e) == -1) {
    if ((*(ushort *)(param_3 + 6) & 0x1000) != 0) goto _L534;
  }
  else {
...
_L484:
  if (-1 < (int)((uint)*(ushort *)(param_3 + 6) << 0x12)) goto _L486;
    ...
    if (iVar9 == 0) {
      ...
      *(uint *)(puVar12 + 0x18) = CONCAT22(uVar4,*(undefined2 *)(iVar9 + iVar17 + 8));
      ...
      if (((g_bt_plf_log_level & 2) != 0) && (((byte)puVar12[0x1e] - 2 & 0xff) < 2)) {
        uVar19 = (int)(((uVar16 & 0xffff) + (uint)_DAT_000150c6 * -2) * 0x10000) >> 0x10;
      }
