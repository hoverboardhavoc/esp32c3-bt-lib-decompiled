...

{
  ...
  sVar2 = *(short *)(iVar16 + 0x12 + iVar9);
  *(ushort *)(iVar7 + 0x36) = (ushort)(byte)param_3[5];
  iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
  *(byte *)(iVar7 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar9 + iVar16 + 6) >> 0xe);
  ...
  if ((*(ushort *)(param_3 + 6) & 0x100) == 0) {
    ...
    if ((((*(byte *)(_lld_scan_env + 0x15) & 0xfd) == 1) &&
        (sVar8 = sVar19, *(char *)(iVar7 + 0x6f) == -1)) && ((_DAT_60031000 >> 10 & 1) != 0)) {
      *(undefined1 *)(iVar7 + 0x6e) = 0xff;
    }
  }
  else {
    if ((param_3[1] == '\0') && (*(char *)(iVar7 + 0x6f) != -1)) {
      *(ushort *)(param_3 + 6) = *(ushort *)(param_3 + 6) & 0xfeff;
      ...
      iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
      bVar14 = (byte)(*(ushort *)(iVar16 + 4 + iVar9) >> 6) & 1;
      param_3[8] = bVar14;
  ...
  if ((*(ushort *)(param_3 + 6) & 0x200) != 0) {
    if (*(byte *)(iVar7 + 0x6d) == 4) {
      ...
      *(byte *)(iVar7 + 0x6d) = *(byte *)(iVar7 + 0x6d) | 4;
      iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
      *(byte *)(iVar7 + 0x70) = (byte)(*(ushort *)(iVar16 + 4 + iVar9) >> 7) & 1;
  ...
  if (*(char *)(iVar7 + 0x6e) == -1) {
    if ((*(ushort *)(param_3 + 6) & 0x1000) == 0) goto _L482;
  }
  else {
    ...
    iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
    if ((*(ushort *)(iVar16 + 2 + iVar9) >> 9 & 1) == 0) {
      iVar9 = r_lld_calc_aux_rx(iVar7 + 0x48,param_2);
      uVar15 = 1;
      if (iVar9 != 0) goto _L531;
    ...
    if ((bVar1 || puVar12 == (undefined1 *)0x0) ||
      ...
      *(undefined2 *)(iVar7 + 0x76) = *puVar13;
      ...
      if (iVar9 == 0) {
        ...
        *puVar12 = *_lld_scan_sync_env;
        iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
        puVar12[0x1e] = (byte)((ushort)*(undefined2 *)(iVar9 + iVar16 + 6) >> 0xe);
        iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
        uVar4 = *(ushort *)(iVar16 + 10 + iVar9);
        if ((uVar4 & 0xf000) != 0) {
          r_assert_err(0,"lld_scan.c",1000);
        }
        iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
        *(uint *)(puVar12 + 0x18) = CONCAT22(uVar4,*(undefined2 *)(iVar16 + 8 + iVar9));
        iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
        uVar17 = ((uint)*(ushort *)(&lld_exp_sync_pos_tab + (uint)(byte)puVar12[0x1e] * 2) * -2 +
                 0x270) - (*(ushort *)(iVar16 + 0xc + iVar9) & 0x3ff);
        uVar18 = (int)(uVar17 * 0x10000) >> 0x10;
        if (((g_bt_plf_log_level & 2) != 0) && (((byte)puVar12[0x1e] - 2 & 0xff) < 2)) {
          uVar18 = (int)(((uVar17 & 0xffff) + (uint)_DAT_000150c6 * -2) * 0x10000) >> 0x10;
        }
        if (0x751 < (uVar18 + 0x4e1 & 0xffff)) {
          r_assert_err(0,"lld_scan.c",0x6d1);
        }
        for (; (int)uVar18 < 0; uVar18 = (int)(((uVar18 & 0xffff) + 0x271) * 0x10000) >> 0x10) {
          *(uint *)(puVar12 + 0x18) = *(int *)(puVar12 + 0x18) - 1U & 0xfffffff;
        }
        *(short *)(puVar12 + 0x1c) = (short)uVar18;
        iVar9 = r_emi_get_mem_addr_by_offset(0x1000);
        puVar6 = _lld_scan_sync_env;
        uVar5 = *(undefined2 *)(iVar16 + 0xe + iVar9);
