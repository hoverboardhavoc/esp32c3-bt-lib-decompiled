...

{
  ...
  *param_4 = (byte)uVar20;
  ...
  if (*(ushort *)(iVar11 + iVar6) >> 8 <= uVar20) {
    r_assert_err(0,"lld_scan.c",0x80a);
  }
  bVar13 = *param_4;
  if (bVar13 != 0) {
    bVar13 = bVar13 - 1;
  ...
  *(undefined1 *)(iVar19 + 0x3e) = 0;
  ...
  if (cVar2 != '\x01') {
    if (cVar2 != '\0') {
      if (cVar2 != '\x02') {
        if (cVar2 != '\x03') {
          r_assert_err(0,"lld_scan.c",0x831);
          return;
        }
...
_L305:
        ...
        else if ((*(byte *)(iVar6 + 0x6d) & 8) != 0) goto _L300;
        *(undefined1 *)(iVar6 + 0x6e) = 2;
        param_4[5] = 0;
_L327:
        *(undefined1 *)(iVar6 + 0x3d) = 0;
...
_L224:
  ...
  *(byte *)(iVar6 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar11 + iVar18 + 6) >> 0xe);
  ...
  if (*(char *)(iVar6 + 0x6e) == -1) {
    if ((*(ushort *)(param_4 + 6) & 0x1000) != 0) goto _L528;
  }
  else {
...
_L478:
  if (-1 < (int)((uint)*(ushort *)(param_4 + 6) << 0x12)) goto _L480;
    ...
    *(undefined2 *)(iVar6 + 0x76) = *puVar7;
    ...
    if (iVar11 == 0) {
      ...
      *(uint *)(puVar10 + 0x18) = CONCAT22(uVar14,*(undefined2 *)(iVar11 + iVar18 + 8));
      ...
      if ((((byte)ets_printf & 2) != 0) && (((byte)puVar10[0x1e] - 2 & 0xff) < 2)) {
        uVar21 = (int)(((uVar15 & 0xffff) + (uint)_DAT_000150be * -2) * 0x10000) >> 0x10;
      }
      if (0x751 < (uVar21 + 0x4e1 & 0xffff)) {
        r_assert_err(0,"lld_scan.c",0x6b6);
      }
