...
_L315:
        ...
        else if ((*(byte *)(iVar6 + 0x6d) & 8) != 0) goto _L310;
        *(undefined1 *)(iVar6 + 0x6e) = 2;
        param_4[5] = 0;
_L337:
        *(undefined1 *)(iVar6 + 0x3d) = 0;
...
_L234:
  ...
  *(byte *)(iVar6 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar11 + iVar18 + 6) >> 0xe);
  ...
  if (*(char *)(iVar6 + 0x6e) == -1) {
    if ((*(ushort *)(param_4 + 6) & 0x1000) != 0) goto _L542;
  }
  else {
...
_L492:
  if (-1 < (int)((uint)*(ushort *)(param_4 + 6) << 0x12)) goto _L494;
