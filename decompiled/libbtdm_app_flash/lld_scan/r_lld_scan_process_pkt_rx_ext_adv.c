...

{
  ...
  *param_4 = (byte)uVar20;
  ...
  if (*(ushort *)(iVar11 + iVar6) >> 8 <= uVar20) {
    r_assert_err(0,"lld_scan.c",0x80d);
  }
  bVar13 = *param_4;
  if (bVar13 != 0) {
    bVar13 = bVar13 - 1;
  ...
  *(undefined1 *)(iVar19 + 0x3e) = 0;
  ...
  if (cVar2 != '\x01') {
    if (cVar2 != '\0') {
      if (cVar2 != '\x02') {
        if (cVar2 != '\x03') {
          r_assert_err(0,"lld_scan.c",0x834);
          return;
        }
...
_L224:
  ...
  *(byte *)(iVar6 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar11 + iVar18 + 6) >> 0xe);
  ...
  if (*(char *)(iVar6 + 0x6e) == -1) {
    if ((*(ushort *)(param_4 + 6) & 0x1000) != 0) goto _L529;
  }
  else {
...
_L479:
  if (-1 < (int)((uint)*(ushort *)(param_4 + 6) << 0x12)) goto _L481;
