  ...
  *(undefined1 *)(iVar18 + 0x3e) = 0;
  ...
  if (bVar11 != 2) {
    if (2 < bVar11) {
      ...
      uVar16 = (uint)*(ushort *)(param_3 * 0x14 + 0x12 + iVar17);
      bVar11 = param_4[5];
      uVar14 = (uint)*(ushort *)(iVar9 + 0x36) + (uint)bVar11;
      iVar17 = uVar14 * 0x10000;
      *(char *)(iVar9 + 0x41) = *(char *)(iVar9 + 0x41) + '\x01';
      *(short *)(iVar9 + 0x36) = (short)((uint)iVar17 >> 0x10);
      if (0x672 < (uVar14 & 0xffff)) {
      ...
      uVar14 = (int)((uint)uVar21 << 0x17) >> 0x1f & 6;
      if ((uVar21 & 0x200) != 0) {
        uVar14 = uVar14 + 6;
      }
      iVar17 = uVar14 + ((uVar21 & 0x400) != 0);
      if ((int)((uint)uVar21 << 0x14) < 0) {
        psVar8 = (short *)r_emi_get_mem_addr_by_offset(uVar16 + iVar17 & 0xffff);
...
_L293:
          ...
          pvVar5 = (void *)r_emi_get_mem_addr_by_offset(uVar16 + iVar17 & 0xffff);
          ...
          if ((*(ushort *)(param_3 * 0x14 + 2 + iVar18) >> 9 & 1) == 0) {
            if (*(byte *)(iVar9 + 0x41) < 7) {
              iVar18 = r_lld_calc_aux_rx(iVar9 + 0x48,param_3,unaff_s7);
              uVar10 = 1;
              if (iVar18 != 0) goto _L318;
            }
            *(undefined1 *)(iVar9 + 0x6e) = 2;
          }
          else {
...
_L298:
          ...
          puVar7 = (undefined1 *)r_emi_get_mem_addr_by_offset(uVar16 + iVar17 & 0xffff);
          *(undefined1 *)(iVar9 + 0x73) = *puVar7;
          return;
        }
      }
      else if ((*(byte *)(iVar9 + 0x6d) & 8) != 0) goto _L293;
      *(undefined1 *)(iVar9 + 0x6e) = 2;
      param_4[5] = '\0';
_L319:
      *(undefined1 *)(iVar9 + 0x3d) = 0;
    ...
    if (bVar11 != 0) {
      ...
      *(byte *)(iVar9 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar17 + iVar18 + 6) >> 0xe);
      ...
      if ((*(ushort *)(param_4 + 6) & 0x100) == 0) {
        if ((((*(byte *)(_lld_scan_env + 0x15) & 0xfd) == 1) && (*(char *)(iVar9 + 0x6f) == -1)) &&
        ...
        if ((param_4[1] == '\0') && (*(char *)(iVar9 + 0x6f) != -1)) {
          ...
          *(byte *)(iVar9 + 0x6f) = bVar11;
          ...
          if (((*(char *)(_lld_scan_env + 0x15) == '\x01') ||
             ...
             (iVar17 = r_emi_get_mem_addr_by_offset(0x1000),
             -1 < (int)((uint)*(ushort *)(iVar18 + 2 + iVar17) << 0x14))) {
            *(undefined1 *)(iVar9 + 0x6e) = 0xff;
          }
        }
        sVar15 = 6;
      ...
      sVar15 = sVar15 + (ushort)((*(ushort *)(param_4 + 6) & 0x400) != 0);
      ...
      if (*(char *)(iVar9 + 0x6e) == -1) {
        if ((*(ushort *)(param_4 + 6) & 0x1000) != 0) goto _L510;
      }
      else {
...
_L464:
      if (-1 < (int)((uint)*(ushort *)(param_4 + 6) << 0x12)) goto _L468;
        ...
        *(undefined2 *)(iVar9 + 0x76) = *puVar6;
        ...
        if (iVar17 == 0) {
          ...
          *(uint *)(puVar7 + 0x18) = CONCAT22(uVar13,*(undefined2 *)(iVar18 + 8 + iVar17));
          iVar17 = r_emi_get_mem_addr_by_offset(0x1000);
          uVar16 = ((uint)*(ushort *)(&lld_exp_sync_pos_tab + (uint)(byte)puVar7[0x1e] * 2) * -2 +
                   0x270) - (*(ushort *)(iVar18 + 0xc + iVar17) & 0x3ff);
          uVar14 = uVar16 & 0xffff;
          uVar16 = (int)(uVar16 * 0x10000) >> 0x10;
          if (((g_bt_plf_log_level & 2) != 0) && (((byte)puVar7[0x1e] - 2 & 0xff) < 2)) {
            uVar16 = uVar14 + (uint)_DAT_000150c6 * -2;
            uVar14 = uVar16 & 0xffff;
            uVar16 = (int)(uVar16 * 0x10000) >> 0x10;
          }
    ...
    *(undefined1 *)(iVar9 + 0x6a) = 0;
    if (*param_4 == '\0') {
      *(undefined1 *)(iVar9 + 0x6e) = 0;
      ...
      if ((uVar13 & 0x100) != 0) {
        if (((uVar21 & 3) == 0) &&
           ((*(char *)(iVar9 + 0x3b) == '\0' || (-1 < (int)((uint)uVar13 << 0x13))))) {
          iVar17 = r_emi_get_mem_addr_by_offset(0x1000);
      ...
      if ((uVar21 & 0x200) != 0) {
        if ((param_4[1] == '\0') &&
           ((*(char *)(iVar9 + 0x3b) == '\0' || (-1 < (int)((uint)uVar21 << 0x13))))) {
          *(byte *)(iVar9 + 0x6d) = *(byte *)(iVar9 + 0x6d) | 4;
          iVar17 = r_emi_get_mem_addr_by_offset(0x1000);
          *(byte *)(iVar9 + 0x70) = (byte)(*(ushort *)(iVar18 + 4 + iVar17) >> 7) & 1;
          param_4[2] = (char)sVar15;
...
_L208:
      ...
      uVar14 = (uint)*(ushort *)(param_4 + 6);
      if ((int)(uVar14 << 0x12) < 0) {
        sVar15 = sVar15 + 0x12;
      }
      if ((int)(uVar14 << 0x11) < 0) {
        if ((*(char *)(iVar9 + 0x3b) != '\0') &&
           ((param_4[1] != '\0' || ((int)(uVar14 << 0x13) < 0)))) goto _L214;
...
_L214:
  ...
  *(byte *)(iVar9 + 0x6d) = *(byte *)(iVar9 + 0x6d) | 8;
  ...
  sVar15 = sVar15 + (ushort)((uVar21 & 0x400) != 0);
  if ((int)((uint)uVar21 << 0x14) < 0) {
    sVar15 = sVar15 + 2;
  }
  if (-1 < (int)((uint)uVar21 << 0x13)) {
    *(undefined1 *)(iVar9 + 0x6e) = 0;
    *(undefined1 *)(iVar9 + 0x3d) = 0;
    goto _L260;
  }
