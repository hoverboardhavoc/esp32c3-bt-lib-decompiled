...

{
  ...
  *param_4 = (char)uVar22;
  ...
  if (*(ushort *)(iVar10 + iVar18) >> 8 <= uVar22) {
    r_assert_err(0,"lld_scan.c",0x86a);
  }
  cVar13 = *param_4;
  if (cVar13 != '\0') {
    cVar13 = cVar13 + -1;
  ...
  *(undefined1 *)(iVar19 + 0x3e) = 0;
  ...
  if (bVar12 != 2) {
    if (2 < bVar12) {
      if (bVar12 != 3) {
        r_assert_err(0,"lld_scan.c",0x891);
        return;
      }
      ...
      *(short *)(iVar10 + 0x36) = (short)((uint)iVar18 >> 0x10);
      ...
      if ((uVar22 >> 0xb & 1) == 0) {
        if ((*(byte *)(iVar10 + 0x6d) & 8) != 0) goto _L298;
      }
      else {
    ...
    if (bVar12 != 0) {
      ...
      *(byte *)(iVar10 + 0x72) = (byte)((ushort)*(undefined2 *)(iVar18 + iVar19 + 6) >> 0xe);
      ...
      if (*(char *)(iVar10 + 0x6e) == -1) {
        if ((*(ushort *)(param_4 + 6) & 0x1000) == 0) goto _L476;
      }
      else {
        if ((*(ushort *)(param_4 + 6) & 0x1000) == 0) {
          ...
          if (iVar18 == 0) {
            ...
            *(undefined2 *)(pbVar9 + 0x20) = uVar3;
            ...
            r_ble_log_internal_x2
                      (0x40a10146,*(undefined4 *)(pbVar9 + 0x18),
