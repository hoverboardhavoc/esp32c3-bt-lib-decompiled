...

{
  ...
  if (iVar1 != 0) {
    r_ble_log_internal_x1
              (0x40e3008d,(uint)*(ushort *)(iVar1 + 0x7c) | param_1 << 0x10 | param_2 << 0x18);
      ...
      if (*(uint *)(iVar1 + 100) < (*(int *)(iVar1 + 0x48) - iVar2 & 0xfffffffU)) {
        ...
        while( true ) {
          ...
          if (*(short *)(iVar1 + 0x7e) == 0) {
            r_assert_err(0,"lld_con.c",0xf18);
          }
        ...
        r_ble_log_internal_x3
                  (0x4043008e,*(undefined4 *)(iVar1 + 0x48),*(undefined4 *)(iVar1 + 0x7c),param_1);
        uVar3 = 0;
        goto _L752;
      }
    }
