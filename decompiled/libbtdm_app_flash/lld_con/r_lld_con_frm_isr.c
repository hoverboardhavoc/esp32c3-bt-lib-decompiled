...

{
  ...
  if (iVar5 == 0) {
    r_assert_err(0,"lld_con.c",0xd52);
    return;
  }
    ...
    *(char *)(iVar5 + 0x16) = cVar13;
    ...
    while (uVar19 = (undefined2)iVar8, (uVar18 - uVar15 & 0xfffffff) <= uVar16) {
      ...
      if ((*(ushort *)(iVar5 + 0x84) & 1) != 0) {
        ...
        uVar11 = uVar10 * 2;
        if (uVar12 != 0) {
          *(undefined2 *)(&DAT_0001564c + iVar7) = 0;
        }
        if ((*(ushort *)(iVar5 + 0x84) & 2) == 0) {
...
_L240:
          ...
          if ((*(ushort *)(iVar5 + 0x7c) < 7) &&
            ...
            uVar11 = uVar11 + ((int)((uint)*(ushort *)(&DAT_0001564c + iVar7) *
            ...
            *(ushort *)(&DAT_0001564c + iVar7) = *(ushort *)(&DAT_0001564c + iVar7) + 1;
            goto _L240;
          }
        }
