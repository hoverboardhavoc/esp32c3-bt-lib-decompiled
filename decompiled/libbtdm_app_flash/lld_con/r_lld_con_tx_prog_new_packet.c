...
_L407:
      ...
      *(ushort *)(iVar17 + 0x82) = uVar4 - (short)uVar12;
      ...
      if (((param_2 == 2) && (piStack_5c != (int *)0x0)) &&
         ((bVar16 != 1 && (DAT_0001508e != '\0')))) goto _L407;
    ...
    if (uVar14 == 3) {
      if (param_2 == 2) {
        ...
        *(byte *)((int)&lld_con_cntl_pkt_info + param_1 * 4 + 1) = bVar18;
        ...
        if (param_2 == 0) {
          (&DAT_000149bd)[iVar15] = 1;
          iVar7 = 10;
        }
        else if (param_2 == 1) {
          (&DAT_000149bd)[iVar15] = 2;
          iVar7 = 6;
        }
        else if (param_2 == 0x18) {
          (&DAT_000149bd)[iVar15] = 3;
          iVar7 = 3;
        }
        else {
          r_assert_param(param_1,param_2,"lld_con.c",0x4ec);
          iVar7 = 0;
        }
        (&DAT_000149bc)[iVar15] = bVar18;
        ...
        if (((uint)uVar3 == (uint)uVar4) &&
          ...
          *(undefined2 *)(&DAT_000149bc + iVar15) = 0;
        }
      }
    }
    iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
