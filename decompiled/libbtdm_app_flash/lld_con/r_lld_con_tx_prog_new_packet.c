...

{
  ...
  piStack_5c = (int *)0x0;
  if ((((*(ushort *)(iVar17 + 0x84) & 0x10) != 0) && (piStack_5c = piVar5, piVar5 != (int *)0x0)) &&
...
_L406:
      if ((*(short *)(iVar17 + 0x82) == 0) && (piVar11 = (int *)*piVar5, piVar11 != (int *)0x0)) {
      ...
      uVar19 = (uint)uVar4;
      uVar6 = (*(ushort *)(piVar5 + 1) - uVar19) + (uVar3 & 0x3ff) & 0xffff;
      uVar14 = 2;
      if (((int)(uint)uVar3 >> 0xc & 3U) == 1) {
        uVar14 = 1;
      }
      uVar12 = (uint)*(byte *)(iVar17 + 0x8c);
      if (uVar19 < *(byte *)(iVar17 + 0x8c)) {
        uVar12 = uVar19;
      }
      *(ushort *)((int)piVar5 + 6) = uVar3 & 0xcfff | 0x1000;
      *(ushort *)(iVar17 + 0x82) = uVar4 - (short)uVar12;
    }
    else {
      if (((param_2 == 2) && (piStack_5c != (int *)0x0)) &&
         ((bVar16 != 1 && (DAT_0001508e != '\0')))) goto _L406;
    ...
    bVar18 = cVar20 + cVar1;
    piStack_5c = (int *)0x0;
    if ((((uVar3 & 0x10) != 0) && (piStack_5c = piVar5, piVar5 != (int *)0x0)) &&
       (piStack_5c = (int *)0x1, *(short *)(iVar17 + 0x82) == 0)) {
      piStack_5c = (int *)(uint)(*piVar5 != 0);
    }
    if ((uVar3 & 0x40) != 0) {
    ...
    *(short *)(iVar7 + iVar13 + 4) = (short)uVar6;
    ...
    if (uVar14 == 3) {
      if (param_2 == 2) {
        ...
        *(byte *)((int)&lld_con_cntl_pkt_info + param_1 * 4 + 1) = bVar18;
        ...
        if (param_2 == 0) {
          (&DAT_000149b1)[iVar15] = 1;
          iVar7 = 10;
        }
        else if (param_2 == 1) {
          (&DAT_000149b1)[iVar15] = 2;
          iVar7 = 6;
        }
        else if (param_2 == 0x18) {
          (&DAT_000149b1)[iVar15] = 3;
          iVar7 = 3;
        }
        else {
          r_assert_param(param_1,param_2,"lld_con.c",0x4ea);
          iVar7 = 0;
        }
        (&DAT_000149b0)[iVar15] = bVar18;
        uVar19 = uVar6 + iVar7 & 0xffff;
        puVar8 = (ushort *)r_emi_get_mem_addr_by_offset(uVar19);
        uVar4 = *puVar8;
        uVar3 = *(ushort *)(iVar17 + 0x44);
        if (((uint)uVar3 == (uint)uVar4) &&
           (pbVar9 = (byte *)r_emi_get_mem_addr_by_offset(uVar6), *pbVar9 == param_2)) {
          uVar6 = (uint)*(ushort *)(iVar17 + 0x7c) + (uint)*(ushort *)(iVar17 + 0x7e) + 9 +
                  (uint)*(ushort *)(iVar17 + 0x72);
          iVar7 = uVar6 * 0x10000;
          uVar6 = uVar6 & 0xffff;
          if (((uVar6 + 1) - (uint)uVar3 & 0xffff) < 0x7fff) {
            puVar10 = (undefined1 *)r_emi_get_mem_addr_by_offset(uVar19);
            *puVar10 = (char)((uint)iVar7 >> 0x10);
            puVar10[1] = (char)(uVar6 >> 8);
            *(short *)(iVar17 + 0x44) = (short)((uint)iVar7 >> 0x10);
          }
        }
        else {
          if (0 < _g_bt_plf_log_level) {
            uVar3 = *(ushort *)(iVar17 + 0x7e);
            uVar14 = *(ushort *)(iVar17 + 0x7c);
          ...
          *(undefined2 *)(&DAT_000149b0 + iVar15) = 0;
        }
      }
    }
    iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
