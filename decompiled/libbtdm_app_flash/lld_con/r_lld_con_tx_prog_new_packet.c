...
_L445:
      ...
      *(ushort *)(iVar19 + 0x82) = uVar4 - (short)uVar12;
      ...
      if (((param_2 == 2) && (piStack_64 != (int *)0x0)) &&
         ((bVar18 != 1 && (DAT_0001608e != '\0')))) goto _L445;
    ...
    if (uVar14 == 3) {
      if (param_2 == 2) {
        ...
        *(byte *)((int)&lld_con_cntl_pkt_info + param_1 * 4 + 1) = bVar16;
        ...
        if (param_2 == 0) {
          (&DAT_0001505d)[iVar15] = 1;
          iVar7 = 10;
        }
        else if (param_2 == 1) {
          (&DAT_0001505d)[iVar15] = 2;
          iVar7 = 6;
        }
        else if (param_2 == 0x18) {
          (&DAT_0001505d)[iVar15] = 3;
          iVar7 = 3;
        }
        else {
        ...
        if (((uint)uVar3 == (uint)uVar4) &&
          ...
          *(undefined2 *)(&DAT_0001505c + iVar15) = 0;
        }
      }
    }
    iVar7 = r_emi_get_mem_addr_by_offset(0x1400);
