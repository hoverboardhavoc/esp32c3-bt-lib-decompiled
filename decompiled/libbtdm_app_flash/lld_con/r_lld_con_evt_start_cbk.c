...
_L474:
    ...
    if (*(char *)(param_1 + 0x46) == '\x02') {
      if ((*(byte *)(param_1 + 0x38) & 0xe0) != 0) {
        r_assert_err(0,"lld_con.c",0xaf3);
      }
  ...
  r_ble_log_internal_x1
            (0x40a300e7,CONCAT11(*(undefined1 *)(iVar10 + 0x46),*(byte *)(param_1 + 0x8e)));
  ...
  if (cVar6 == '\x02') {
    ...
    if (cVar6 != '\x03') {
      if (cVar6 == '\x01') {
        ...
        r_assert_warn(0,0,"lld_con.c",0x857);
      }
      goto _L260;
    }
