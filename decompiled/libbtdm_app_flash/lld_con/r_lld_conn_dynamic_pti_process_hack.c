 ...
 * Source: libbtdm_app_flash -> lld_con.o -> r_lld_conn_dynamic_pti_process_hack
 *
...
void r_lld_conn_dynamic_pti_process_hack(uint param_1)

{
  ...
  if ((iVar3 != 0) && (iVar4 = r_bt_rf_coex_conn_dynamic_pti_en_get(), iVar4 != 0)) {
    if (*(char *)(iVar3 + 0x46) == '\0') {
      ...
      if ((uint)*(byte *)(iVar4 + 4) < (uint)*(ushort *)(iVar3 + 0x7c)) {
    ...
    if ((byte)(*(char *)(iVar3 + 0x93) - 2U) < 2) {
      ...
      puVar2 = (uint *)((param_1 + 0x1800c4cb) * 4);
      uVar5 = *puVar2 & 0xffffff0f | uVar5;
    }
    *puVar2 = uVar5;
    bVar1 = *(byte *)(*(int *)(_bt_rf_coex_cfg_p + 0x30) + 3);
    if (0xb < param_1) {
