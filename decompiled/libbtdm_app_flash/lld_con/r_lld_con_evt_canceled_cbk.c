...

{
  ...
  *(char *)(param_1 + 0x16) = *(char *)(param_1 + 0x16) + cVar5;
  iVar6 = *(int *)(&lld_con_env + uVar10 * 4);
  ...
  for (; (iVar9 - uVar7 & 0xfffffff) < 0x7ffffff; uVar7 = uVar7 + *(int *)(iVar6 + 100) & 0xfffffff)
  {
    *(short *)(iVar6 + 0x7e) = *(short *)(iVar6 + 0x7e) + 1;
  }
  uVar21 = *(uint *)(iVar6 + 0x58);
  if (((*(char *)(iVar6 + 0x46) == '\x01') && (*(char *)(iVar6 + 0x43) == '\0')) &&
    ...
    while (sVar15 = sVar15 + -1, sVar15 != -1) {
      uVar21 = uVar21 - *(int *)(iVar6 + 100) & 0xfffffff;
    }
  }
  if ((*(ushort *)(iVar6 + 0x84) & 2) == 0) {
    uVar20 = *(int *)(iVar6 + 100) * 6;
  }
  else {
    uVar20 = *(uint *)(iVar6 + 0x68);
  }
  iVar9 = (uVar10 + 0x10) * 2;
  iVar19 = 0;
  while ((uVar7 - uVar21 & 0xfffffff) <= uVar20) {
    uVar17 = uVar7;
    if ((*(ushort *)(iVar6 + 0x84) & 1) != 0) {
      iVar16 = *(int *)(iVar6 + 0x50);
      sVar15 = *(short *)(iVar6 + 0x6e);
      iVar19 = r_rwip_active_check();
      uVar18 = 0x14;
      if (iVar19 == 0) {
        uVar18 = (uint)*(ushort *)(_p_lld_env + 0xd4);
      }
      uVar17 = ((*(ushort *)(iVar6 + 0x7a) + uVar18) * (uVar7 - iVar16 & 0xfffffff)) / 0x640 + 0x40;
      uVar18 = uVar17 * 2;
      if ((*(ushort *)(iVar6 + 0x84) & 2) == 0) {
...
_L235:
      ...
      iVar19 = ((int)sVar15 - (uVar18 >> 1)) + uVar14 * 0x271;
      if (iVar19 < 0) {
  ...
  iVar9 = *(int *)(&lld_con_env + uVar10 * 4);
  if (iVar9 == 0) {
    return;
  }
  uVar18 = uVar10 << 8 | 1;
  ...
  *puVar8 = uVar11;
  r_ke_msg_send();
  iVar6 = r_co_list_pop_front(iVar9 + 0x28);
  do {
    if (*(char *)(iVar9 + 0x92) == '\0') {
      ...
      r_sch_slice_per_remove(4,uVar10);
      r_ke_free(*(undefined4 *)(&lld_con_env + uVar10 * 4));
      *(undefined4 *)(&lld_con_env + uVar10 * 4) = 0;
      (&g_event_empty)[uVar10] = 0;
      r_bt_rtp_deregister_rule_cs_idx(uVar10);
      r_bt_rma_deregister_rule_cs_idx(uVar10);
      return;
    }
