...

{
  ...
  uVar13 = (uint)DAT_0001606a << 1;
  if ((uVar3 & 2) == 0) {
    *(undefined1 *)(iVar5 + 0x16) = 0x1f;
  }
  if ((uVar3 & 3) == 3) {
    *(undefined1 *)(iVar5 + 0x96) = 0;
    if ((((param_3 != 0) && (uVar11 = (uint)*(ushort *)(iVar5 + 0x72), uVar11 != 0)) &&
  ...
  if ((*(ushort *)(iVar5 + 0x84) & 2) == 0) {
    uVar15 = *(int *)(iVar5 + 100) * 6;
  }
  else {
    uVar15 = *(uint *)(iVar5 + 0x68);
  }
  iVar12 = (param_1 + 0x10) * 2;
  iVar17 = 0;
  while (uVar16 = (undefined2)iVar17, (uVar6 - uVar11 & 0xfffffff) <= uVar15) {
    uVar9 = uVar6;
    if ((*(ushort *)(iVar5 + 0x84) & 1) != 0) {
      ...
      uVar13 = uVar9 * 2;
      if (param_3 != 0) {
        *(undefined2 *)(&DAT_000150b0 + iVar12) = 0;
      }
      if ((*(ushort *)(iVar5 + 0x84) & 2) == 0) {
...
_L235:
        ...
        {
          uVar13 = uVar13 + ((int)((uint)*(ushort *)(&DAT_000150b0 + iVar12) *
          ...
          *(ushort *)(&DAT_000150b0 + iVar12) = *(ushort *)(&DAT_000150b0 + iVar12) + 1;
          goto _L235;
        }
      }
      ...
      iVar17 = uVar18 * 0x271 + ((int)sVar10 - (uVar13 >> 1));
      if (iVar17 < 0) {
  ...
  if (iVar12 != 0) {
    ...
    *(uint *)(iVar5 + 0x48) = uVar6;
    if ((*(ushort *)(iVar5 + 0x84) & 1) != 0) {
      ...
      *(uint *)(iVar5 + 0x4c) = uVar6 * 2 + uVar13;
    }
    return;
  }
  iVar12 = 8;
