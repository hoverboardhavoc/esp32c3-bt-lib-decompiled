  ...
  if (*(char *)(iVar6 + 0x8f) == '\x02') {
    ...
    *(char *)(iVar6 + 0x16) = *(char *)(iVar6 + 0x16) + cVar5;
    ...
    for (; (iVar10 - uVar7 & 0xfffffff) < 0x7ffffff;
        uVar7 = uVar7 + *(int *)(iVar8 + 100) & 0xfffffff) {
    ...
    if (((*(char *)(iVar8 + 0x46) == '\x01') && (*(char *)(iVar8 + 0x43) == '\0')) &&
      ...
      if (*(char *)(iVar8 + 0x42) == '\0') {
        uVar7 = uVar7 + *(ushort *)(iVar8 + 0x3c) & 0xfffffff;
        if ((uVar3 & 1) != 0) {
          uVar7 = uVar7 + (*(ushort *)(iVar8 + 0x40) >> 1) & 0xfffffff;
        }
    ...
    iVar10 = 0;
    while (uVar16 = (undefined2)iVar10, (uVar7 - uVar18 & 0xfffffff) <= uVar19) {
      uVar20 = uVar7;
      if ((*(ushort *)(iVar8 + 0x84) & 1) != 0) {
        iVar15 = *(int *)(iVar8 + 0x50);
        ...
        uVar20 = ((*(ushort *)(iVar8 + 0x7a) + uVar17) * (uVar7 - iVar15 & 0xfffffff)) / 0x640 +
                 0x40;
        uVar17 = uVar20 * 2;
        if ((*(ushort *)(iVar8 + 0x84) & 2) == 0) {
...
_L249:
          ...
          if (*(ushort *)(iVar8 + 0x7c) < 7) {
            uVar12 = ((int)((uint)*(ushort *)(&DAT_00015058 + iVar6) *
                            (uint)*(ushort *)(iVar8 + 0x70) * 0x271) >> 1) +
                     (uint)*(ushort *)(iVar8 + 0x70) * 0x271 + uVar17;
            uVar17 = *(int *)(iVar8 + 100) * 0x271;
            if (uVar12 < uVar17) {
              uVar17 = uVar12;
            }
            *(ushort *)(&DAT_00015058 + iVar6) = *(ushort *)(&DAT_00015058 + iVar6) + 1;
            goto _L249;
          }
        }
        if (((*(char *)(iVar8 + 0x46) == '\x01') && (*(char *)(iVar8 + 0x42) != '\0')) &&
        ...
        else if ((((!bVar4) && (((uint)(*(int *)(iVar8 + 100) * 0x271) >> 1) - 300 <= uVar20)) &&
          ...
          r_ble_log_internal_x3
                     ...
                     *(undefined4 *)(iVar8 + 100),uVar20);
        }
        uVar12 = (uVar17 >> 1) / 0x271;
        uVar20 = uVar7 - uVar12 & 0xfffffff;
        iVar10 = ((int)sVar14 - (uVar17 >> 1)) + uVar12 * 0x271;
        if (iVar10 < 0) {
          uVar20 = uVar20 - 1 & 0xfffffff;
          iVar10 = iVar10 + 0x271;
        }
        *(int *)(iVar8 + 8) = iVar10;
        *(uint *)(iVar8 + 0x10) = *(int *)(iVar8 + 0x5c) + uVar17;
      }
      uVar16 = (undefined2)iVar10;
      *(uint *)(iVar8 + 4) = uVar20;
      iVar15 = r_sch_arb_insert(iVar8);
      if (iVar15 == 0) {
        iVar6 = 1;
        goto _L192;
      }
    ...
    if (iVar6 != 0) {
      ...
      *(uint *)(iVar8 + 0x48) = uVar7;
      if ((*(ushort *)(iVar8 + 0x84) & 1) != 0) {
        ...
        *(undefined2 *)(iVar8 + 0x6c) = uVar16;
        *(uint *)(iVar8 + 0x4c) = uVar17 + uVar7 * 2;
      }
      return;
    }
    iVar6 = 8;
...
_L167:
      ...
      iVar8 = r_emi_get_mem_addr_by_offset(0x1400);
      r_ble_util_buf_llcp_tx_free(*(undefined2 *)(iVar15 + 4 + iVar8));
      uVar11 = 0x79f;
      if (*(int *)(iVar10 + 0x24) == 0) goto _L147;
      goto _L167;
    }
_L147:
