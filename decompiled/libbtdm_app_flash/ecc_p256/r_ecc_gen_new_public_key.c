...
/* WARNING: Removing unreachable block (ram,0x00011f26) */
...

{
  ...
  puVar12 = (undefined1 *)(param_1 + 0x1f);
  asStack_164[0] = 0;
  asStack_10c[0] = 0;
  asStack_e0[0] = 0;
  ...
  do {
    ...
    puVar8 = puVar8 + -2;
    psVar5 = psVar5 + 1;
  } while ((undefined1 *)(param_1 + -1) != puVar12);
  iVar9 = 0;
  psVar5 = asStack_164;
  do {
    if (*psVar5 != 0) break;
  ...
  uStack_e4 = 0;
  uStack_b8 = 0;
  iVar10 = r_ecc_is_valid_point(asStack_10c,asStack_e0);
  uVar11 = 0x12;
  if (iVar10 != 0) {
    ...
    *(undefined4 *)(iVar6 + 0x10c) = 0;
    memcpy((void *)(iVar6 + 0x110),asStack_164,0x22);
