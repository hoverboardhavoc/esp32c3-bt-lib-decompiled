...

{
  ...
  if ((byte)(cVar1 - 1U) < 2) {
    ...
    if (iVar6 != 0) {
      ...
      r_GF_Jacobian_Point_Addition256(auStack_128,pvVar2,auStack_a4);
    ...
    r_GF_Jacobian_Point_Double256(pvVar2,auStack_a4);
    memcpy(pvVar2,auStack_a4,0x22);
    *(undefined4 *)(param_1 + 0x2c) = uStack_80;
    *(undefined4 *)(param_1 + 0x30) = uStack_7c;
    memcpy((void *)(param_1 + 0x34),auStack_78,0x22);
    ...
    *(undefined4 *)(param_1 + 0x88) = uStack_24;
    ...
    if (cVar1 == '\x03') {
      ...
      r_GF_Jacobian_Point_Double256(pvVar2,auStack_128);
