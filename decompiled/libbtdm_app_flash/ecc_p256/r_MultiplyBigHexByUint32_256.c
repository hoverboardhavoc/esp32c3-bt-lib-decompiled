...

{
  ...
  uVar2 = 0;
  do {
    uVar2 = uVar2 + (uint)*(ushort *)(param_1 + iVar3) * param_2;
    *(short *)(param_3 + iVar3) = (short)uVar2;
    iVar3 = iVar3 + -2;
    uVar2 = uVar2 >> 0x10;
  } while (iVar3 != -2);
  iVar3 = 0;
  ...
  *(undefined4 *)(param_3 + 0x28) = *(undefined4 *)(param_1 + 0x28);
  ...
  else if (*(int *)(param_3 + 0x28) != 1) {
    return;
  }
  if (_r_co_list_push_back < *(uint *)(param_3 + 0x24)) {
    r_MultiplyByU16ModP256
              (*(undefined2 *)((0x11 - *(uint *)(param_3 + 0x24)) * 2 + param_3),auStack_3c);
    if (*(int *)(param_3 + 0x28) == 0) {
      r_SubtractFromSelfBigHexSign256(param_3,auStack_3c);
    }
    else {
  ...
  if (*(int *)(param_3 + 0x28) == 0) {
    ...
    r_SubtractFromSelfBigHex256(param_3,&bigHexP256);
  }
  else if (*(int *)(param_3 + 0x28) == 1) {
    r_AddP256(param_3);
  }
