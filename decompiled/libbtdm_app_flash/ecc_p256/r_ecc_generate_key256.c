...

{
  ...
  psVar8 = local_10c;
  psVar4 = local_164;
  puVar11 = (undefined1 *)(param_2 + 0x1f);
  local_164[0] = 0;
  local_10c[0] = 0;
  asStack_e0[0] = 0;
  puVar6 = (undefined1 *)(param_3 + 0x1f);
  puVar7 = (undefined1 *)(param_4 + 0x1f);
  psVar3 = psVar4;
  psVar12 = psVar8;
  do {
    uVar2 = *puVar11;
    ...
    puVar7 = puVar7 + -2;
    psVar12 = psVar12 + 1;
  } while ((undefined1 *)(param_2 + -1) != puVar11);
  iVar14 = 0;
  do {
    if (*psVar4 != 0) break;
    iVar14 = iVar14 + 1;
  ...
  uStack_b8 = 0;
  iStack_bc = iVar9;
  iVar5 = r_ecc_is_valid_point(local_10c,asStack_e0);
  uVar10 = 0x12;
  if (iVar5 != 0) {
    iVar5 = r_ke_malloc(0x14c,3);
    *(undefined2 *)(iVar5 + 0x13e) = param_6;
    *(undefined4 *)(iVar5 + 0x148) = 0;
    *(char *)(iVar5 + 0x144) = (char)param_1;
    *(undefined2 *)(iVar5 + 0x13c) = param_5;
    ...
    *(undefined4 *)(iVar5 + 0x10c) = 0;
    memcpy((void *)(iVar5 + 0x110),local_164,0x22);
    ...
    *(undefined4 *)(iVar5 + 4) = 0x11;
    if (param_1 == 2) {
      ...
      *(void **)(iVar5 + 0x148) = __dest;
      memcpy(__dest,(void *)(iVar5 + 0x8c),0x22);
      *(undefined4 *)((int)__dest + 0x24) = *(undefined4 *)(iVar5 + 0xb0);
      *(undefined4 *)((int)__dest + 0x28) = *(undefined4 *)(iVar5 + 0xb4);
      memcpy((void *)((int)__dest + 0x2c),(void *)(iVar5 + 0xb8),0x22);
      *(undefined4 *)((int)__dest + 0x50) = *(undefined4 *)(iVar5 + 0xdc);
      *(undefined4 *)((int)__dest + 0x54) = *(undefined4 *)(iVar5 + 0xe0);
      memcpy((void *)((int)__dest + 0x58),(void *)(iVar5 + 0xe4),0x22);
      *(undefined4 *)((int)__dest + 0x7c) = *(undefined4 *)(iVar5 + 0x108);
      *(undefined4 *)((int)__dest + 0x80) = *(undefined4 *)(iVar5 + 0x10c);
      *(undefined1 *)(iVar5 + 0x144) = 3;
      *(undefined2 *)(iVar5 + 0x142) = 0;
    }
