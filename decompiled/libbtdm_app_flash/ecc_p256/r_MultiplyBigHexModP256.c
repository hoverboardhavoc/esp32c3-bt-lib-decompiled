 ...
 * Source: libbtdm_app_flash -> ecc_p256.o -> r_MultiplyBigHexModP256
 *
...

{
  ...
  uStack_70 = uStack_24;
  if (uStack_28 <= _r_co_list_extract_after) {
    if (uStack_28 < _r_co_list_extract_after) goto _L145;
    for (iVar8 = 0x22 - uStack_28; iVar8 < 0x22; iVar8 = iVar8 + 1) {
      if (*(ushort *)(&veryBigHexP256 + iVar8 * 2) != local_6c[iVar8]) {
        if (local_6c[iVar8] <= *(ushort *)(&veryBigHexP256 + iVar8 * 2)) goto _L145;
        break;
      }
    }
  }
