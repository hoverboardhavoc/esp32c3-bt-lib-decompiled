 ...
 * Source: libbtdm_app_flash -> ecc_p256.o -> r_ecc_is_valid_point
 *
...

{
  ...
  uStack_18 = 0;
  uStack_14 = 0;
  r_MultiplyBigHexModP256(param_2,param_2,auStack_144);
  r_MultiplyBigHexModP256(param_1,param_1,auStack_118);
  r_MultiplyBigHexModP256(param_1,auStack_118,auStack_ec);
  r_AddBigHexModP256(param_1,param_1,auStack_c0);
  r_AddBigHexModP256(auStack_c0,param_1,auStack_94);
  r_SubtractBigHexMod256(auStack_ec,auStack_94,auStack_68);
  r_AddBigHexModP256(auStack_68,&coef_B,auStack_3c);
