...

{
  ...
  if (param_1 == 0) {
    r_assert_err(0x10000,0x519);
    return;
  }
  r_ble_log_internal_x2
            (0x404500d9,
             (uint)*(ushort *)(param_1 + 0x4a) |
             (uint)*(byte *)(param_1 + 0x55) << 0x10 | (uint)*(byte *)(param_1 + 0x5b) << 0x18,
             *(undefined1 *)(param_1 + 99));
  if (*(char *)(param_1 + 0x5b) != '\0') {
    r_assert_param(0,0x10000,0x504);
  }
  ...
  if (*(char *)(param_1 + 0x5b) == '\x02') {
    ...
    if (*piVar5 != 0) {
      r_ble_log_internal_x1(0x400500cb,(uint)CONCAT12(bVar2,*(undefined2 *)(*piVar5 + 0x4a)));
      ...
      *(uint *)(iVar6 + 0x44) = iVar11 * *(int *)(iVar6 + 0x40) + *(int *)(iVar6 + 0x44) & 0xfffffff
      ...
      if (uVar9 < (*(int *)(iVar6 + 0x44) - *(int *)(iVar6 + 0x3c) & 0xfffffffU)) {
        r_ble_log_internal_x4
                  (0x600500d4,*(undefined4 *)(iVar6 + 0x40),
...
_L224:
      ...
      if (*(char *)(iVar6 + 0x57) == '\0') {
        ...
        if (((uint)(*(int *)(iVar6 + 0x40) * 0x271) >> 1) - 0x96 < uVar9 >> 1) {
          r_ble_log_internal_x3(0x400500d5,(uint)CONCAT12(bVar2,*(undefined2 *)(iVar6 + 0x4a)));
          goto _L224;
        }
      }
