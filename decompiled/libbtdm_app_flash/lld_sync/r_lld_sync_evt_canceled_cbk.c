  ...
  do {
    ...
    *(char *)(iVar5 + 0x16) = cVar12;
    if (*(char *)(iVar5 + 99) == '\x01') {
      ...
      iVar9 = (int)*(short *)(iVar5 + 0x28);
      uVar8 = *(uint *)(iVar5 + 0x24);
    }
    else {
      iVar9 = 1;
      if ((((*(char *)(iVar5 + 100) != '\0') && (*(char *)(iVar5 + 0x62) == '\0')) &&
          (*(ushort *)(iVar5 + 0x4c) != 0)) && (iVar9 = -1, cVar3 == '\0')) {
        iVar10 = *(ushort *)(iVar5 + 0x4c) + 1;
        iVar9 = iVar10 * 0x10000 >> 0x10;
        *(short *)(iVar5 + 0x4e) = (short)iVar10 + *(short *)(iVar5 + 0x4a);
      }
      *(short *)(iVar5 + 0x4a) = *(short *)(iVar5 + 0x4a) + (short)iVar9;
      *(uint *)(iVar5 + 0x44) = iVar9 * *(int *)(iVar5 + 0x40) + *(int *)(iVar5 + 0x44) & 0xfffffff;
      iVar9 = r_lld_read_clock();
      if ((((uint)rwip_prog_delay * 2 - *(int *)(iVar5 + 0x44)) + iVar9 & 0xfffffff) < 0x8000001) {
        iVar9 = r_lld_read_clock();
        uVar7 = iVar9 + ((uint)rwip_prog_delay * 2 - *(int *)(iVar5 + 0x44)) & 0xfffffff;
        if (uVar7 != 0) {
          uVar2 = *(ushort *)(iVar5 + 0x4a);
          uVar8 = *(uint *)(iVar5 + 0x40);
          if (((uint)uVar2 - (uint)*(ushort *)(iVar5 + 0x4e) & 0xffff) < 0x7fff) {
            iVar9 = ((uVar8 - 1) + uVar7) / uVar8 << 0x10;
          }
          else {
            iVar9 = ((*(ushort *)(iVar5 + 0x4e) + 1) - (uint)uVar2) * 0x10000;
            *(undefined1 *)(iVar5 + 100) = 0;
          }
          *(ushort *)(iVar5 + 0x4a) = uVar2 + (short)((uint)iVar9 >> 0x10);
          *(uint *)(iVar5 + 0x44) = (iVar9 >> 0x10) * uVar8 + *(int *)(iVar5 + 0x44) & 0xfffffff;
        }
      }
      else {
        r_lld_read_clock();
...
_L225:
      ...
      if (*(char *)(iVar5 + 0x57) == '\0') {
        ...
        uVar7 = uVar7 + iVar10;
        if (((uint)(*(int *)(iVar5 + 0x40) * 0x271) >> 1) - 0x96 < uVar7 >> 1) {
          iVar9 = r_sdk_config_get_opts_ext();
          if (((*(uint *)(iVar9 + 0x28) & 0x80) != 0) &&
             (iVar9 = r_sdk_config_get_opts_ext(), *(byte *)(iVar9 + 0x2c) < 3)) {
