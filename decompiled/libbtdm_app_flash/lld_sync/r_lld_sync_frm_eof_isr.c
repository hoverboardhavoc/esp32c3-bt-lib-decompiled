...
void r_lld_sync_frm_eof_isr(int param_1,char param_2)

{
  ...
  if (*(char *)(iVar4 + 0x5b) == '\x02') {
    piVar3 = (int *)(&lld_sync_env + param_1 * 4);
    if (*piVar3 != 0) {
  ...
  do {
    ...
    if (*(char *)(iVar4 + 99) == '\x01') {
      ...
      iVar5 = (int)*(short *)(iVar4 + 0x28);
      uVar11 = *(uint *)(iVar4 + 0x24);
    }
    else {
      iVar5 = 1;
      if ((((*(char *)(iVar4 + 100) != '\0') && (*(char *)(iVar4 + 0x62) == '\0')) &&
          (*(short *)(iVar4 + 0x4c) != 0)) && (iVar5 = -1, acStack_41[0] == '\0')) {
        sVar10 = *(short *)(iVar4 + 0x4c) + 1;
        iVar5 = (int)sVar10;
        *(short *)(iVar4 + 0x4e) = sVar10 + *(short *)(iVar4 + 0x4a);
      }
      *(short *)(iVar4 + 0x4a) = *(short *)(iVar4 + 0x4a) + (short)iVar5;
      *(uint *)(iVar4 + 0x44) = iVar5 * *(int *)(iVar4 + 0x40) + *(int *)(iVar4 + 0x44) & 0xfffffff;
      iVar5 = r_lld_read_clock();
      if ((iVar5 + ((uint)rwip_prog_delay * 2 - *(int *)(iVar4 + 0x44)) & 0xfffffff) < 0x8000001) {
        iVar5 = r_lld_read_clock();
        uVar8 = iVar5 + ((uint)rwip_prog_delay * 2 - *(int *)(iVar4 + 0x44)) & 0xfffffff;
        if (uVar8 != 0) {
          uVar2 = *(ushort *)(iVar4 + 0x4a);
          uVar9 = *(uint *)(iVar4 + 0x40);
          if (((uint)uVar2 - (uint)*(ushort *)(iVar4 + 0x4e) & 0xffff) < 0x7fff) {
            iVar5 = ((uVar9 - 1) + uVar8) / uVar9 << 0x10;
          }
          else {
            iVar5 = ((*(ushort *)(iVar4 + 0x4e) + 1) - (uint)uVar2) * 0x10000;
            *(undefined1 *)(iVar4 + 100) = 0;
          }
          *(ushort *)(iVar4 + 0x4a) = (short)((uint)iVar5 >> 0x10) + uVar2;
          *(uint *)(iVar4 + 0x44) = (iVar5 >> 0x10) * uVar9 + *(int *)(iVar4 + 0x44) & 0xfffffff;
        }
      }
      else {
        r_lld_read_clock();
...
_L211:
      ...
      iVar5 = (((uint)((*(int *)(iVar4 + 0x44) - *(int *)(iVar4 + 0x38)) * 0x10) >> 8) *
              (*(ushort *)(&co_sca2ppm + (uint)*(byte *)(iVar4 + 0x5a) * 2) + uVar8)) / 100 + 0x10;
      uVar8 = iVar5 * 2;
      uVar11 = *(int *)(iVar4 + 0x44) - uVar8 / 0x271 & 0xfffffff;
      uVar9 = (uint)*(ushort *)(iVar4 + 0x48) + iVar5 * -2 + (uVar8 / 0x271) * 0x271;
