...

{
  ...
  if ((uVar13 & 0x603d) != 0) {
    r_ble_log_internal_x1(0x20a500d1,param_1 << 0x10 | uVar19 << 0x18 | (uint)uVar13);
    return;
  }
  uVar21 = uVar19 << 8 | param_1;
  r_ble_log_internal_x1(0x20a500ce,uVar21);
  iVar8 = r_emi_get_mem_addr_by_offset(0x1000);
  iVar7 = iVar16 + 4;
  uVar13 = *(ushort *)(iVar8 + iVar7);
  uVar9 = r_emi_get_mem_addr_by_offset(sVar1);
  r_ble_log_internal_hex(0x20a500cf,uVar13 >> 8,uVar9);
  iVar8 = r_emi_get_mem_addr_by_offset(0x1000);
  ...
  *(undefined2 *)(puVar10 + 8) = *(undefined2 *)(iVar22 + 0x4a);
  ...
  if (*(char *)(iVar22 + 0x57) == '\0') {
    ...
    *(short *)(puVar10 + 6) = (short)((uVar18 >> 1) % uVar14);
    ...
    r_ble_log_internal_x2(0x400500d0,*(undefined4 *)(iVar22 + 0x44),param_2 << 0x10 | uVar21);
  }
  else {
