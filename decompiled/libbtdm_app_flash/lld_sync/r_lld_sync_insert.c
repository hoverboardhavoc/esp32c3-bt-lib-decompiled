    ...
    *(ushort *)(iVar4 + param_1 + 4) =
    ...
    if (*(char *)(iVar7 + 99) == '\x01') {
      ...
      *(ushort *)(iVar5 + param_1 + 0x16) = bVar1 | 0x4000;
      ...
      iVar5 = r_emi_get_mem_addr_by_offset(0x400);
      *(ushort *)(iVar5 + iVar4) = uVar8 | uVar2 & 0xf800;
      bVar1 = *(byte *)(iVar7 + 0x30);
      if ((bVar1 & 0xc0) != 0) {
      ...
      iVar4 = r_emi_get_mem_addr_by_offset(0x400);
      *(ushort *)(iVar4 + param_1 + 0x26) = uVar8 & 0x3ff | (ushort)bVar1 << 10;
    }
    else {
      if ((*(char *)(iVar7 + 0x61) != '\0') &&
        ...
        *(undefined2 *)(param_1 + 0x24 + iVar5) = uVar3;
        ...
        iVar5 = r_emi_get_mem_addr_by_offset(0x400);
        *(ushort *)(iVar5 + param_1 + 0x26) = bVar1 & 0x1f | uVar8 & 0xffe0;
    ...
    iVar4 = r_emi_get_mem_addr_by_offset(0x400);
    *(short *)(param_1 + 0x20 + iVar4) = (short)((((uVar9 >> 1) - uVar6) + 0x270) / 0x271);
    if (param_3 < 0x4000) {
      iVar4 = r_emi_get_mem_addr_by_offset(0x400);
      *(short *)(iVar4 + param_1 + 0x1a) = (short)(param_3 + 0x25 >> 1);
      ...
      iVar4 = r_emi_get_mem_addr_by_offset(0x400);
      *(ushort *)(iVar4 + param_1 + 0x1a) = (ushort)uVar6 | 0x8000;
    }
