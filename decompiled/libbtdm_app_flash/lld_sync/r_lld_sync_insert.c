...

{
  ...
  if (iVar5 == 0) {
    ...
    *(ushort *)(iVar5 + param_1 + 4) = (ushort)(param_4 << 4) | (ushort)(param_4 << 2) | 0x1000;
    ...
    if (*(char *)(iVar4 + 99) == '\x01') {
      ...
      *(ushort *)(iVar6 + param_1 + 0x16) = bVar1 | 0x4000;
      ...
      iVar6 = r_emi_get_mem_addr_by_offset(0x400);
      *(ushort *)(iVar6 + iVar5) = uVar2 & 0xf800 | uVar7;
      uVar9 = (uint)*(byte *)(iVar4 + 0x30) << 10;
      if ((uVar9 & 0x30000) != 0) {
      ...
      *(ushort *)(iVar5 + param_1 + 0x26) = uVar7 & 0x3ff | (ushort)uVar9;
      ...
      if ((*(char *)(iVar4 + 0x61) != '\0') &&
        ...
        *(undefined2 *)(iVar6 + param_1 + 0x24) = uVar3;
        ...
        iVar6 = r_emi_get_mem_addr_by_offset(0x400);
        uVar7 = *(ushort *)(iVar6 + param_1 + 0x26);
        iVar6 = r_emi_get_mem_addr_by_offset(0x400);
        *(ushort *)(iVar6 + param_1 + 0x26) = uVar7 & 0xffe0 | bVar1 & 0x1f;
    ...
    iVar5 = r_emi_get_mem_addr_by_offset(0x400);
    *(short *)(iVar5 + param_1 + 0x20) = (short)((((uVar8 >> 1) - uVar9) + 0x270) / 0x271);
    if (param_3 < 0x4000) {
      iVar5 = r_emi_get_mem_addr_by_offset(0x400);
    ...
    *(ushort *)(iVar5 + param_1 + 0x1a) = uVar7;
