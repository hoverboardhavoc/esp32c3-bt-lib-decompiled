  ...
  do {
    ...
    *(char *)(iVar4 + 0x16) = cVar10;
    ...
    if (*(char *)(iVar4 + 99) == '\x01') {
      ...
      iVar8 = (int)*(short *)(iVar4 + 0x28);
      uVar6 = *(uint *)(iVar4 + 0x24);
    }
    else {
      if ((((*(char *)(iVar4 + 100) != '\0') && (*(char *)(iVar4 + 0x62) == '\0')) &&
          (*(ushort *)(iVar4 + 0x4c) != 0)) && (iVar8 = -1, cVar3 == '\0')) {
        iVar7 = *(ushort *)(iVar4 + 0x4c) + 1;
        iVar8 = iVar7 * 0x10000 >> 0x10;
        *(short *)(iVar4 + 0x4e) = (short)iVar7 + *(short *)(iVar4 + 0x4a);
      }
      *(short *)(iVar4 + 0x4a) = *(short *)(iVar4 + 0x4a) + (short)iVar8;
      *(uint *)(iVar4 + 0x44) = iVar8 * *(int *)(iVar4 + 0x40) + *(int *)(iVar4 + 0x44) & 0xfffffff;
      iVar8 = r_lld_read_clock();
      if ((((uint)rwip_prog_delay * 2 - *(int *)(iVar4 + 0x44)) + iVar8 & 0xfffffff) < 0x8000001) {
        iVar8 = r_lld_read_clock();
        uVar5 = iVar8 + ((uint)rwip_prog_delay * 2 - *(int *)(iVar4 + 0x44)) & 0xfffffff;
        if (uVar5 != 0) {
          uVar2 = *(ushort *)(iVar4 + 0x4a);
          uVar6 = *(uint *)(iVar4 + 0x40);
          if (((uint)uVar2 - (uint)*(ushort *)(iVar4 + 0x4e) & 0xffff) < 0x7fff) {
            iVar8 = ((uVar6 - 1) + uVar5) / uVar6 << 0x10;
          }
          else {
            iVar8 = ((*(ushort *)(iVar4 + 0x4e) + 1) - (uint)uVar2) * 0x10000;
            *(undefined1 *)(iVar4 + 100) = 0;
          }
          *(ushort *)(iVar4 + 0x4a) = uVar2 + (short)((uint)iVar8 >> 0x10);
          *(uint *)(iVar4 + 0x44) = (iVar8 >> 0x10) * uVar6 + *(int *)(iVar4 + 0x44) & 0xfffffff;
        }
      }
      else {
        r_lld_read_clock();
...
_L210:
      ...
      iVar8 = (((uint)(*(int *)(iVar4 + 0x44) - *(int *)(iVar4 + 0x38)) >> 4 & 0xffffff) *
              (*(ushort *)(&co_sca2ppm + (uint)*(byte *)(iVar4 + 0x5a) * 2) + uVar5)) / 100 + 0x10;
      uVar5 = iVar8 * 2;
      uVar6 = *(int *)(iVar4 + 0x44) - uVar5 / 0x271 & 0xfffffff;
      uVar9 = (uint)*(ushort *)(iVar4 + 0x48) + iVar8 * -2 + (uVar5 / 0x271) * 0x271;
      iVar8 = (int)(uVar9 * 0x10000) >> 0x10;
      if (iVar8 < 0) {
        uVar6 = uVar6 - 1 & 0xfffffff;
        iVar8 = (int)(((uVar9 & 0xffff) + 0x271) * 0x10000) >> 0x10;
      }
      if ((*(char *)(iVar4 + 0x57) == '\0') &&
         (uVar5 = uVar5 + (-(uint)(*(char *)(iVar4 + 0x56) == '\0') & 0xfffffef2) + 300,
         ((uint)(*(int *)(iVar4 + 0x40) * 0x271) >> 1) - 0x96 < uVar5 >> 1)) {
        iVar8 = r_sdk_config_get_opts_ext();
        if (((*(uint *)(iVar8 + 0x28) & 0x80) != 0) &&
           (iVar8 = r_sdk_config_get_opts_ext(), *(byte *)(iVar8 + 0x2c) < 3)) {
          r_ble_log_internal_x2(0x40020005,(uint)*(ushort *)(iVar4 + 0x4a) << 0x10 | param_1,uVar5);
        }
        goto _L210;
      }
    ...
    *(int *)(iVar4 + 8) = iVar8;
    *(uint *)(iVar4 + 4) = uVar6;
    uVar5 = (*(ushort *)(&lld_sync_max_aux_dur_tab + (uint)bVar1 * 2) + uVar5) * 2 +
