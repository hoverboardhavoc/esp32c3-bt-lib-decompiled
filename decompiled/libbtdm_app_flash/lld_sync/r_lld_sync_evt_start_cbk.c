...

{
  ...
  if (param_1 != 0) {
    ...
    r_ble_log_internal_x3
              (0x40450161,uVar4,*(int *)(param_1 + 8) << 0x10 | *(ushort *)(iVar3 + iVar6) & 0x1f,
               uVar5);
    r_lld_sync_scan_dynamic_pti_process(param_1,0);
    iVar3 = r_emi_get_mem_addr_by_offset(0x400);
    r_bt_rma_get_ant_by_act(*(ushort *)(iVar3 + iVar6) & 0x1f,uVar5,&bStack_41,&pcStack_40);
    ...
    *(ushort *)(iVar3 + iVar6) = uVar2 & 0xff7f | (ushort)((uint)bStack_41 << 7);
    ...
    uVar2 = *(ushort *)(iVar3 + iVar6);
    iVar3 = r_emi_get_mem_addr_by_offset(0x400);
    *(ushort *)(iVar3 + iVar6) = uVar2 & 0xffbf | (ushort)uVar5;
