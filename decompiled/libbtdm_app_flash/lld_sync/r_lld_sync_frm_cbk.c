...

{
  ...
  if (*(byte *)(iVar12 + 0xd) <= param_2) {
    r_assert_param(param_2,param_3,0x10000,0x497);
  }
  if (param_3 == 2) {
  ...
  if (param_3 < 3) {
    ...
    r_ble_log_internal_x4
              (0x40450003,uStack_34,((uint)bVar7 + iVar11) * -0x80000000 | uVar13 >> 1,
               *(undefined2 *)(iVar12 + 0x4a),
               (uint)CONCAT11(param_3 != 0,*(undefined1 *)(iVar12 + 0x55)) | (uVar3 & 0x3f) << 0x10
        ...
        if (*(char *)(iVar12 + 99) == '\x01') {
          ...
          *(uint *)(iVar12 + 0x44) =
          ...
          if (uVar13 < (*(int *)(iVar12 + 0x44) - *(int *)(iVar12 + 0x3c) & 0xfffffffU)) {
            r_ble_log_internal_x4
                      (0x60050133,*(undefined4 *)(iVar12 + 0x40),
...
_L224:
          ...
          if (*(char *)(iVar12 + 0x57) == '\0') {
            ...
            if (((uint)(*(int *)(iVar12 + 0x40) * 0x271) >> 1) - 0x96 < uVar13 >> 1) {
              r_ble_log_internal_x3(0x40050134,(uint)*(ushort *)(iVar12 + 0x4a) | param_2 << 0x10);
              goto _L224;
            }
          }
    ...
    if (param_3 != 4) {
      r_assert_param(param_2,param_3,0x10000,0x4ad);
      return;
    }
    param_2 = param_2 & 0xff;
    iVar12 = *(int *)(&lld_sync_env + param_2 * 4);
    if (iVar12 == 0) {
      r_assert_err(0,0x10000,0x48a);
      return;
    }
  ...
  if (*piVar8 != 0) {
    r_ble_log_internal_x1(0x4005012a,(uint)*(ushort *)(*piVar8 + 0x4a) | param_2 << 0x10);
