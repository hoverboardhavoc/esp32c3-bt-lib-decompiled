...

{
  ...
  r_ble_log_internal_x2(0x202a01ac,param_1,CONCAT22(param_1[-2],param_1[-1]));
  psVar8 = param_1 + -2;
  if (param_1[-2] != -0x7cc8) {
...
_L68:
    ...
    psVar2 = *(short **)(&r_osi_funcs_p + (uVar6 + 4) * 4);
    if (uVar6 == 4) {
      if (psVar2 == (short *)0x0) goto _L68;
      break;
    }
  } while (psVar2 == (short *)0x0);
_L69:
  if (param_1 <= psVar2) {
    r_assert_err(0,"ke_mem.c",0x1c5);
  }
  psVar7 = (short *)0x0;
  do {
    psVar3 = psVar2;
    if (psVar3 == (short *)0x0) {
      ...
      *(short **)(param_1 + 2) = psVar7;
      ...
      param_1[-2] = -0x5aa6;
_L76:
                    /* WARNING: Could not recover jumptable at 0x00010506. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)(_r_osi_funcs_p + 0x18))(*(code **)(_r_osi_funcs_p + 0x18));
      return;
    }
    if (*psVar3 != -0x5aa6) {
      r_assert_err(0,"ke_mem.c",0x1cd);
    }
