...

{
  ...
  if (param_2 == 0) {
    ...
    iStack_4c = param_2;
    puStack_48 = param_1;
    iVar1 = r_hci_pack_bytes(&iStack_4c,&puStack_48,param_4,puVar4,1);
    if (iVar1 == 0) {
      iStack_4c = param_2 + 1;
      iVar2 = r_hci_pack_bytes(&iStack_4c,&puStack_48,param_4,puVar4,1);
      iVar1 = iVar2;
      if (iVar2 == 0) {
        iVar5 = param_2 + 0x11;
        for (iVar6 = 0; iVar1 = iVar2, iVar6 < (int)(uint)*(byte *)(param_2 + 1); iVar6 = iVar6 + 1)
        {
          ...
          if (iVar1 != 0) break;
          iStack_4c = iVar5 + -0xd;
          iVar1 = r_hci_pack_bytes(&iStack_4c,&puStack_48,param_4,puVar4,6);
          if (iVar1 != 0) break;
          iStack_4c = iVar5 + -7;
          iVar1 = r_hci_pack_bytes(&iStack_4c,&puStack_48,param_4,puVar4,1);
          if (iVar1 != 0) break;
