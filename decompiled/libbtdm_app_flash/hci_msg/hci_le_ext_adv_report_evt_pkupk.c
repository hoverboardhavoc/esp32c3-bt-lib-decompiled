...

{
  ...
  if (param_2 == (undefined1 *)0x0) {
    *param_3 = 0;
    ...
    puStack_138 = param_2;
    puStack_134 = param_1;
    iVar2 = r_hci_pack_bytes(&puStack_138,&puStack_134,puVar4,puVar1,1);
    if (iVar2 == 0) {
      puStack_138 = param_2 + 1;
      iVar3 = r_hci_pack_bytes(&puStack_138,&puStack_134,puVar4,puVar1,1);
      iVar2 = iVar3;
      if (iVar3 == 0) {
        puVar5 = param_2 + 0x19;
        for (iVar6 = 0; iVar2 = iVar3, iVar6 < (int)(uint)(byte)param_2[1]; iVar6 = iVar6 + 1) {
          puStack_138 = puVar5 + -0x17;
          iVar2 = r_hci_pack_bytes(&puStack_138,&puStack_134,puVar4,puVar1,2);
          if (iVar2 != 0) break;
          puStack_138 = puVar5 + -0x15;
          iVar2 = r_hci_pack_bytes(&puStack_138,&puStack_134,puVar4,puVar1,1);
          if (iVar2 != 0) break;
          puStack_138 = puVar5 + -0x14;
          iVar2 = r_hci_pack_bytes(&puStack_138,&puStack_134,puVar4,puVar1,6);
          if (iVar2 != 0) break;
          ...
          if ((iVar2 != 0) ||
             (puStack_138 = puVar5,
             iVar2 = r_hci_pack_bytes(&puStack_138,&puStack_134,puVar4,puVar1,1), iVar2 != 0))
          break;
          puStack_138 = puVar5 + 1;
          iVar2 = r_hci_pack_bytes(&puStack_138,&puStack_134,puVar4,puVar1,*puVar5);
          puVar5 = puVar5 + 0xfe;
          if (iVar2 != 0) break;
        }
      }
