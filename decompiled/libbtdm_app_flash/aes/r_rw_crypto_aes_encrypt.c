 ...
 * Source: libbtdm_app_flash -> aes.o -> r_rw_crypto_aes_encrypt
 *
...

{
  ...
  if (param_3 == 0) {
    iVar2 = r_aes_alloc(0x18,0,param_4);
    __dest = param_1;
  }
  else {
    iVar2 = r_aes_alloc(0x38,0,param_4,param_5);
    __dest = (void *)(iVar2 + 0x18);
    memcpy(__dest,param_1,0x10);
    param_2 = memcpy((void *)(iVar2 + 0x28),param_2,0x10);
  }
  r_co_list_push_back(&aes_env,iVar2);
  cVar1 = r_co_list_init;
  *(void **)(iVar2 + 0xc) = __dest;
  *(void **)(iVar2 + 0x10) = param_2;
  if (cVar1 != (code)0x0) {
    return;
  }
  r_co_list_init = (code)0x1;
  r_rwip_aes_encrypt(__dest,param_2);
  return;
}
