  ...
  if (param_2 == (byte *)0x0) {
    ...
    if ((iVar5 != 0) && (uVar4 < 0x23)) {
      ...
      *(undefined4 *)(iVar2 + 4) = param_3;
      ...
      r_ble_log_internal_x1(0x406f003d,(uint)*param_2 << 8 | param_1);
      r_ble_log_internal_hex(0x406f003e,uStack_22,iVar2 + 9);
      if (iVar3 == 0) {
        *(char *)(iVar2 + 8) = (char)uStack_22;
        ...
        r_ble_log_internal_x1(0x806f003f,(uint)*param_2 << 0x10 | param_1 | iVar3 << 8);
      }
      return;
    }
  }
