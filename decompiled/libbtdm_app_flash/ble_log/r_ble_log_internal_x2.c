 ...
 * Source: libbtdm_app_flash -> ble_log.o -> r_ble_log_internal_x2
 *
...
void r_ble_log_internal_x2(uint param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (ble_log_env != (byte *)0x0) {
    ...
    uStack_2c = param_2;
    uStack_28 = param_3;
    (**(code **)(ble_log_env + 8))(0x10,&uStack_34,0,0,0,*(code **)(ble_log_env + 8));
    *ble_log_env = 0;
  }
  return;
}
